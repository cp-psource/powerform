...
/**
 * Class Powerform_Addon_Default_Holder
 * Placeholder for nonexistent PRO Addon
 *
 * @since 1.1
 */
class Powerform_Addon_Default_Holder extends Powerform_Addon_Abstract {

	private static $_instance = null;

	protected $_slug                   = '';
	protected $_version                = '1.0';
	protected $_min_powerform_version = PHP_INT_MAX; // make it un-activable
