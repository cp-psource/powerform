...
class Powerform_Addon_Googlesheet_Form_Hooks extends Powerform_Addon_Form_Hooks_Abstract {
	...
	public function __construct( Powerform_Addon_Abstract $addon, $form_id ) {
		...
		$this->_submit_form_error_message = __( 'Googlesheet failed to process submitted data. Please check your form and try again', Powerform::DOMAIN );
	}
	...
	public function add_entry_fields( $submitted_data, $form_entry_fields = array() ) {
		 ...
		 * @param Powerform_Addon_Googlesheet_Form_Settings $form_settings_instance Googlesheet Addon Form Settings instance
		 */
	 ...
	 * - Info : Text that are generated by addon when building and sending data to Googlesheet @see Powerform_Addon_Googlesheet_Form_Hooks::add_entry_fields()
	 *
	 * @param $addon_meta_data
	 *
	 * @since 1.0 Googlesheet Addon
