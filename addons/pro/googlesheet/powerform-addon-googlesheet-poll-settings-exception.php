 ...
 * @since 1.6.1
 */
class Powerform_Addon_Googlesheet_Poll_Settings_Exception extends Powerform_Addon_Googlesheet_Exception {
	...
	/**
	 * Powerform_Addon_Googlesheet_Poll_Settings_Exception constructor.
	 *
