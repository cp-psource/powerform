...
/**
 * Class Powerform_Addon_Googlesheet_Form_Settings_Exception
 * Wrapper of Form Settings Google Sheets Exception
 *
 * @since 1.0 Google Sheets Addon
 */
class Powerform_Addon_Googlesheet_Form_Settings_Exception extends Powerform_Addon_Googlesheet_Exception {
	...
	/**
	 * Powerform_Addon_Googlesheet_Form_Settings_Exception constructor.
	 *
