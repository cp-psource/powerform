...
class Powerform_Addon_Googlesheet_Poll_Hooks extends Powerform_Addon_Poll_Hooks_Abstract {
	...
	public function __construct( Powerform_Addon_Abstract $addon, $poll_id ) {
		...
		$this->_submit_poll_error_message = __( 'Google Sheets failed to process submitted data. Please check your poll and try again', Powerform::DOMAIN );
	}
	...
	public function add_entry_fields( $submitted_data, $current_entry_fields = array() ) {
		 ...
		 * @param Powerform_Addon_Googlesheet_Poll_Settings $poll_settings_instance Google Sheets Addon poll Settings instance
		 */
	...
	public function on_export_render_entry( Powerform_Form_Entry_Model $entry_model, $addon_meta_data ) {
		 ...
		 * @param int                                        $poll_id                current Poll ID
		 * @param Powerform_Addon_Googlesheet_Poll_Settings $poll_settings_instance Google Sheets Addon Form Settings instance
		 */
