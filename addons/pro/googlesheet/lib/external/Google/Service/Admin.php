 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Admin extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->mail = new Powerform_Google_Service_Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new Powerform_Google_Service_Admin(...);
 *   $mail = $adminService->mail;
 *  </code>
 */
class Powerform_Google_Service_Admin_Mail_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param Powerform_Google_MailItem $postBody
   * @param array $optParams Optional parameters.
   */
  public function insert($userKey, Powerform_Google_Service_Admin_MailItem $postBody, $optParams = array())
  {
...
class Powerform_Google_Service_Admin_MailItem extends Powerform_Google_Collection
{
