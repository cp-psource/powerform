 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_QPXExpress extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->trips = new Powerform_Google_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new Powerform_Google_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class Powerform_Google_Service_QPXExpress_Trips_Resource extends Powerform_Google_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param Powerform_Google_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_QPXExpress_TripsSearchResponse
   */
  public function search(Powerform_Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Powerform_Google_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class Powerform_Google_Service_QPXExpress_AircraftData extends Powerform_Google_Model
{
...
class Powerform_Google_Service_QPXExpress_AirportData extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class Powerform_Google_Service_QPXExpress_BagDescriptor extends Powerform_Google_Collection
{
...
class Powerform_Google_Service_QPXExpress_CarrierData extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Powerform_Google_Service_QPXExpress_CityData extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $code;
...
class Powerform_Google_Service_QPXExpress_Data extends Powerform_Google_Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  protected $aircraftType = 'Powerform_Google_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'Powerform_Google_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'Powerform_Google_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'Powerform_Google_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'Powerform_Google_Service_QPXExpress_TaxData';
...
class Powerform_Google_Service_QPXExpress_FareInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $basisCode;
...
class Powerform_Google_Service_QPXExpress_FlightInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $carrier;
...
class Powerform_Google_Service_QPXExpress_FreeBaggageAllowance extends Powerform_Google_Collection
{
  protected $collection_key = 'bagDescriptor';
  protected $internal_gapi_mappings = array(
  );
  protected $bagDescriptorType = 'Powerform_Google_Service_QPXExpress_BagDescriptor';
...
class Powerform_Google_Service_QPXExpress_LegInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $aircraft;
...
class Powerform_Google_Service_QPXExpress_PassengerCounts extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $adultCount;
...
class Powerform_Google_Service_QPXExpress_PricingInfo extends Powerform_Google_Collection
{
  protected $collection_key = 'tax';
  protected $internal_gapi_mappings = array(
  );
  public $baseFareTotal;
  protected $fareType = 'Powerform_Google_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'Powerform_Google_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'Powerform_Google_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'Powerform_Google_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(Powerform_Google_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class Powerform_Google_Service_QPXExpress_SegmentInfo extends Powerform_Google_Collection
{
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'Powerform_Google_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'Powerform_Google_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(Powerform_Google_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class Powerform_Google_Service_QPXExpress_SegmentPricing extends Powerform_Google_Collection
{
  protected $collection_key = 'freeBaggageOption';
  protected $internal_gapi_mappings = array(
  );
  public $fareId;
  protected $freeBaggageOptionType = 'Powerform_Google_Service_QPXExpress_FreeBaggageAllowance';
...
class Powerform_Google_Service_QPXExpress_SliceInfo extends Powerform_Google_Collection
{
  ...
  public $duration;
  public $kind;
  protected $segmentType = 'Powerform_Google_Service_QPXExpress_SegmentInfo';
...
class Powerform_Google_Service_QPXExpress_SliceInput extends Powerform_Google_Collection
{
  ...
  protected $permittedDepartureTimeType = 'Powerform_Google_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(Powerform_Google_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class Powerform_Google_Service_QPXExpress_TaxData extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Powerform_Google_Service_QPXExpress_TaxInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $chargeType;
...
class Powerform_Google_Service_QPXExpress_TimeOfDayRange extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $earliestTime;
...
class Powerform_Google_Service_QPXExpress_TripOption extends Powerform_Google_Collection
{
  ...
  public $id;
  public $kind;
  protected $pricingType = 'Powerform_Google_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'Powerform_Google_Service_QPXExpress_SliceInfo';
...
class Powerform_Google_Service_QPXExpress_TripOptionsRequest extends Powerform_Google_Collection
{
  protected $collection_key = 'slice';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'Powerform_Google_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class Powerform_Google_Service_QPXExpress_TripOptionsResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'tripOption';
  protected $internal_gapi_mappings = array(
  );
  protected $dataType = 'Powerform_Google_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'Powerform_Google_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';


  public function setData(Powerform_Google_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class Powerform_Google_Service_QPXExpress_TripsSearchRequest extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $requestType = 'Powerform_Google_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';


  public function setRequest(Powerform_Google_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class Powerform_Google_Service_QPXExpress_TripsSearchResponse extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $tripsType = 'Powerform_Google_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(Powerform_Google_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
