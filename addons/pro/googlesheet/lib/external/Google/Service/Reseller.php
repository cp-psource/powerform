 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Reseller extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->customers = new Powerform_Google_Service_Reseller_Customers_Resource(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->subscriptions = new Powerform_Google_Service_Reseller_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $resellerService = new Powerform_Google_Service_Reseller(...);
 *   $customers = $resellerService->customers;
 *  </code>
 */
class Powerform_Google_Service_Reseller_Customers_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @return Powerform_Google_Service_Reseller_Customer
   */
  public function get($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Reseller_Customer");
  }
   ...
   * @return Powerform_Google_Service_Reseller_Customer
   */
  public function insert(Powerform_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Powerform_Google_Service_Reseller_Customer");
  }
   ...
   * @return Powerform_Google_Service_Reseller_Customer
   */
  public function patch($customerId, Powerform_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Powerform_Google_Service_Reseller_Customer");
  }
   ...
   * @return Powerform_Google_Service_Reseller_Customer
   */
  public function update($customerId, Powerform_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Powerform_Google_Service_Reseller_Customer");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Reseller_Subscriptions_Resource extends Powerform_Google_Service_Resource
{
   ...
   * customer
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Reseller_Subscription
   */
  public function activate($customerId, $subscriptionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('activate', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Powerform_Google_ChangePlanRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Reseller_Subscription
   */
  public function changePlan($customerId, $subscriptionId, Powerform_Google_Service_Reseller_ChangePlanRequest $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changePlan', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Powerform_Google_RenewalSettings $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Reseller_Subscription
   */
  public function changeRenewalSettings($customerId, $subscriptionId, Powerform_Google_Service_Reseller_RenewalSettings $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeRenewalSettings', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Powerform_Google_Seats $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Reseller_Subscription
   */
  public function changeSeats($customerId, $subscriptionId, Powerform_Google_Service_Reseller_Seats $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeSeats', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
  ...
  public function get($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
   ...
   * @return Powerform_Google_Service_Reseller_Subscription
   */
  public function insert($customerId, Powerform_Google_Service_Reseller_Subscription $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
   ...
   * @return Powerform_Google_Service_Reseller_Subscriptions
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Reseller_Subscriptions");
  }
  ...
  public function startPaidService($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('startPaidService', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
  ...
  public function suspend($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('suspend', array($params), "Powerform_Google_Service_Reseller_Subscription");
  }
}
...
class Powerform_Google_Service_Reseller_Address extends Powerform_Google_Model
{
...
class Powerform_Google_Service_Reseller_ChangePlanRequest extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  ...
  protected $seatsType = 'Powerform_Google_Service_Reseller_Seats';
  ...
  public function setSeats(Powerform_Google_Service_Reseller_Seats $seats)
  {
    $this->seats = $seats;
  }
...
class Powerform_Google_Service_Reseller_Customer extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $kind;
  public $phoneNumber;
  protected $postalAddressType = 'Powerform_Google_Service_Reseller_Address';
  ...
  public function setPostalAddress(Powerform_Google_Service_Reseller_Address $postalAddress)
  {
...
class Powerform_Google_Service_Reseller_RenewalSettings extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Powerform_Google_Service_Reseller_Seats extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Powerform_Google_Service_Reseller_Subscription extends Powerform_Google_Collection
{
  ...
  public $customerId;
  public $kind;
  protected $planType = 'Powerform_Google_Service_Reseller_SubscriptionPlan';
  protected $planDataType = '';
  public $purchaseOrderId;
  protected $renewalSettingsType = 'Powerform_Google_Service_Reseller_RenewalSettings';
  ...
  protected $transferInfoType = 'Powerform_Google_Service_Reseller_SubscriptionTransferInfo';
  protected $transferInfoDataType = '';
  protected $trialSettingsType = 'Powerform_Google_Service_Reseller_SubscriptionTrialSettings';
  ...
  public function setPlan(Powerform_Google_Service_Reseller_SubscriptionPlan $plan)
  {
    $this->plan = $plan;
  }
  ...
  public function setRenewalSettings(Powerform_Google_Service_Reseller_RenewalSettings $renewalSettings)
  {
  ...
  public function setTransferInfo(Powerform_Google_Service_Reseller_SubscriptionTransferInfo $transferInfo)
  {
  ...
  public function setTrialSettings(Powerform_Google_Service_Reseller_SubscriptionTrialSettings $trialSettings)
  {
...
class Powerform_Google_Service_Reseller_SubscriptionPlan extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $commitmentIntervalType = 'Powerform_Google_Service_Reseller_SubscriptionPlanCommitmentInterval';
  protected $commitmentIntervalDataType = '';
  public $isCommitmentPlan;
  public $planName;


  public function setCommitmentInterval(Powerform_Google_Service_Reseller_SubscriptionPlanCommitmentInterval $commitmentInterval)
  {
...
class Powerform_Google_Service_Reseller_SubscriptionPlanCommitmentInterval extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class Powerform_Google_Service_Reseller_SubscriptionTransferInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Powerform_Google_Service_Reseller_SubscriptionTrialSettings extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $isInTrial;
...
class Powerform_Google_Service_Reseller_Subscriptions extends Powerform_Google_Collection
{
  ...
  protected $subscriptionsType = 'Powerform_Google_Service_Reseller_Subscription';
