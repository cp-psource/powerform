 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Cloudbilling extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->billingAccounts = new Powerform_Google_Service_Cloudbilling_BillingAccounts_Resource(
        $this,
        $this->serviceName,
        'billingAccounts',
        array(
    ...
    $this->billingAccounts_projects = new Powerform_Google_Service_Cloudbilling_BillingAccountsProjects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->projects = new Powerform_Google_Service_Cloudbilling_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudbillingService = new Powerform_Google_Service_Cloudbilling(...);
 *   $billingAccounts = $cloudbillingService->billingAccounts;
 *  </code>
 */
class Powerform_Google_Service_Cloudbilling_BillingAccounts_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @return Powerform_Google_Service_Cloudbilling_BillingAccount
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Cloudbilling_BillingAccount");
  }
   ...
   * returned.
   * @return Powerform_Google_Service_Cloudbilling_ListBillingAccountsResponse
   */
  public function listBillingAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Cloudbilling_ListBillingAccountsResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Cloudbilling_BillingAccountsProjects_Resource extends Powerform_Google_Service_Resource
{
   ...
   * returned.
   * @return Powerform_Google_Service_Cloudbilling_ListProjectBillingInfoResponse
   */
  public function listBillingAccountsProjects($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Cloudbilling_ListProjectBillingInfoResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Cloudbilling_Projects_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Cloudbilling_ProjectBillingInfo
   */
  public function getBillingInfo($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('getBillingInfo', array($params), "Powerform_Google_Service_Cloudbilling_ProjectBillingInfo");
  }
   ...
   * rain-123`.
   * @param Powerform_Google_ProjectBillingInfo $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Cloudbilling_ProjectBillingInfo
   */
  public function updateBillingInfo($name, Powerform_Google_Service_Cloudbilling_ProjectBillingInfo $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('updateBillingInfo', array($params), "Powerform_Google_Service_Cloudbilling_ProjectBillingInfo");
  }
}
...
class Powerform_Google_Service_Cloudbilling_BillingAccount extends Powerform_Google_Model
{
...
class Powerform_Google_Service_Cloudbilling_ListBillingAccountsResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'billingAccounts';
  protected $internal_gapi_mappings = array(
  );
  protected $billingAccountsType = 'Powerform_Google_Service_Cloudbilling_BillingAccount';
...
class Powerform_Google_Service_Cloudbilling_ListProjectBillingInfoResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'projectBillingInfo';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $projectBillingInfoType = 'Powerform_Google_Service_Cloudbilling_ProjectBillingInfo';
...
class Powerform_Google_Service_Cloudbilling_ProjectBillingInfo extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
