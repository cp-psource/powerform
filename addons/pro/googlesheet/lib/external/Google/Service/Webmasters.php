 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Webmasters extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->searchanalytics = new Powerform_Google_Service_Webmasters_Searchanalytics_Resource(
        $this,
        $this->serviceName,
        'searchanalytics',
        array(
    ...
    $this->sitemaps = new Powerform_Google_Service_Webmasters_Sitemaps_Resource(
        $this,
        $this->serviceName,
        'sitemaps',
        array(
    ...
    $this->sites = new Powerform_Google_Service_Webmasters_Sites_Resource(
        $this,
        $this->serviceName,
        'sites',
        array(
    ...
    $this->urlcrawlerrorscounts = new Powerform_Google_Service_Webmasters_Urlcrawlerrorscounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->urlcrawlerrorssamples = new Powerform_Google_Service_Webmasters_Urlcrawlerrorssamples_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new Powerform_Google_Service_Webmasters(...);
 *   $searchanalytics = $webmastersService->searchanalytics;
 *  </code>
 */
class Powerform_Google_Service_Webmasters_Searchanalytics_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param Powerform_Google_SearchAnalyticsQueryRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_SearchAnalyticsQueryResponse
   */
  public function query($siteUrl, Powerform_Google_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Powerform_Google_Service_Webmasters_SearchAnalyticsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Webmasters_Sitemaps_Resource extends Powerform_Google_Service_Resource
{
   ...
   * http://www.example.com/sitemap.xml
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_WmxSitemap
   */
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Webmasters_WmxSitemap");
  }
   ...
   * @return Powerform_Google_Service_Webmasters_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Webmasters_SitemapsListResponse");
  }
 ...
 *  </code>
 */
class Powerform_Google_Service_Webmasters_Sites_Resource extends Powerform_Google_Service_Resource
{
   ...
   * Examples: http://www.example.com/ or android-app://com.example/
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_WmxSite
   */
  public function get($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Webmasters_WmxSite");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_SitesListResponse
   */
  public function listSites($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Webmasters_SitesListResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Webmasters_Urlcrawlerrorscounts_Resource extends Powerform_Google_Service_Resource
{
   ...
   * platforms.
   * @return Powerform_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse
   */
  public function query($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Powerform_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Webmasters_Urlcrawlerrorssamples_Resource extends Powerform_Google_Service_Resource
{
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_UrlCrawlErrorsSample
   */
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Webmasters_UrlCrawlErrorsSample");
  }
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse
   */
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
...
class Powerform_Google_Service_Webmasters_ApiDataRow extends Powerform_Google_Collection
{
...
class Powerform_Google_Service_Webmasters_ApiDimensionFilter extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dimension;
...
class Powerform_Google_Service_Webmasters_ApiDimensionFilterGroup extends Powerform_Google_Collection
{
  protected $collection_key = 'filters';
  protected $internal_gapi_mappings = array(
  );
  protected $filtersType = 'Powerform_Google_Service_Webmasters_ApiDimensionFilter';
...
class Powerform_Google_Service_Webmasters_SearchAnalyticsQueryRequest extends Powerform_Google_Collection
{
  protected $collection_key = 'dimensions';
  protected $internal_gapi_mappings = array(
  );
  public $aggregationType;
  protected $dimensionFilterGroupsType = 'Powerform_Google_Service_Webmasters_ApiDimensionFilterGroup';
...
class Powerform_Google_Service_Webmasters_SearchAnalyticsQueryResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $responseAggregationType;
  protected $rowsType = 'Powerform_Google_Service_Webmasters_ApiDataRow';
...
class Powerform_Google_Service_Webmasters_SitemapsListResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'sitemap';
  protected $internal_gapi_mappings = array(
  );
  protected $sitemapType = 'Powerform_Google_Service_Webmasters_WmxSitemap';
...
class Powerform_Google_Service_Webmasters_SitesListResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'siteEntry';
  protected $internal_gapi_mappings = array(
  );
  protected $siteEntryType = 'Powerform_Google_Service_Webmasters_WmxSite';
...
class Powerform_Google_Service_Webmasters_UrlCrawlErrorCount extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Powerform_Google_Service_Webmasters_UrlCrawlErrorCountsPerType extends Powerform_Google_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  public $category;
  protected $entriesType = 'Powerform_Google_Service_Webmasters_UrlCrawlErrorCount';
...
class Powerform_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'countPerTypes';
  protected $internal_gapi_mappings = array(
  );
  protected $countPerTypesType = 'Powerform_Google_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
class Powerform_Google_Service_Webmasters_UrlCrawlErrorsSample extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = 'Powerform_Google_Service_Webmasters_UrlSampleDetails';
  ...
  public function setUrlDetails(Powerform_Google_Service_Webmasters_UrlSampleDetails $urlDetails)
  {
...
class Powerform_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'urlCrawlErrorSample';
  protected $internal_gapi_mappings = array(
  );
  protected $urlCrawlErrorSampleType = 'Powerform_Google_Service_Webmasters_UrlCrawlErrorsSample';
...
class Powerform_Google_Service_Webmasters_UrlSampleDetails extends Powerform_Google_Collection
{
...
class Powerform_Google_Service_Webmasters_WmxSite extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Powerform_Google_Service_Webmasters_WmxSitemap extends Powerform_Google_Collection
{
  protected $collection_key = 'contents';
  protected $internal_gapi_mappings = array(
  );
  protected $contentsType = 'Powerform_Google_Service_Webmasters_WmxSitemapContent';
...
class Powerform_Google_Service_Webmasters_WmxSitemapContent extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexed;
