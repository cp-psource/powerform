 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Fitness extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->users_dataSources = new Powerform_Google_Service_Fitness_UsersDataSources_Resource(
        $this,
        $this->serviceName,
        'dataSources',
        array(
    ...
    $this->users_dataSources_datasets = new Powerform_Google_Service_Fitness_UsersDataSourcesDatasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->users_dataset = new Powerform_Google_Service_Fitness_UsersDataset_Resource(
        $this,
        $this->serviceName,
        'dataset',
        array(
    ...
    $this->users_sessions = new Powerform_Google_Service_Fitness_UsersSessions_Resource(
        $this,
        $this->serviceName,
        'sessions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = new Powerform_Google_Service_Fitness(...);
 *   $users = $fitnessService->users;
 *  </code>
 */
class Powerform_Google_Service_Fitness_Users_Resource extends Powerform_Google_Service_Resource
{
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Fitness_UsersDataSources_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param Powerform_Google_DataSource $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Fitness_DataSource
   */
  public function create($userId, Powerform_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Powerform_Google_Service_Fitness_DataSource");
  }
  ...
  public function delete($userId, $dataSourceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Powerform_Google_Service_Fitness_DataSource");
  }
  ...
  public function get($userId, $dataSourceId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Fitness_DataSource");
  }
   ...
   * @return Powerform_Google_Service_Fitness_ListDataSourcesResponse
   */
  public function listUsersDataSources($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Fitness_ListDataSourcesResponse");
  }
   ...
   * @return Powerform_Google_Service_Fitness_DataSource
   */
  public function patch($userId, $dataSourceId, Powerform_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Powerform_Google_Service_Fitness_DataSource");
  }
   ...
   * @return Powerform_Google_Service_Fitness_DataSource
   */
  public function update($userId, $dataSourceId, Powerform_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Powerform_Google_Service_Fitness_DataSource");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Fitness_UsersDataSourcesDatasets_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @return Powerform_Google_Service_Fitness_Dataset
   */
  public function get($userId, $dataSourceId, $datasetId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Fitness_Dataset");
  }
   ...
   * @return Powerform_Google_Service_Fitness_Dataset
   */
  public function patch($userId, $dataSourceId, $datasetId, Powerform_Google_Service_Fitness_Dataset $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Powerform_Google_Service_Fitness_Dataset");
  }
}
/**
 ...
 *  </code>
 */
class Powerform_Google_Service_Fitness_UsersDataset_Resource extends Powerform_Google_Service_Resource
{
   ...
   * indicate the authenticated user. Only me is supported at this time.
   * @param Powerform_Google_AggregateRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Fitness_AggregateResponse
   */
  public function aggregate($userId, Powerform_Google_Service_Fitness_AggregateRequest $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('aggregate', array($params), "Powerform_Google_Service_Fitness_AggregateResponse");
  }
}
/**
 ...
 *  </code>
 */
class Powerform_Google_Service_Fitness_UsersSessions_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @return Powerform_Google_Service_Fitness_ListSessionsResponse
   */
  public function listUsersSessions($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Fitness_ListSessionsResponse");
  }
   ...
   * @param Powerform_Google_Session $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string currentTimeMillis The client's current time in milliseconds
   * since epoch.
   * @return Powerform_Google_Service_Fitness_Session
   */
  public function update($userId, $sessionId, Powerform_Google_Service_Fitness_Session $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'sessionId' => $sessionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Powerform_Google_Service_Fitness_Session");
  }
}
...
class Powerform_Google_Service_Fitness_AggregateBucket extends Powerform_Google_Collection
{
  protected $collection_key = 'dataset';
  protected $internal_gapi_mappings = array(
  );
  public $activity;
  protected $datasetType = 'Powerform_Google_Service_Fitness_Dataset';
  protected $datasetDataType = 'array';
  public $endTimeMillis;
  protected $sessionType = 'Powerform_Google_Service_Fitness_Session';
  ...
  public function setSession(Powerform_Google_Service_Fitness_Session $session)
  {
...
class Powerform_Google_Service_Fitness_AggregateBy extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dataSourceId;
...
class Powerform_Google_Service_Fitness_AggregateRequest extends Powerform_Google_Collection
{
  protected $collection_key = 'aggregateBy';
  protected $internal_gapi_mappings = array(
  );
  protected $aggregateByType = 'Powerform_Google_Service_Fitness_AggregateBy';
  protected $aggregateByDataType = 'array';
  protected $bucketByActivitySegmentType = 'Powerform_Google_Service_Fitness_BucketByActivity';
  protected $bucketByActivitySegmentDataType = '';
  protected $bucketByActivityTypeType = 'Powerform_Google_Service_Fitness_BucketByActivity';
  protected $bucketByActivityTypeDataType = '';
  protected $bucketBySessionType = 'Powerform_Google_Service_Fitness_BucketBySession';
  protected $bucketBySessionDataType = '';
  protected $bucketByTimeType = 'Powerform_Google_Service_Fitness_BucketByTime';
  ...
  public function setBucketByActivitySegment(Powerform_Google_Service_Fitness_BucketByActivity $bucketByActivitySegment)
  {
  ...
  public function setBucketByActivityType(Powerform_Google_Service_Fitness_BucketByActivity $bucketByActivityType)
  {
  ...
  public function setBucketBySession(Powerform_Google_Service_Fitness_BucketBySession $bucketBySession)
  {
  ...
  public function setBucketByTime(Powerform_Google_Service_Fitness_BucketByTime $bucketByTime)
  {
...
class Powerform_Google_Service_Fitness_AggregateResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'bucket';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketType = 'Powerform_Google_Service_Fitness_AggregateBucket';
...
class Powerform_Google_Service_Fitness_Application extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $detailsUrl;
...
class Powerform_Google_Service_Fitness_BucketByActivity extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Powerform_Google_Service_Fitness_BucketBySession extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $minDurationMillis;
...
class Powerform_Google_Service_Fitness_BucketByTime extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Powerform_Google_Service_Fitness_DataPoint extends Powerform_Google_Collection
{
  ...
  protected $valueType = 'Powerform_Google_Service_Fitness_Value';
...
class Powerform_Google_Service_Fitness_DataSource extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $applicationType = 'Powerform_Google_Service_Fitness_Application';
  protected $applicationDataType = '';
  public $dataStreamId;
  public $dataStreamName;
  protected $dataTypeType = 'Powerform_Google_Service_Fitness_DataType';
  protected $dataTypeDataType = '';
  protected $deviceType = 'Powerform_Google_Service_Fitness_Device';
  protected $deviceDataType = '';
  public $name;
  public $type;


  public function setApplication(Powerform_Google_Service_Fitness_Application $application)
  {
  ...
  public function setDataType(Powerform_Google_Service_Fitness_DataType $dataType)
  {
  ...
  public function setDevice(Powerform_Google_Service_Fitness_Device $device)
  {
    $this->device = $device;
  }
...
class Powerform_Google_Service_Fitness_DataType extends Powerform_Google_Collection
{
  protected $collection_key = 'field';
  protected $internal_gapi_mappings = array(
  );
  protected $fieldType = 'Powerform_Google_Service_Fitness_DataTypeField';
...
class Powerform_Google_Service_Fitness_DataTypeField extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $format;
...
class Powerform_Google_Service_Fitness_Dataset extends Powerform_Google_Collection
{
  ...
  protected $pointType = 'Powerform_Google_Service_Fitness_DataPoint';
...
class Powerform_Google_Service_Fitness_Device extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $manufacturer;
...
class Powerform_Google_Service_Fitness_ListDataSourcesResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'dataSource';
  protected $internal_gapi_mappings = array(
  );
  protected $dataSourceType = 'Powerform_Google_Service_Fitness_DataSource';
...
class Powerform_Google_Service_Fitness_ListSessionsResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'session';
  protected $internal_gapi_mappings = array(
  );
  protected $deletedSessionType = 'Powerform_Google_Service_Fitness_Session';
...
class Powerform_Google_Service_Fitness_MapValue extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fpVal;
...
class Powerform_Google_Service_Fitness_Session extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Powerform_Google_Service_Fitness_Value extends Powerform_Google_Collection
{
  ...
  public $fpVal;
  public $intVal;
  protected $mapValType = 'Powerform_Google_Service_Fitness_ValueMapValEntry';
...
class Powerform_Google_Service_Fitness_ValueMapValEntry extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
  protected $valueType = 'Powerform_Google_Service_Fitness_MapValue';
  ...
  public function setValue(Powerform_Google_Service_Fitness_MapValue $value)
  {
    $this->value = $value;
  }
  public function getValue()
