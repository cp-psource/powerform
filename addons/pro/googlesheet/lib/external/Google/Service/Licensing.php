 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Licensing extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->licenseAssignments = new Powerform_Google_Service_Licensing_LicenseAssignments_Resource(
        $this,
        $this->serviceName,
        'licenseAssignments',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $licensingService = new Powerform_Google_Service_Licensing(...);
 *   $licenseAssignments = $licensingService->licenseAssignments;
 *  </code>
 */
class Powerform_Google_Service_Licensing_LicenseAssignments_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param string $userId email id or unique Id of the user
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Licensing_LicenseAssignment
   */
  public function get($productId, $skuId, $userId, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Licensing_LicenseAssignment");
  }
   ...
   * @param string $productId Name for product
   * @param string $skuId Name for sku
   * @param Powerform_Google_LicenseAssignmentInsert $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Licensing_LicenseAssignment
   */
  public function insert($productId, $skuId, Powerform_Google_Service_Licensing_LicenseAssignmentInsert $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Powerform_Google_Service_Licensing_LicenseAssignment");
  }
   ...
   * @return Powerform_Google_Service_Licensing_LicenseAssignmentList
   */
  public function listForProduct($productId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProduct', array($params), "Powerform_Google_Service_Licensing_LicenseAssignmentList");
  }
  ...
  public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('listForProductAndSku', array($params), "Powerform_Google_Service_Licensing_LicenseAssignmentList");
  }
   ...
   * @param string $userId email id or unique Id of the user
   * @param Powerform_Google_LicenseAssignment $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Licensing_LicenseAssignment
   */
  public function patch($productId, $skuId, $userId, Powerform_Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Powerform_Google_Service_Licensing_LicenseAssignment");
  }
   ...
   * @return Powerform_Google_Service_Licensing_LicenseAssignment
   */
  public function update($productId, $skuId, $userId, Powerform_Google_Service_Licensing_LicenseAssignment $postBody, $optParams = array())
  {
    $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Powerform_Google_Service_Licensing_LicenseAssignment");
  }
}
...
class Powerform_Google_Service_Licensing_LicenseAssignment extends Powerform_Google_Model
{
...
class Powerform_Google_Service_Licensing_LicenseAssignmentInsert extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $userId;
...
class Powerform_Google_Service_Licensing_LicenseAssignmentList extends Powerform_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Powerform_Google_Service_Licensing_LicenseAssignment';
