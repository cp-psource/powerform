 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Cloudtrace extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->projects = new Powerform_Google_Service_Cloudtrace_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->projects_traces = new Powerform_Google_Service_Cloudtrace_ProjectsTraces_Resource(
        $this,
        $this->serviceName,
        'traces',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudtraceService = new Powerform_Google_Service_Cloudtrace(...);
 *   $projects = $cloudtraceService->projects;
 *  </code>
 */
class Powerform_Google_Service_Cloudtrace_Projects_Resource extends Powerform_Google_Service_Resource
{
   ...
   * stored.
   * @param Powerform_Google_Traces $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Cloudtrace_Empty
   */
  public function patchTraces($projectId, Powerform_Google_Service_Cloudtrace_Traces $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patchTraces', array($params), "Powerform_Google_Service_Cloudtrace_Empty");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Cloudtrace_ProjectsTraces_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Cloudtrace_Trace
   */
  public function get($projectId, $traceId, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'traceId' => $traceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Cloudtrace_Trace");
  }
   ...
   * @return Powerform_Google_Service_Cloudtrace_ListTracesResponse
   */
  public function listProjectsTraces($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Cloudtrace_ListTracesResponse");
  }
}
...
class Powerform_Google_Service_Cloudtrace_Empty extends Powerform_Google_Model
{
}

class Powerform_Google_Service_Cloudtrace_ListTracesResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'traces';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $tracesType = 'Powerform_Google_Service_Cloudtrace_Trace';
...
class Powerform_Google_Service_Cloudtrace_Trace extends Powerform_Google_Collection
{
  protected $collection_key = 'spans';
  protected $internal_gapi_mappings = array(
  );
  public $projectId;
  protected $spansType = 'Powerform_Google_Service_Cloudtrace_TraceSpan';
...
class Powerform_Google_Service_Cloudtrace_TraceSpan extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class Powerform_Google_Service_Cloudtrace_Traces extends Powerform_Google_Collection
{
  protected $collection_key = 'traces';
  protected $internal_gapi_mappings = array(
  );
