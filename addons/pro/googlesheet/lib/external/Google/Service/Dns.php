 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Dns extends Powerform_Google_Service
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    ...
    $this->changes = new Powerform_Google_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new Powerform_Google_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new Powerform_Google_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new Powerform_Google_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new Powerform_Google_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class Powerform_Google_Service_Dns_Changes_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param Powerform_Google_Change $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Dns_Change
   */
  public function create($project, $managedZone, Powerform_Google_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Powerform_Google_Service_Dns_Change");
  }
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Dns_Change");
  }
   ...
   * 'descending'.
   * @return Powerform_Google_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Dns_ManagedZones_Resource extends Powerform_Google_Service_Resource
{
   ...
   *
   * @param string $project Identifies the project addressed by this request.
   * @param Powerform_Google_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Dns_ManagedZone
   */
  public function create($project, Powerform_Google_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Powerform_Google_Service_Dns_ManagedZone");
  }
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Dns_ManagedZone");
  }
   ...
   * request that was truncated. Use this parameter to continue a previous list
   * request.
   * @return Powerform_Google_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Dns_Projects_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @param string $project Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return Powerform_Google_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Powerform_Google_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class Powerform_Google_Service_Dns_ResourceRecordSets_Resource extends Powerform_Google_Service_Resource
{
   ...
   * @return Powerform_Google_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Powerform_Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class Powerform_Google_Service_Dns_Change extends Powerform_Google_Collection
{
  protected $collection_key = 'deletions';
  protected $internal_gapi_mappings = array(
  );
  protected $additionsType = 'Powerform_Google_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'Powerform_Google_Service_Dns_ResourceRecordSet';
...
class Powerform_Google_Service_Dns_ChangesListResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'changes';
  protected $internal_gapi_mappings = array(
  );
  protected $changesType = 'Powerform_Google_Service_Dns_Change';
...
class Powerform_Google_Service_Dns_ManagedZone extends Powerform_Google_Collection
{
...
class Powerform_Google_Service_Dns_ManagedZonesListResponse extends Powerform_Google_Collection
{
  protected $collection_key = 'managedZones';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $managedZonesType = 'Powerform_Google_Service_Dns_ManagedZone';
...
class Powerform_Google_Service_Dns_Project extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'Powerform_Google_Service_Dns_Quota';
  ...
  public function setQuota(Powerform_Google_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class Powerform_Google_Service_Dns_Quota extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Powerform_Google_Service_Dns_ResourceRecordSet extends Powerform_Google_Collection
{
...
class Powerform_Google_Service_Dns_ResourceRecordSetsListResponse extends Powerform_Google_Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'Powerform_Google_Service_Dns_ResourceRecordSet';
