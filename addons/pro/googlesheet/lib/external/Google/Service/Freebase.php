 ...
 * @author Google, Inc.
 */
class Powerform_Google_Service_Freebase extends Powerform_Google_Service
{
   ...
   * @return Powerform_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "Powerform_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class Powerform_Google_Service_Freebase_ReconcileCandidate extends Powerform_Google_Model
{
  ...
  public $mid;
  public $name;
  protected $notableType = 'Powerform_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(Powerform_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class Powerform_Google_Service_Freebase_ReconcileCandidateNotable extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Powerform_Google_Service_Freebase_ReconcileGet extends Powerform_Google_Collection
{
  protected $collection_key = 'warning';
  protected $internal_gapi_mappings = array(
  );
  protected $candidateType = 'Powerform_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'Powerform_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Powerform_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'Powerform_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(Powerform_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(Powerform_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class Powerform_Google_Service_Freebase_ReconcileGetCosts extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $hits;
...
class Powerform_Google_Service_Freebase_ReconcileGetWarning extends Powerform_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $location;
