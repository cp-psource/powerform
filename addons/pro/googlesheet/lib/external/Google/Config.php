...
class Powerform_Google_Config
{
  ...
  /**
   * Create a new Powerform_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Powerform_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Powerform_Google_Cache_File',
      'logger_class'  => 'Powerform_Google_Logger_Null',
      ...
      'classes' => array(
        'Powerform_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Powerform_Google_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'Powerform_Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Powerform_Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Powerform_Google_Http_Request' => array(
        ...
        'Powerform_Google_Auth_OAuth2' => array(
        ...
        'Powerform_Google_Task_Runner' => array(
        ...
        'Powerform_Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'Powerform_Google_IO_Exception' => array(
        ...
        'Powerform_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Powerform_Google_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see Powerform_Google_Auth_LoginTicket) after sign
