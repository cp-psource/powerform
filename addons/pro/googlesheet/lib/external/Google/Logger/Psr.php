 ...
 * with the `Powerform_Google_Logger_Psr::setLogger()` method.
 */
class Powerform_Google_Logger_Psr extends Powerform_Google_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(Powerform_Google_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
