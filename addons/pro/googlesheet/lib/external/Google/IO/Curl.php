...
/**
 * Curl based implementation of Powerform_Google_IO.
 *
...
class Powerform_Google_IO_Curl extends Powerform_Google_IO_Abstract
{
  ...
  public function executeRequest(Powerform_Google_Http_Request $request)
  {
    ...
    $options = $this->client->getClassConfig('Powerform_Google_IO_Curl', 'options');
    if (is_array($options)) {
    ...
    if ($response === false) {
      ...
      $map = $this->client->getClassConfig('Powerform_Google_IO_Exception', 'retry_map');

      $this->client->getLogger()->error('cURL ' . $error);
      throw new Powerform_Google_IO_Exception($error, $code, null, $map);
    }
  ...
  protected function needsQuirk()
  {
    ...
    return $versionNum < Powerform_Google_IO_Curl::NO_QUIRK_VERSION;
  }
}
