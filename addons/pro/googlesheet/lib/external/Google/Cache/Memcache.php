 ...
 */
class Powerform_Google_Cache_Memcache extends Powerform_Google_Cache_Abstract
{
  ...
  public function __construct(Powerform_Google_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new Powerform_Google_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws Powerform_Google_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new Powerform_Google_Cache_Exception("Couldn't store data in cache");
    }
