...
class Powerform_Addon_Googlesheet_Quiz_Hooks extends Powerform_Addon_Quiz_Hooks_Abstract {
	...
	public function __construct( Powerform_Addon_Abstract $addon, $quiz_id ) {
		...
		$this->_submit_quiz_error_message = __( 'Googlesheet failed to process submitted data. Please check your quiz and try again', Powerform::DOMAIN );
	}
	...
	public function add_entry_fields( $submitted_data, $current_entry_fields = array() ) {
		 ...
		 * @param Powerform_Addon_Googlesheet_Quiz_Settings $quiz_settings_instance Googlesheet Addon quiz Settings instance
		 */
	...
	public function on_render_entry( Powerform_Form_Entry_Model $entry_model, $addon_meta_data ) {
		 ...
		 * @param Powerform_Addon_Googlesheet_Quiz_Settings $quiz_settings_instance Googlesheet Addon Form Settings instance
		 */
		$addon_meta_data = apply_filters(
			'powerform_addon_quiz_googlesheet_metadata',
			$addon_meta_data,
	 ...
	 * - Info : Text that are generated by addon when building and sending data to Googlesheet @see Powerform_Addon_Googlesheet_Quiz_Hooks::add_entry_fields()
	 *
	 * @param $addon_meta_data
	 *
	 * @since 1.6.2
