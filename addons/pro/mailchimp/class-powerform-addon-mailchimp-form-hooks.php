...
/**
 * Class Powerform_Addon_Mailchimp_Form_Hooks
 *
 * Hooks that used by Mailchimp Addon defined here
 *
 * @since 1.0 Mailchimp Addon
 */
class Powerform_Addon_Mailchimp_Form_Hooks extends Powerform_Addon_Form_Hooks_Abstract {
	 ...
	 *
	 * @since 1.0 Mailchimp Addon
	 * @var Powerform_Addon_Mailchimp_Form_Settings | null
	 *
	 */
	...
	public function on_after_render_form_fields() {
		 ...
		 * @param Powerform_Addon_Mailchimp_Form_Settings $form_settings_instance Mailchimp Form settings Instance
		 */
		do_action(
			'powerform_addon_mailchimp_on_after_render_form_fields',
			$form_id,
	...
	public function on_form_submit( $submitted_data ) {
		 ...
		 * @param int                                      $form_id                current Form ID
		 * @param Powerform_Addon_Mailchimp_Form_Settings $form_settings_instance Mailchimp API Form Settings instance
		 */
	...
	public function add_entry_fields( $submitted_data, $form_entry_fields = array() ) {
        ...
        foreach ( $submitted_data as $field => $value ) {
            if ( false !== strpos( $field, 'date' ) && ! empty( $value ) ) {
                $date_format            = Powerform_API::get_form_field( $form_id, $field, false )->date_format;
		...
		try {
			 ...
			 * @param Powerform_Addon_Mailchimp_Form_Settings $form_settings_instance Mailchimp Form Settings
			 */
			 ...
			 * @param Powerform_Addon_Mailchimp_Form_Settings $form_settings_instance Mailchimp Form Settings
			 */
			do_action( 'powerform_addon_mailchimp_before_add_update_member', $form_id, $submitted_data, $form_settings_instance );
