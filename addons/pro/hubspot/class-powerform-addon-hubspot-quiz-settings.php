...
require_once dirname( __FILE__ ) . '/class-powerform-addon-hubspot-quiz-settings-exception.php';

/**
 * Class Powerform_Addon_Hubspot_Quiz_Settings
 * Handle how quiz settings displayed and saved
 *
 * @since 1.0 HubSpot Addon
 */
class Powerform_Addon_Hubspot_Quiz_Settings extends Powerform_Addon_Quiz_Settings_Abstract {
	...
	/**
	 * Powerform_Addon_Hubspot_Quiz_Settings constructor.
	 *
	 * @since 1.0 HubSpot Addon
	 *
	...
	public function map_fields( $submitted_data ) {
		$template = powerform_addon_hubspot_dir() . 'views/quiz-settings/create-contact.php';
		...
		} catch ( Powerform_Addon_Hubspot_Quiz_Settings_Exception $e ) {
		...
		if ( $is_submit ) {
			...
			try {
				$input_exceptions = new Powerform_Addon_Hubspot_Quiz_Settings_Exception();
	...
	public function create_ticket( $submitted_data ) {
		$template = powerform_addon_hubspot_dir() . 'views/quiz-settings/create-ticket.php';
