...
/**
 * Class Powerform_Addon_Hubspot_Form_Settings_Exception
 * Wrapper of Form Settings HubSpot Exception
 *
 * @since 1.0 HubSpot Addon
 */
class Powerform_Addon_Hubspot_Form_Settings_Exception extends Powerform_Addon_Hubspot_Exception {
	...
	/**
	 * Powerform_Addon_Hubspot_Form_Settings_Exception constructor.
	 *
