...
/**
 * Class Powerform_Addon_Hubspot_Form_Hooks
 *
 * @since 1.0 HubSpot Addon
 *
 */
class Powerform_Addon_Hubspot_Form_Hooks extends Powerform_Addon_Form_Hooks_Abstract {
	 ...
	 *
	 * @since 1.0 HubSpot Addon
	 * @var Powerform_Addon_Hubspot_Form_Settings | null
	 */
	protected $form_settings_instance;

	/**
	 * Powerform_Addon_Hubspot_Form_Hooks constructor.
	 *
	 * @since 1.0 HubSpot Addon
	 *
	...
	public function __construct( Powerform_Addon_Abstract $addon, $form_id ) {
		...
		$this->_submit_form_error_message = __( 'HubSpot failed to process submitted data. Please check your form and try again', Powerform::DOMAIN );
	}
	...
	public function add_entry_fields( $submitted_data, $form_entry_fields = array() ) {
		 ...
		 * @param Powerform_Addon_Hubspot_Form_Settings $form_settings_instance HubSpot Addon Form Settings instance
		 */
		$submitted_data = apply_filters(
			'powerform_addon_hubspot_form_submitted_data',
			$submitted_data,
			$form_id,
		 ...
		 * @param Powerform_Addon_Hubspot_Form_Settings $form_settings_instance HubSpot Addon Form Settings instance
		 */
		do_action( 'powerform_addon_hubspot_before_send_message', $form_id, $submitted_data, $form_settings_instance );
	...
	private function get_status_on_contact_sync( $connection_id, $submitted_data, $connection_settings, $form_entry_fields ) {
		...
		try {
			...
			if ( '1' === $create_ticket ) {
				...
				$ticket_name                  = powerform_addon_replace_custom_vars( $connection_settings['ticket_name'], $submitted_data, $this->custom_form, $form_entry_fields, false );
				$ticket['ticket_name']        = $ticket_name;
				$ticket_description           = powerform_addon_replace_custom_vars( $connection_settings['ticket_description'], $submitted_data, $this->custom_form, $form_entry_fields, false );
	 ...
	 * subentries included are defined in @see Powerform_Addon_Hubspot_Form_Hooks::get_additional_entry_item()
	 *
	 * @since 1.0 HubSpot Addon
	 *
	 ...
	 * - Info : Text that are generated by addon when building and sending data to HubSpot @see Powerform_Addon_Hubspot_Form_Hooks::add_entry_fields()
