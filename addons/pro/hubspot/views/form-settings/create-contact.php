...
<div class="integration-header">
	...
	<p class="sui-description" style="max-width: 400px; margin: 20px auto 0; line-height: 22px;"><?php esc_html_e( 'Let\'s start with choosing a HubSpot list and matching up your form fields with the default HubSpot contact fields to make sure weâ€™re sending data to the right place.', Powerform::DOMAIN ); ?></p>
