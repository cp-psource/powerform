...
/**
 * Class Powerform_Addon_Hubspot_Quiz_Settings_Exception
 * Wrapper of Quiz Settings HubSpot Exception
 *
 * @since 1.0 HubSpot Addon
 */
class Powerform_Addon_Hubspot_Quiz_Settings_Exception extends Powerform_Addon_Hubspot_Exception {
	...
	/**
	 * Powerform_Addon_Hubspot_Quiz_Settings_Exception constructor.
	 *
	 * Useful if input_id is needed for later.
	 * If no input_id needed, use @see Powerform_Addon_Hubspot_Exception
	 *
	 * @since 1.0 HubSpot Addon
	 *
