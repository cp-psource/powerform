...
<div class="integration-header">
	<h3 class="sui-box-title" id="dialogTitle2"><?php echo esc_html( __( 'Choose Contact List', Powerform::DOMAIN ) ); ?></h3>
	<span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( 'Pick ActiveCampaign List for new contacts to be added to.', Powerform::DOMAIN ); ?></span>
...
<form>
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['list_id_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		<label class="sui-label" for="activecampaign-list-id"><?php esc_html_e( 'List', Powerform::DOMAIN ); ?></label>
