...
<div class="integration-header">
    <h3 class="sui-box-title" id="dialogTitle2"><?php echo esc_html( __( 'Assign Fields', Powerform::DOMAIN ) ); ?></h3>
    <span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( 'Match up your quiz lead fields with your campaign fields to make sure we\'re sending data to the right place.', Powerform::DOMAIN ); ?></span>
...
<form>
    <table class="sui-table">
        <thead>
        <tr>
            <th><?php esc_html_e( 'ActiveCampaign Field', Powerform::DOMAIN ); ?></th>
                ...
                <td>
                    ...
                    <div class="sui-form-field <?php echo esc_attr( ! empty( $current_error ) ? 'sui-form-field-error' : '' ); ?>">
                        <select class="sui-select" name="fields_map[<?php echo esc_attr( $key ); ?>]">
                            <option value=""><?php esc_html_e( 'Please Select A Field', Powerform::DOMAIN ); ?></option>
