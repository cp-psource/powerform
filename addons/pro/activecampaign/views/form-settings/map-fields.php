...
<div class="integration-header">
	...
	<span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( 'Match up your form fields with your campaign fields to make sure we\'re sending data to the right place.', Powerform::DOMAIN ); ?></span>
