...
require_once dirname( __FILE__ ) . '/class-powerform-addon-activecampaign-exception.php';
require_once dirname( __FILE__ ) . '/lib/class-powerform-addon-activecampaign-wp-api.php';
...
final class Powerform_Addon_Activecampaign extends Powerform_Addon_Abstract {
	...
	protected $_quiz_settings = 'Powerform_Addon_Activecampaign_Quiz_Settings';
	protected $_quiz_hooks    = 'Powerform_Addon_Activecampaign_Quiz_Hooks';
	...
	public function is_quiz_connected( $quiz_id ) {
		try {
			...
			if ( ! $quiz_settings_instance instanceof Powerform_Addon_Activecampaign_Quiz_Settings ) {
				throw new Powerform_Addon_Activecampaign_Exception( __( 'Invalid Quiz Settings of ActiveCampaign', Powerform::DOMAIN ) );
			}

			// Mark as active when there is at least one active connection
			if ( false === $quiz_settings_instance->find_one_active_connection() ) {
				throw new Powerform_Addon_Activecampaign_Exception( __( 'No active ActiveCampaign connection found in this quiz', Powerform::DOMAIN ) );
			}
		 ...
		 * @param Powerform_Addon_Activecampaign_Quiz_Settings|null $quiz_settings_instance Instance of quiz settings, or null when unavailable
		 *
		 */
		$is_quiz_connected = apply_filters( 'powerform_addon_activecampaign_is_quiz_connected', $is_quiz_connected, $quiz_id, $quiz_settings_instance );
	...
	public function is_quiz_lead_connected( $quiz_id ) {
		 ...
		 *
		 */
		$is_quiz_connected = apply_filters( 'powerform_addon_activecampaign_is_quiz_lead_connected', $is_quiz_connected, $quiz_id, $quiz_settings_instance );
