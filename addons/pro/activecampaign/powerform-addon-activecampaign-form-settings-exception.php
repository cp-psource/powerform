...
/**
 * Class Powerform_Addon_Activecampaign_Form_Settings_Exception
 * Wrapper of Form Settings Activecampaign Exception
 *
 * @since 1.0 Activecampaign Addon
 */
class Powerform_Addon_Activecampaign_Form_Settings_Exception extends Powerform_Addon_Activecampaign_Exception {
	...
	/**
	 * Powerform_Addon_Activecampaign_Form_Settings_Exception constructor.
	 *
	 * Useful if input_id is needed for later.
	 * If no input_id needed, use @see Powerform_Addon_Activecampaign_Exception
	 *
	 * @since 1.0 Activecampaign Addon
	 *
