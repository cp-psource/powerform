...
require_once dirname( __FILE__ ) . '/class-powerform-addon-activecampaign-form-settings-exception.php';
...
class Powerform_Addon_Activecampaign_Form_Settings extends Powerform_Addon_Form_Settings_Abstract {
	...
	/**
	 * @var Powerform_Addon_Activecampaign_CustomField
	...
	public function pick_name( $submitted_data ) {
		...
		if ( $this->pick_name_is_completed( array( 'multi_id' => $multi_id ) ) ) {
			$buttons['disconnect']['markup'] = Powerform_Addon_Abstract::get_button_markup(
				...
				esc_html__( 'Deactivate this ActiveCampaign Integration from this Form.', Powerform::DOMAIN )
			);
		}
