...
/**
 * Class Powerform_Addon_Slack_Quiz_Settings_Exception
 * Wrapper of Quiz Settings Slack Exception
 *
 * @since 1.6.2
 */
class Powerform_Addon_Slack_Quiz_Settings_Exception extends Powerform_Addon_Slack_Exception {
	...
	/**
	 * Powerform_Addon_Slack_Quiz_Settings_Exception constructor.
	 *
	 * Useful if input_id is needed for later.
	 * If no input_id needed, use @see Powerform_Addon_Slack_Exception
	 *
	 * @since 1.6.2
	 *
