...
<div class="integration-header">
	<h3 class="sui-box-title" id="dialogTitle2"><?php echo esc_html( __( 'Setup Message', Powerform::DOMAIN ) ); ?></h3>
	<p><?php esc_html_e( 'Configure message to be sent.', Powerform::DOMAIN ); ?></p>
...
<form>
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['message_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Message', Powerform::DOMAIN ); ?></label>
		...
		<span class="sui-description">
			<?php esc_html_e( 'You can format your message using Slack Flavored Markdown, find more information ', Powerform::DOMAIN ); ?>
		...
		<span class="sui-description">
			<?php esc_html_e( 'By default sent message will include Poll Answer and Poll Results as attachment using Powerform Format to ease you up, more information about attachment can be found ',
			                  Powerform::DOMAIN ); ?>
