...
<form>
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['message_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<span class="sui-description">
			<?php
			esc_html_e(
				'By default sent message will include Poll Answer and Poll Results as attachment using Powerform Format to ease you up, more information about attachment can be found ',
				Powerform::DOMAIN
			);
			?>
