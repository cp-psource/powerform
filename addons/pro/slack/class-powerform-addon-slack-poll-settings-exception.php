...
/**
 * Class Powerform_Addon_Slack_Poll_Settings_Exception
 * Wrapper of Poll Settings Slack Exception
 *
 * @since 1.6.1
 */
class Powerform_Addon_Slack_Poll_Settings_Exception extends Powerform_Addon_Slack_Exception {
	...
	/**
	 * Powerform_Addon_Slack_Poll_Settings_Exception constructor.
	 *
