...
<div class="integration-header">
    ...
    <span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( "Match up your quiz lead fields with your Campaign Monitor fields to make sure we're sending data to the right place.", Powerform::DOMAIN ); ?></span>
