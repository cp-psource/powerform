...
require_once dirname( __FILE__ ) . '/class-powerform-addon-campaignmonitor-quiz-settings-exception.php';

/**
 * Class Powerform_Addon_Campaignmonitor_Quiz_Settings
 * Handle how quiz settings displayed and saved
 *
 * @since 1.0 Campaignmonitor Addon
 */
class Powerform_Addon_Campaignmonitor_Quiz_Settings extends Powerform_Addon_Quiz_Settings_Abstract {
	...
	/**
	 * Powerform_Addon_Campaignmonitor_Quiz_Settings constructor.
	 *
	 * @since 1.0 Campaignmonitor Addon
	 *
	...
	public function pick_name( $submitted_data ) {
		$template = powerform_addon_campaignmonitor_dir() . 'views/quiz-settings/pick-name.php';
	...
	public function setup_list( $submitted_data ) {
		$template = powerform_addon_campaignmonitor_dir() . 'views/quiz-settings/setup-list.php';
	...
	public function map_fields( $submitted_data ) {
		$template = powerform_addon_campaignmonitor_dir() . 'views/quiz-settings/map-fields.php';
		...
		if ( $is_submit ) {
			...
			try {
				...
				$input_exceptions = new Powerform_Addon_Campaignmonitor_Quiz_Settings_Exception();
			...
			} catch ( Powerform_Addon_Campaignmonitor_Quiz_Settings_Exception $e ) {
	...
	public function setup_options( $submitted_data ) {
		$template = powerform_addon_campaignmonitor_dir() . 'views/quiz-settings/setup-options.php';
