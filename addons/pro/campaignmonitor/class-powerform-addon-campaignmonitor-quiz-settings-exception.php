...
/**
 * Class Powerform_Addon_Campaignmonitor_Quiz_Settings_Exception
 * Wrapper of Form Settings Campaignmonitor Exception
 *
 * @since 1.0 Campaignmonitor Addon
 */
class Powerform_Addon_Campaignmonitor_Quiz_Settings_Exception extends Powerform_Addon_Campaignmonitor_Exception {
	...
	/**
	 * Powerform_Addon_Campaignmonitor_Quiz_Settings_Exception constructor.
	 *
	 * Useful if input_id is needed for later.
	 * If no input_id needed, use @see Powerform_Addon_Campaignmonitor_Exception
	 *
	 * @since 1.0 Campaignmonitor Addon
	 *
