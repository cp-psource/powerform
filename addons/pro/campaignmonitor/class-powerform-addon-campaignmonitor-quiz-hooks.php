...
/**
 * Class Powerform_Addon_Campaignmonitor_Quiz_Hooks
 *
 * @since 1.0 Campaignmonitor Addon
 *
 */
class Powerform_Addon_Campaignmonitor_Quiz_Hooks extends Powerform_Addon_Quiz_Hooks_Abstract {
	 ...
	 *
	 * @since 1.0 Campaignmonitor Addon
	 * @var Powerform_Addon_Campaignmonitor_Quiz_Settings | null
	 */
	protected $quiz_settings_instance;

	/**
	 * Powerform_Addon_Campaignmonitor_Quiz_Hooks constructor.
	 *
	 * @since 1.0 Campaignmonitor Addon
	 *
	...
	public function __construct( Powerform_Addon_Abstract $addon, $quiz_id ) {
		...
		$this->_submit_quiz_error_message = __( 'Campaign Monitor failed to process submitted data. Please check your quiz and try again', Powerform::DOMAIN );
	}
	...
	public function add_entry_fields( $submitted_data, $form_entry_fields = array() ) {
		 ...
		 * @param Powerform_Addon_Campaignmonitor_Quiz_Settings $quiz_settings_instance Campaign Monitor Addon Quiz Settings instance
		 */
		$submitted_data = apply_filters(
			'powerform_addon_campaignmonitor_quiz_submitted_data',
			$submitted_data,
			$quiz_id,
		 ...
		 * @param Powerform_Addon_Campaignmonitor_Quiz_Settings $quiz_settings_instance Campaign Monitor Addon Quiz Settings instance
		 */
		do_action( 'powerform_addon_campaignmonitor_before_add_subscriber', $quiz_id, $submitted_data, $quiz_settings_instance );
	 ...
	 * subentries included are defined in @see Powerform_Addon_Campaignmonitor_Quiz_Hooks::get_additional_entry_item()
	 *
	 * @since 1.0 Campaign Monitor Addon
	 *
	 ...
	 * - Info : Text that are generated by addon when building and sending data to Campaign Monitor @see Powerform_Addon_Campaignmonitor_Quiz_Hooks::add_entry_fields()
