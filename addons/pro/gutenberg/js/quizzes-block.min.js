! function(e) {
    ...
    t.m = e, t.c = n, t.d = function(e, n, o) { t.o(e, n) || Object.defineProperty(e, n, { configurable: !1, enumerable: !0, get: o }) }, t.n = function(e) { var n = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(n, "a", n), n }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "", t(t.s = 2) }({ 2: function(module, exports) {
        ...
        function _inherits(e, t) { if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
            ...
            BlockEdit = function(_Component) {
                function BlockEdit() { _classCallCheck(this, BlockEdit); var e = _possibleConstructorReturn(this, (BlockEdit.__proto__ || Object.getPrototypeOf(BlockEdit)).apply(this, arguments)); return e.update_id = e.update_id.bind(e), e.preview = e.preview.bind(e), e.state = { loading: !1, markup: "", type: "" }, e } return _inherits(BlockEdit, _Component), _createClass(BlockEdit, [{ key: "update_id", value: function(e) { this.props.setAttributes({ module_id: e }) } }, { key: "preview", value: function preview(attributes) { var _this2 = this,
                            module_id = attributes.module_id; if (!this.state.loading) { this.setState({ loading: !0 }); var ajax_url = wpApiSettings.root + "powerform/v1/preview/quizzes/?module_id=" + module_id;
                            window.fetch(ajax_url).then(function(e) { return e.json() }).then(function(data) { data.success && _this2.setState({ markup: data.data.markup, type: data.data.type }), setTimeout(function() { window.jQuery("form.powerform-quiz-" + module_id).parent().find("script").each(function() { eval(jQuery(this).text()) }) }, 10), _this2.setState({ loading: !1 }) }).catch(function(e) { return { success: !1 } }) } } }, { key: "componentDidMount", value: function() { var e = this.props.attributes;
                        e.module_id && this.preview(e) } }, { key: "componentDidUpdate", value: function(e) { var t = this.props.attributes; if (e.attributes.module_id !== t.module_id) return t.module_id ? void this.preview(t) : void this.setState({ markup: "", type: "" }) } }, { key: "update_alignment", value: function(e) { this.props.setAttributes({ alignment: e }) } }, { key: "open_settings", value: function(e, t) { var n = ""; "knowledge" === t && (n = frmnt_quiz_data.admin_url + "?page=powerform-knowledge-wizard&id=" + e), "nowrong" === t && (n = frmnt_quiz_data.admin_url + "?page=powerform-nowrong-wizard&id=" + e), n && (window.location.href = n) } }, { key: "render", value: function() { var e = this,
                            t = this.state,
                            n = t.loading,
                            o = t.markup,
                            r = t.type,
