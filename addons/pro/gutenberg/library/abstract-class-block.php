...
/**
 * Class Powerform_GFBlock_Abstract
 * Extend this class to create new gutenberg block
 *
 * @since 1.0 Gutenber Addon
 */
abstract class Powerform_GFBlock_Abstract {
	...
	public function register_block() {
		register_block_type( 'powerform/' . $this->get_slug(), array(
	...
	public function block_preview_api() {
		register_rest_route( 'powerform/v1', '/preview/' . $this->get_slug(), array(
			array(
