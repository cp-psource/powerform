...
/**
 * Class Powerform_Addon_Trello_Poll_Settings_Exception
 * Wrapper of Poll Settings Trello Exception
 *
 * @since 1.6.1
 */
class Powerform_Addon_Trello_Poll_Settings_Exception extends Powerform_Addon_Trello_Exception {
	...
	/**
	 * Powerform_Addon_Trello_Poll_Settings_Exception constructor.
	 *
