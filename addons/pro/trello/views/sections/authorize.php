...
<div id="powerform-integrations" class="wpmudev-settings--box">
	<div class="sui-box">
		<div class="sui-box-header">
			<h2 class="sui-box-title"><?php esc_html_e( "Authorizing Trello", Powerform::DOMAIN ); ?></h2>
		</div>
		<div class="sui-box-body">
			...
			<?php elseif ( $vars['is_close'] ): ?>
				<span class="sui-notice sui-notice-success">
					<p>
						<?php
						esc_html_e( 'Successfully authorized Trello, you can go back to integration settings.',
						            Powerform::DOMAIN
						);
						?>
					</p>
