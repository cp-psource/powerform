...
require_once dirname( __FILE__ ) . '/powerform-addon-trello-form-settings-exception.php';

/**
 * Class Powerform_Addon_Trello_Form_Settings
 * Handle how form settings displayed and saved
 *
 * @since 1.0 Trello Addon
 */
class Powerform_Addon_Trello_Form_Settings extends Powerform_Addon_Form_Settings_Abstract {
	...
	/**
	 * Powerform_Addon_Trello_Form_Settings constructor.
	 *
	 * @since 1.0 Trello Addon
	 *
	...
	public function setup_name( $submitted_data ) {
		$template = powerform_addon_trello_dir() . 'views/form-settings/setup-name.php';
		...
		if ( $this->setup_name_is_completed( array( 'multi_id' => $multi_id ) ) ) {
			$buttons['disconnect']['markup'] = Powerform_Addon_Abstract::get_button_markup( esc_html__( 'DISCONNECT', Powerform::DOMAIN ),
			                                                                                 ...
			                                                                                 esc_html__( 'Disconnect this Trello Integration from this Form.', Powerform::DOMAIN )
			);
		}
	...
	public function setup_board( $submitted_data ) {
		$template = powerform_addon_trello_dir() . 'views/form-settings/setup-board.php';
	...
	public function setup_list( $submitted_data ) {
		$template = powerform_addon_trello_dir() . 'views/form-settings/setup-list.php';
	...
	public function setup_card( $submitted_data ) {
		$template = powerform_addon_trello_dir() . 'views/form-settings/setup-card.php';
		...
		if ( $is_submit ) {
			...
			try {
				$input_exceptions = new Powerform_Addon_Trello_Form_Settings_Exception();
			...
			} catch ( Powerform_Addon_Trello_Form_Settings_Exception $e ) {
	...
	public function get_multi_ids() {
		 ...
		 */
		$multi_ids = apply_filters( 'powerform_addon_trello_multi_id_labels', $multi_ids, $form_settings_values );
