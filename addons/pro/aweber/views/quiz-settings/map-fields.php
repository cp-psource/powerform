...
<div class="integration-header">
	...
	<p><?php esc_html_e( 'Match up your form fields with your AWeber fields to make sure we\'re sending data to the right place.', Powerform::DOMAIN ); ?></p>
...
<form>
	...
	<table class="sui-table">
		...
		<thead>
			...
			<tr>
				<th><?php esc_html_e( 'AWeber Field', Powerform::DOMAIN ); ?></th>
