...
<div class="integration-header">
	...
	<span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( 'Pick AWeber List for new subscriber to be added to.', Powerform::DOMAIN ); ?></span>
...
<form>
	...
	<div class="sui-form-field<?php echo esc_attr( ! empty( $vars['list_id_error'] ) ? ' sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label" for="aweber-list-id"><?php esc_html_e( 'List', Powerform::DOMAIN ); ?></label>

		<select name="list_id" class="sui-select sui-form-control" id="aweber-list-id">
			<option value=""><?php esc_html_e( 'Please select a list', Powerform::DOMAIN ); ?></option>
