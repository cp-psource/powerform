...
<div class="integration-header">
	<h3 class="sui-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Webhook', Powerform::DOMAIN ); ?></h3>
	<p><?php esc_html_e( 'Put your ZAP Webhook URL below. ', Powerform::DOMAIN ); ?></p>
...
<form enctype="multipart/form-data">
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['name_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		<label class="sui-label"><?php esc_html_e( 'Zapier Integration Name', Powerform::DOMAIN ); ?></label>
		<div class="sui-control-with-icon">
			<input type="text"
				name="name"
				placeholder="<?php esc_attr_e( 'Friendly Name', Powerform::DOMAIN ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['webhook_url_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		<label class="sui-label"><?php esc_html_e( 'Webhook URL', Powerform::DOMAIN ); ?></label>
		<div class="sui-control-with-icon">
			<input
					type="text"
					name="webhook_url"
					placeholder="<?php esc_attr_e( 'Webhook URL', Powerform::DOMAIN ); ?>"
...
<div class="sui-notice sui-notice-warning">
	<p>
		...
		echo sprintf(/* translators: ... */
			esc_html__( 'Please go %1$shere%2$s if you do not have any ZAP created. Remember to choose %3$sWebhooks by Zapier%4$s as Trigger App.', Powerform::DOMAIN ),
