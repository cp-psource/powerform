...
/**
 * Class Powerform_Addon_Zapier_Quiz_Settings_Exception
 * Wrapper of Quiz Settings Zapier Exception
 *
 * @since 1.6.2
 */
class Powerform_Addon_Zapier_Quiz_Settings_Exception extends Powerform_Addon_Zapier_Exception {
	...
	/**
	 * Powerform_Addon_Zapier_Quiz_Settings_Exception constructor.
	 *
