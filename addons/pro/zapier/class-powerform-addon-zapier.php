...
require_once dirname( __FILE__ ) . '/class-powerform-addon-zapier-exception.php';
require_once dirname( __FILE__ ) . '/lib/class-powerform-addon-zapier-wp-api.php';
...
final class Powerform_Addon_Zapier extends Powerform_Addon_Abstract {
	...
	protected $_documentation          = 'https://n3rds.work/docs/wpmu-dev-plugins/powerform/#zapier';
	...
	public function __construct() {
		...
		$doc_description    = powerform_is_show_addons_documentation_link() ?
			sprintf(
			/* translators: 1: article anchor start, 2: article anchor end. */
				__( 'Refer to this %1$sarticle%2$s for tips and tricks on using Zapier integration and creating automated workflows.', Powerform::DOMAIN ),
				'<a href="https://n3rds.work/blog/zapier-wordpress-form-integrations/" target="_blank">',
				'</a>'
			) : '';
		$this->_promotion   = sprintf(
		/* translators: ... */
			__( 'Zapier connects Powerform with %1$s1000+ apps%2$s. You can use it to send your submissions to third party apps not natively supported in Powerform and automate your after-submission workflows. %3$s Happy automating!', Powerform::DOMAIN ),
		...
		$this->_banner    = powerform_addon_zapier_assets_url() . 'img/banner.png';
		$this->_banner_x2 = powerform_addon_zapier_assets_url() . 'img/banner@2x.png';
	}
