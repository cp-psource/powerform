...
require_once dirname( __FILE__ ) . '/class-powerform-addon-zapier-form-settings-exception.php';
...
class Powerform_Addon_Zapier_Form_Settings extends Powerform_Addon_Form_Settings_Abstract {
	...
	public function setup_webhook_url( $submitted_data ) {
		...
		if ( $this->setup_webhook_url_is_completed( $current_data ) ) {
			$buttons['disconnect']['markup'] = Powerform_Addon_Zapier::get_button_markup(
				...
				esc_html__( 'Deactivate Zapier from this Form.', Powerform::DOMAIN )
			);
		}
