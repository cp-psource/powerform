...
/**
 * Class Powerform_Addon_Zapier_Poll_Settings_Exception
 * Wrapper of Poll Settings Zapier Exception
 *
 * @since 1.6.1
 */
class Powerform_Addon_Zapier_Poll_Settings_Exception extends Powerform_Addon_Zapier_Exception {
	...
	/**
	 * Powerform_Addon_Zapier_Poll_Settings_Exception constructor.
	 *
