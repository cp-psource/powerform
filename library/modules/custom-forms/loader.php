...
class Powerform_Custom_Form extends Powerform_Module {
	...
	public function options() {
		return array(
			'name'          => __('Custom Forms', Powerform::DOMAIN),
			'singular_name' => __('Custom Form', Powerform::DOMAIN),
			'description'   => __( "Custom forms, conditional forms, etc. Choose from our library of forms or create a new one from scratch.", Powerform::DOMAIN ),
			'button_label'  => __( "New Custom Form", Powerform::DOMAIN ),
