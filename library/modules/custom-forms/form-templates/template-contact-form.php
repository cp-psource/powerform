 ...
 * @since 1.0
 */
class Powerform_Template_Contact_Form extends Powerform_Template {
	...
	public function defaults() {
		return array(
			'id'          => 'contact_form',
			'name'        => __( 'Kontaktformulare', Powerform::DOMAIN ),
			...
			array(
				...
				'fields'     => array(
					array(
						...
						'cols'            => '12',
						"required"        => false,
						"field_label"     => __( "Telefonnummer", Powerform::DOMAIN ),
						"placeholder"     => __( "Z.B. +1 3004005000", Powerform::DOMAIN ),
						"validation"      => true,
						"validation_text" => "",
					),
				),
			...
			array(
				...
				'fields'     => array(
					array(
						...
						'cols'        => '12',
						"required"    => false,
						"field_label" => __( "Mitteilung", Powerform::DOMAIN ),
						"placeholder" => __( "Gib deine Nachricht ein...", Powerform::DOMAIN ),
	...
	public function settings() {
		return array(
			...
			'admin-email-title'      => __( "Neuer Formulareintrag #{submission_id} für {form_name}", Powerform::DOMAIN ),
			'admin-email-editor'     => __( "Du hast ein neues Webseiten-Formular eingereicht: <br/> {all_fields} <br/>---<br/> Diese Nachricht wurde gesendet von {site_url}.", Powerform::DOMAIN ),
			'admin-email-recipients' => array(
				get_option( 'admin_email' ),
			),
			'user-email-title'      => __( "Vielen Dank", Powerform::DOMAIN ),
			'user-email-editor'     => __( "Vielen Dank für Deine Kontaktaufnahme. Wir werden uns in Kürze bei Dir melden. <br/>---<br/> Diese Nachricht wurde gesendet von {site_url}.", Powerform::DOMAIN ),
