 ...
 * @since 1.0
 */
class Powerform_Template_Post extends Powerform_Template {
	...
	public function defaults() {
		return array(
			'id'          => 'post',
			'name'        => __( 'Beitrag erstellen', Powerform::DOMAIN ),
	...
	public function settings() {
		return array(
			...
			'submitData'                    => array(
				"custom-submit-text"          => __( "Beitrag erstellen", Powerform::DOMAIN ),
