 ...
 * @since 1.0
 */
class Powerform_Template_Quote extends Powerform_Template {
	...
	public function defaults() {
		return array(
			'id'          => 'quote',
			'name'        => __( 'Angebotsanfrage', Powerform::DOMAIN ),
			...
			array(
				...
				'fields'     => array(
					array(
						...
						'cols'        => '12',
						"required"    => false,
						"field_label" => __( "Dienstleistungen", Powerform::DOMAIN ),
						"placeholder" => __( "", Powerform::DOMAIN ),
						"value_type"  => "checkbox",
						"options"     => array(
							array(
								"label" => "Service 1",
			...
			array(
				...
				'fields'     => array(
					array(
						...
						'cols'        => '12',
						"required"    => false,
						"field_label" => __( "Zusätzliche Bemerkungen", Powerform::DOMAIN ),
						"placeholder" => __( "", Powerform::DOMAIN ),
	...
	public function settings() {
		return array(
			...
			'submitData'                    => array(
				"custom-submit-text"          => __( "Angebot anfordern", Powerform::DOMAIN ),
