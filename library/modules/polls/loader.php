...
/**
 * Class Powerform_Polls
 *
 * @since 1.0
 */
class Powerform_Polls extends Powerform_Module {
	...
	public function init() {
		...
		if ( class_exists( 'Powerform_Polls_General_Data_Protection' ) ) {
			new Powerform_Polls_General_Data_Protection();
		}
	}
	...
	public function load_front() {
		...
		new Powerform_Poll_Front_Action();
		new Powerform_Poll_Front();

		add_action( 'wp_ajax_powerform_load_poll', array( 'Powerform_Poll_Front', 'ajax_load_module' ) );
		add_action( 'wp_ajax_nopriv_powerform_load_poll', array( 'Powerform_Poll_Front', 'ajax_load_module' ) );
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'powerform_polls', $args );
	}
