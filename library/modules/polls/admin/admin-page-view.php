...
/**
 * Class Powerform_Poll_Page
 *
 * @since 1.0
 */
class Powerform_Poll_Page extends Powerform_Admin_Page {
	...
	public function get_models() {
		$data = Powerform_Poll_Form_Model::model()->get_all_paged( $this->page_number );
	...
	public function processRequest() {
		...
		if ( ! wp_verify_nonce( $nonce, 'powerformPollFormRequest' ) ) {
			return;
		}
