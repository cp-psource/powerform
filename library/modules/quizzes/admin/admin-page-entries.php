...
/**
 * Class Powerform_Quizz_View_Page
 *
 * @since 1.0
 */
class Powerform_Quizz_View_Page extends Powerform_Admin_Page {

	/**
	 * Current model
	 *
	 * @var bool|Powerform_Quiz_Form_Model
	 */
	...
	public function get_table() {
		...
		$entries  = Powerform_Form_Entry_Model::list_entries( $this->form_id, $per_page, ( $this->get_paged() - 1 ) * $per_page );
	 ...
	 * @return array
	 */
	public function get_integrations_data_from_entry( Powerform_Form_Entry_Model $entry ) {
		...
		if ( empty( self::$registered_addons ) ) {
			...
			foreach ( $registered_addons as $registered_addon ) {
				try {
					...
					powerform_addon_maybe_log( $registered_addon->get_slug(), 'failed to get_addon_quiz_hooks', $e->getMessage() );
				}
			}
		}
	 ...
	 *
	 * @see   Powerform_Addon_Quiz_Hooks_Abstract::on_render_entry()
	 * @since 1.6.2
	 *
