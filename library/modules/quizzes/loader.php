...
class Powerform_Quizzes extends Powerform_Module {
	...
	public function options() {
		return array(
			...
			'description'   => __( "Erstelle lustige Testfragen für Deine Benutzer, die sie in den sozialen Medien bearbeiten und teilen können. Eine großartige Möglichkeit, mehr Traffic auf Deine Webseite zu lenken.", Powerform::DOMAIN ),
			'button_label'  => __( "Neuer Test", Powerform::DOMAIN ),
