...
/**
 * Class Powerform_Quizzes
 *
 * @since 1.0
 */
class Powerform_Quizzes extends Powerform_Module {

	/**
	 * Module instance
	 *
	 * @var null|Powerform_Quizzes
	 */
	...
	public function init() {
		...
		if ( class_exists( 'Powerform_Quiz_General_Data_Protection' ) ) {
			new Powerform_Quiz_General_Data_Protection();
		}
	}
	...
	public function load_front() {
		...
		new Powerform_QForm_Front();
		new Powerform_Quizz_Front_Action();
		new Powerform_QForm_Result();

		add_action( 'wp_ajax_powerform_load_quiz', array( 'Powerform_QForm_Front', 'ajax_load_module' ) );
		add_action( 'wp_ajax_nopriv_powerform_load_quiz', array( 'Powerform_QForm_Front', 'ajax_load_module' ) );

		add_action( 'wp_ajax_powerform_reload_quiz', array( 'Powerform_QForm_Front', 'ajax_reload_module' ) );
		add_action( 'wp_ajax_nopriv_powerform_reload_quiz', array( 'Powerform_QForm_Front', 'ajax_reload_module' ) );
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'powerform_quizzes', $args );
	}
