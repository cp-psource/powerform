...
/**
 * Powerform_Quiz_Front_Mail
 *
 * @since 1.6.2
 */
class Powerform_Quiz_Front_Mail extends Powerform_Mail {
	...
	public function process_mail( $quiz, $data, Powerform_Form_Entry_Model $entry ) {
		 ...
		 * @param Powerform_Quiz_Form_Model  $quiz - the quiz model
		 * @param Powerform_Form_Entry_Model $entry
		 *
		 *
		 * @return array $data
		 */
		$data = apply_filters( 'powerform_quiz_mail_data', $data, $quiz, $entry );

		/**
		 * Action called before mail is sent
		 *
		 * @param Powerform_Quiz_Front_Mail  $this - the current mail class
		 ...
		 *
		 * @param Powerform_Quiz_Front_Mail $this mail class
		 * @param Powerform_Quiz_Form_Model $quiz current quiz
		 * @param array                      $data current data
		 */
		do_action( 'powerform_quiz_mail_after_send_mail', $this, $quiz, $data );
	}
