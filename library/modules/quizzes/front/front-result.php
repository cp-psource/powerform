 ...
 */
class Powerform_QForm_Result extends Powerform_Result {
	...
	private function get_og_description_knowledge( $quiz, $entry ) {
		 ...
		 */
		$description = apply_filters( 'powerform_quiz_knowledge_result_page_meta_description', $description, $quiz, $entry_id, $right, $total, $quiz_title );
	...
	private function get_og_description_nowrong( $quiz, $entry ) {
		 ...
		 * @param string                     $quiz_title Quiz name
		 */
		$description = apply_filters( 'powerform_quiz_nowrong_result_page_meta_description', $description, $quiz, $entry_id, $result, $quiz_title );
