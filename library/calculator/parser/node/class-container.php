 ...
 *
 */
class Powerform_Calculator_Parser_Node_Container extends Powerform_Calculator_Parser_Node_Abstract {

	/**
	 * Array of (sorted) child nodes
	 * Notice: The number of child nodes can be 0.
	 *
	 * @var Powerform_Calculator_Parser_Node_Abstract[]
	 */
	 ...
	 *
	 * @param Powerform_Calculator_Parser_Node_Abstract[] $child_nodes
	 *
	...
	public function set_child_nodes( $child_nodes ) {
		...
		foreach ( $child_nodes as $child_node ) {
			if ( ! $child_node instanceof Powerform_Calculator_Parser_Node_Abstract ) {
