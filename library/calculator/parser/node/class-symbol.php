 ...
 *
 */
class Powerform_Calculator_Parser_Node_Symbol extends Powerform_Calculator_Parser_Node_Abstract {

	/**
	 * The token of the node. It contains the value.
	 *
	 * @var Powerform_Calculator_Parser_Token
	 */
	protected $token;
	 ...
	 *
	 * @param Powerform_Calculator_Parser_Token    $token
	 * @param Powerform_Calculator_Symbol_Abstract $symbol
	 */
	...
	public function set_is_unary_operator( $is_unary_operator = true ) {
		if ( ! $this->symbol instanceof Powerform_Calculator_Symbol_Operator_Abstract ) {
			throw new Powerform_Calculator_Exception(
