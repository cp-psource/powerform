 ...
 *
 */
class Powerform_Calculator_Symbol_Loader {
	...
	private $symbol_registry = array(
		'Powerform_Calculator_Symbol_Number',

		'Powerform_Calculator_Symbol_Separator',

		'Powerform_Calculator_Symbol_Opening_Bracket',
		'Powerform_Calculator_Symbol_Closing_Bracket',

		'Powerform_Calculator_Symbol_Constant_Pi',

		'Powerform_Calculator_Symbol_Operator_Addition',
		'Powerform_Calculator_Symbol_Operator_Division',
		'Powerform_Calculator_Symbol_Operator_Exponentiation',
		'Powerform_Calculator_Symbol_Operator_Modulo',
		'Powerform_Calculator_Symbol_Operator_Multiplication',
		'Powerform_Calculator_Symbol_Operator_Subtraction',

		'Powerform_Calculator_Symbol_Function_Abs',
		'Powerform_Calculator_Symbol_Function_Avg',
		'Powerform_Calculator_Symbol_Function_Ceil',
		'Powerform_Calculator_Symbol_Function_Days_Between',
		'Powerform_Calculator_Symbol_Function_Floor',
		'Powerform_Calculator_Symbol_Function_Hours_Between',
		'Powerform_Calculator_Symbol_Function_Max',
		'Powerform_Calculator_Symbol_Function_Min',
		'Powerform_Calculator_Symbol_Function_Minutes_Between',
		'Powerform_Calculator_Symbol_Function_Months_Between',
		'Powerform_Calculator_Symbol_Function_Round',
		'Powerform_Calculator_Symbol_Function_Seconds_Between',
		'Powerform_Calculator_Symbol_Function_Years_Between',
	);
	/**
	 * Array with all available symbols
	 *
	 * @var Powerform_Calculator_Symbol_Abstract[]
	 */
	protected $symbols;
	...
	protected function prepare() {
		 ...
		 * @return string[]
		 */
		$symbol_registry = apply_filters( 'powerform_calculator_symbol_registry', $symbol_registry );
	 ...
	 *
	 * @return Powerform_Calculator_Symbol_Abstract|null
	 */
	 ...
	 *
	 * @return Powerform_Calculator_Symbol_Abstract[]
	 */
