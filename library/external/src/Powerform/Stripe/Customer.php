 ...
 * @property \Powerform\Stripe\Discount|null $discount
 ...
 * @property \Powerform\Stripe\Collection $sources
 * @property \Powerform\Stripe\Collection $subscriptions
 * @property string|null $tax_exempt
 * @property \Powerform\Stripe\Collection $tax_ids
 *
 * @package Stripe
 */
