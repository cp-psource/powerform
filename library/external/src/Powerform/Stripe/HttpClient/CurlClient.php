...
namespace Powerform\Stripe\HttpClient;

use Powerform\Stripe\Stripe;
use Powerform\Stripe\Exception;
use Powerform\Stripe\Util;
...
class CurlClient implements ClientInterface
{
    ...
    /** @var \Powerform\Stripe\Util\RandomGenerator */
     ...
     * 3. \Powerform\Stripe\Util\CaseInsensitiveArray $rheaders The response headers
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\Powerform\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
