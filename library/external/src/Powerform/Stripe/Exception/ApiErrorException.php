...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param array|\Powerform\Stripe\Util\CaseInsensitiveArray|null $httpHeaders The HTTP headers array.
     ...
     *
     * @return \Powerform\Stripe\ErrorObject|null
     */
     ...
     *
     * @param \Powerform\Stripe\ErrorObject|null $error
     */
     ...
     *
     * @return array|\Powerform\Stripe\Util\CaseInsensitiveArray|null
     */
     ...
     *
     * @param array|\Powerform\Stripe\Util\CaseInsensitiveArray|null $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \Powerform\Stripe\ErrorObject} for possible
     * values.
     *
     * @return string|null
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \Powerform\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
