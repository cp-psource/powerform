 ...
 * @property \Powerform\Stripe\Collection $refunds
...
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \Powerform\Stripe\Exception\CardException exception.
