 ...
 * Author: Hoang Ngo
 */
class Powerform_Quiz_Form_Model extends Powerform_Base_Form_Model {

	/**
	 * @var string
	 */
	protected $post_type = 'powerform_quizzes';
	 ...
	 *
	 * @return Powerform_Quiz_Form_Model
	 */
	...
	public function is_ajax_load( $force = false ) {
		 ...
		 * @return bool
		 */
		$enabled = apply_filters( 'powerform_quiz_is_ajax_load', $enabled, $global_enabled, $quiz_id, $form_settings );
	...
	public function is_use_donotcachepage_constant() {
		 ...
		 * @return bool
		 */
		$enabled = apply_filters( 'powerform_quiz_is_use_donotcachepage_constant', $enabled, $global_enabled, $quiz_id, $form_settings );
	...
	public function is_prevent_store() {
		 ...
		 */
		$is_prevent_store = apply_filters( 'powerform_quiz_is_prevent_store', $is_prevent_store, $quiz_id, $quiz_settings );
