 ...
 */
class Powerform_Form_Views_Model {
	 ...
	 *
	 * @since 1.0
	 * @return Powerform_Form_Views_Model
	 */
	...
	/**
	 * Powerform_Form_Views_Model constructor.
	 *
	 * @since 1.0
	 */
	public function __construct() {
		$this->table_name = Powerform_Database_Tables::get_table_name( Powerform_Database_Tables::FORM_VIEWS );
	}
	...
	public function save_view( $form_id, $page_id, $ip ) {
		global $wpdb;
		if ( ! defined( 'POWERFORM_VIEWS_ENABLE_TRACK_IP' ) || ( defined( 'POWERFORM_VIEWS_ENABLE_TRACK_IP' ) && ! POWERFORM_VIEWS_ENABLE_TRACK_IP ) ) {
			$ip = null;
		}
	 ...
	 *
	 * @since 1.0
	 * @param string $form_type - the form type (Powerform_Base_Form_Model - post_type)
	 * @param string $starting_date - the start date (dd-mm-yyy)
	 * @param string $ending_date - the end date (dd-mm-yyy)
	 *
