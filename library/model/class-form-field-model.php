 ...
 */
class Powerform_Form_Field_Model {
	/**
	...
	/**
	 * Powerform_Form_Field_Model constructor.
	 *
	 * @param $version
	 */
	...
	public function __get( $name ) {
		...
		$value = apply_filters( 'powerform_get_field_' . $this->slug, $value, $this->form_id, $name );
	...
	public function __set( $name, $value ) {
		...
		$value              = apply_filters( 'powerform_set_field_' . $this->slug, $value, $this->form_id, $name );
		$this->raw[ $name ] = $value;
	}
	...
	public function to_formatted_array() {
		return Powerform_Migration::migrate_field( $this->raw, $this->form_settings );
	}
