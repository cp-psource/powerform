...
/**
 * Powerform Akismet protection
 * Use the akismet api to check for possible spam posted
 *
 * Akismet API: http://akismet.com/development/api/
 */
class Powerform_Akismet extends Powerform_Spam_Protection {


	/**
	 * Plugin instance
	 *
	 * @var null|Powerform_Akismet
	 */
	...
	private function _akismet_check( $post_data, $form_id ) {
		...
		return apply_filters( 'powerform_akismet_is_spam', $is_spam, $post_data, $form_id );
	}
