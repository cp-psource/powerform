...
function powerform_pp_currency_list() {
	return apply_filters(
		'powerform_pp_currency_list',
		array(
 ...
 * @return array
 */
function powerform_currency_list() {
	return apply_filters(
		'powerform_currency_list',
		array(
 ...
 * @return string
 */
function powerform_get_currency( $currency_code ) {
 ...
 * @return string
 */
function powerform_get_currency_symbol() {
	$currency         = get_option( 'powerform_currency', 'USD' );
	$current_currency = powerform_get_currency( $currency );
