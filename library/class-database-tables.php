 ...
 */
class Powerform_Database_Tables {
	 ...
	 *
	 * @deprecated on 1.1 use powerform_drop_custom_tables on uninstall.php
	 * @since 1.0
	 */
	public static function uninstall_database_tables() {
		_deprecated_function(__METHOD__, '1.1', 'powerform_drop_custom_tables');
		global $wpdb;
