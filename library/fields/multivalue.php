...
class Powerform_MultiValue extends Powerform_Field {
	...
	public function __construct() {
		...
		$this->name = __( 'Checkbox', Powerform::DOMAIN );
	}
	...
	public function defaults() {
		return array(
			'value_type'  => 'checkbox',
			'field_label' => __( 'Checkbox', Powerform::DOMAIN ),
			'layout'      => 'vertical',
			'options'     => array(
				array(
	...
	public function markup( $field, $settings = array() ) {
		...
		$class       = ( 'horizontal' === self::get_property( 'layout', $field, '' ) ) ? 'powerform-checkbox powerform-checkbox-inline' : 'powerform-checkbox';
	...
	public function get_validation_rules() {
		...
		return apply_filters( 'powerform_field_multiple_validation_rules', $rules, $id, $field );
	}
	...
	private function calculable_value( $submitted_data, $field_settings ) {
		...
		foreach ( $options as $option ) {
			...
			powerform_maybe_log( __METHOD__, $option_value, $submitted_data );
	...
	public function get_calculable_value( $submitted_data, $field_settings ) {
		 ...
		 */
		$calculable_value = apply_filters( 'powerform_field_multi_calculable_value', $calculable_value, $submitted_data, $field_settings );
