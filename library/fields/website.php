...
class Powerform_Website extends Powerform_Field {
	...
	public function __construct() {
		...
		$this->name = __( 'Website', Powerform::DOMAIN );
	}
	...
	public function defaults() {
		return array(
			'field_label' => __( 'Website', Powerform::DOMAIN ),
			'placeholder' => __( 'E.g. http://www.example.com', Powerform::DOMAIN ),
		);
	}
	...
	public function markup( $field, $settings = array() ) {
		...
		$website = array(
			...
			'id'            => $id,
			'class'         => 'powerform-input powerform-website--field',
	...
	public function get_validation_rules() {
		...
		return apply_filters( 'powerform_field_website_validation_rules', $rules, $id, $field );
	}
	...
	public function get_validation_messages() {
		...
		$required_message   = self::get_property( 'required_message', $field, __( 'This field is required. Please input a valid URL', Powerform::DOMAIN ) );
		...
		$validation_message = ! empty( $validation_message ) ? $validation_message : __( 'Please enter a valid Website URL (e.g. https://n3rds.work/).', Powerform::DOMAIN );
		if ( $validation_enabled ) {
		...
		$messages .= '"validurl": "' . powerform_addcslashes( $validation_message ) . '",' . "\n";
		$messages .= '},' . "\n";
