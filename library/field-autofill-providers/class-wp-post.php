...
class Powerform_WP_Post_Autofill_Provider extends Powerform_Autofill_Provider_Abstract {
	...
	/**
	 * Powerform_WP_Post_Autofill_Provider constructor.
	 */
	public function __construct() {

		$attributes_map = array(
			'id'        => array(
				'name'         => __( 'ID', Powerform::DOMAIN ),
			...
			'permalink' => array(
				'name'         => __( 'Permalink', Powerform::DOMAIN ),
	...
	/**
	 * @return Powerform_Autofill_Provider_Interface|Powerform_WP_Post_Autofill_Provider|null
	 */
