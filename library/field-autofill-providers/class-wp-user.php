...
class Powerform_WP_User_Autofill_Provider extends Powerform_Autofill_Provider_Abstract {
	...
	/**
	 * @return Powerform_Autofill_Provider_Interface|Powerform_WP_User_Autofill_Provider|null
	 */
	...
	/**
	 * Powerform_WP_User_Autofill_Provider constructor.
	 */
	public function __construct() {
		$attributes_map = array(
			...
			'email'        => array(
				'name'         => __( 'Email', Powerform::DOMAIN ),
