...
/**
 * Class Powerform_General_Data_Protection
 *
 * What it does :
 ...
 * @since 1.0.6
 */
abstract class Powerform_General_Data_Protection {
	...
	protected function init() {
		...
		if ( ! wp_next_scheduled( 'powerform_general_data_protection_cleanup' ) ) {
			wp_schedule_event( time(), $this->get_cron_cleanup_interval(), 'powerform_general_data_protection_cleanup' );
		}

		add_action( 'powerform_general_data_protection_cleanup', array( $this, 'personal_data_cleanup' ) );
	...
	public function get_cron_cleanup_interval() {
		 ...
		 */
		$cron_cleanup_interval = apply_filters( 'powerform_general_data_cleanup_interval', $cron_cleanup_interval );
