...
class Powerform_Protection {
	...
	private function include_in_built() {
		...
		include_once powerform_plugin_dir() . 'library/protection/class-akismet.php';
	}
	...
	public function init_modules() {
		Powerform_Akismet::get_instance();
