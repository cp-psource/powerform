! function(e) {
    ...
    */
    ...
    var ua = {
        ...
        wa = ca.extend({ key: function(e) { if (e.key) { var t = ga[e.key] || e.key; if ("Unidentified" !== t) return t } return "keypress" === e.type ? (e = Ie(e), 13 === e ? "Enter" : String.fromCharCode(e)) : "keydown" === e.type || "keyup" === e.type ? _a[e.keyCode] || "Unidentified" : "" }, location: null, ctrlKey: null, shiftKey: null, altKey: null, metaKey: null, repeat: null, locale: null, getModifierState: Ae, charCode: function(e) { return "keypress" === e.type ? Ie(e) : 0 }, keyCode: function(e) { return "keydown" === e.type || "keyup" === e.type ? e.keyCode : 0 }, which: function(e) { return "keypress" === e.type ? Ie(e) : "keydown" === e.type || "keyup" === e.type ? e.keyCode : 0 } }),
            ...
            return i(t, e), s(t, [{
                ...
                value: function() {
                    var e = !!this.props.answer.title,
                        t = e ? "" : "fui-error";
                    return u.default.createElement("li", { "data-index": this.props.counter, className: "answer-row " + t }, u.default.createElement("span", { className: "fui-answer--move" }, u.default.createElement("i", { className: "sui-icon-drag", "aria-hidden": "true" })), u.default.createElement("span", { className: "fui-answer--fields" }, u.default.createElement("div", { className: "sui-form-field" }, u.default.createElement("input", { className: "sui-form-control", defaultValue: this.props.answer.title, onChange: this.updateTitle.bind(this) })), !0 === this.props.answer.use_extra && u.default.createElement("div", { className: "sui-form-field" }, u.default.createElement("input", { className: "sui-form-control", placeholder: (0, c.translate)("Platzhalter eingeben"), defaultValue: this.props.answer.extra, onChange: this.updateExtra.bind(this) }))), u.default.createElement("span", { className: "fui-answer--actions" }, u.default.createElement("button", { onClick: this.deleteField, className: "sui-button-icon sui-button-red sui-tooltip", "data-tooltip": (0, c.translate)("Löschen") }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Antwort löschen"))), u.default.createElement("span", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Antwortoptionen"))), u.default.createElement("ul", null, !0 !== this.props.answer.use_extra && u.default.createElement("li", null, u.default.createElement("button", { onClick: this.addExtra.bind(this) }, (0, c.translate)("Benutzerdefinierte Eingabe aktivieren"))), !0 === this.props.answer.use_extra && u.default.createElement("li", null, u.default.createElement("button", { onClick: this.removeExtra.bind(this) }, (0, c.translate)("Benutzerdefinierte Eingabe entfernen")))))))
                }
            }]), t
        }(l.Component);
    t.default = f
