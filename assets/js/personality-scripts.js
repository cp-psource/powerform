    ...
    */
    ...
    var s = function() {
        ...
        f = function(e) {
            ...
            }, { key: "render", value: function() { var e = ""; return _.isUndefined(this.props.result.image) || _.isEmpty(this.props.result.image) || (e = "url(" + this.props.result.image + ")"), u.default.createElement("div", { className: "sui-builder-field sui-react sui-can_move" }, u.default.createElement("div", { className: "sui-field-info", onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-drag", "aria-hidden": "true" }), u.default.createElement("div", { className: "sui-builder-field-label" }, u.default.createElement("div", { className: "sui-builder-field-image", "aria-hidden": "true" }, u.default.createElement("span", { style: { backgroundImage: e } })), u.default.createElement("span", null, this.props.result.title))), u.default.createElement("div", { className: "sui-field-actions" }, u.default.createElement("div", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Einstellungen für offenes Feld"))), u.default.createElement("ul", null, u.default.createElement("li", null, u.default.createElement("button", { onClick: this.editModal }, u.default.createElement("i", { className: "sui-icon-pencil", "aria-hidden": "true" }), (0, c.translate)("Bearbeiten"))), u.default.createElement("li", null, u.default.createElement("button", { onClick: this.duplicateResult }, u.default.createElement("i", { className: "sui-icon-copy", "aria-hidden": "true" }), (0, c.translate)("Duplizieren"))), u.default.createElement("li", null, u.default.createElement("button", { className: "sui-option-red", onClick: this.deleteResult }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0, c.translate)("Löschen"))))))) } }]), t
        }(l.Component);
    t.default = f
}, function(e, t, n) {
    "use strict";
