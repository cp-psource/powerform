...
(function($, window, document, undefined) {
    ...
    function PowerformFrontCondition(element, options) {
    ...
    $.extend(PowerformFrontCondition.prototype, {
        init: function() {
            ...
            this.$el.find('.powerform-field input, .powerform-field select').change(function(e) {
                var $element = $(this),
            ...
            // Simulate change
            this.$el.find('.powerform-field input, .powerform-field select').change();
            this.init_events();
        },
    ...
    $.fn[pluginName] = function(options) {
        return this.each(function() {
            if (!$.data(this, pluginName)) {
                $.data(this, pluginName, new PowerformFrontCondition(this, options));
            }
        });
    };
