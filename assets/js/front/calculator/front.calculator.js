/**********
 * Attempt to rewrite Powerform_Calculator backend
 *
 * @see Powerform_Calculator
 *
 ***********/
...
if (window['powerformCalculator'] === undefined) {
    window.powerformCalculator = function(term) {
