! function(e) {
    ...
    var n = {};
    t.m = e, t.c = n, t.d = function(e, n, r) { t.o(e, n) || Object.defineProperty(e, n, { configurable: !1, enumerable: !0, get: r }) }, t.n = function(e) { var n = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(n, "a", n), n }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "", t(t.s = 485)
        ...
        return _.isUndefined(n) || _.isUndefined(n.main_date_field) || !0 !== n.main_date_field || (a = !0), e.map(function(e) {
            e.fields.map(function(e) {
                if (!_.contains(t, e.type)) {
                    var n = void 0;
                    _.isUndefined(e.field_label) || _.isEmpty(e.field_label) ? (n = e.type, n = P(n)) : n = e.field_label, "name" === e.type ? r = r.concat(N(e, n)) : "address" === e.type ? r = r.concat(F(e, n)) : "time" === e.type ? r = r.concat(R(e, n)) : "date" === e.type && "picker" !== e.field_type && !1 === a || r.push({ element_id: e.element_id, required: e.required, field_type: e.type, field_slug: e.type, label: n, values: A(e), hasOptions: M(e), hasCalcs: S(e), formula: T(e), isNumber: C(e), fieldData: e }), "date" === e.type && "picker" !== e.field_type && (r = r.concat(k(e, n)))
                }
            })
        }), r
    }
    ...
    function N(e, t) {
        ...
        }) : n.push({ element_id: e.element_id, required: e.required, field_type: e.type, field_slug: e.type, label: t, values: A(e), hasOptions: M(e), isNumber: C(e) }), n
    }
    ...
    function M(e) { return "select" === e.type || "checkbox" === e.type || "radio" === e.type }
    ...
    function k(e, t, n) { return (e << 32 - n | t >>> n) >>> 0 }
    var N = n(62),
        C = n(63);
    ...
    function u(e) {
        var t, n, u = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            T = k + "Subscription",
            M = v++,
            A = (t = {}, t[k] = y.a, t[T] = y.b, t),
            F = (n = {}, n[T] = y.b, n);
        return function(t) {
            d()("function" == typeof t, "You must pass a component to the function returned by " + E + ". Instead received " + JSON.stringify(t));
            var n = t.displayName || t.name || "Component",
                i = p(n),
                u = b({}, S, { getDisplayName: p, methodName: E, renderCountProp: O, shouldHandleStateChanges: P, storeKey: k, withRef: C, displayName: i, wrappedComponentName: n, WrappedComponent: t }),
                c = function(n) {
                    function c(e, t) { r(this, c); var o = a(this, n.call(this, e, t)); return o.version = M, o.state = {}, o.renderCount = 0, o.store = e[k] || t[k], o.propsMode = Boolean(e[k]), o.setWrappedInstance = o.setWrappedInstance.bind(o), d()(o.store, 'Could not find "' + k + '" in either the context or props of "' + i + '". Either wrap the root component in a <Provider>, or explicitly pass "' + k + '" as a prop to "' + i + '".'), o.initSelector(), o.initSubscription(), o }
    ...
    function a(e, t) {
        var n = A(e) || d(e) ? r(e.length, String) : [],
            a = n.length,
            o = !!a;
        for (var i in e) !t && !k.call(e, i) || o && ("length" == i || u(i, a)) || n.push(i);
        return n
    }

    function o(e, t, n) {
        var r = e[t];
        k.call(e, t) && p(r, n) && (void 0 !== n || t in e) || (e[t] = n)
    }

    function i(e) { if (!f(e)) return S(e); var t = []; for (var n in Object(e)) k.call(e, n) && "constructor" != n && t.push(n); return t }
    ...
    function d(e) { return m(e) && k.call(e, "callee") && (!C.call(e, "callee") || N.call(e) == w) }
    ...
    var E = 9007199254740991,
        ...
        }(function(e, t) { if (M || f(t) || h(t)) return void l(t, _(t), e); for (var n in t) k.call(t, n) && o(e, n, t[n]) });
    e.exports = F
    ...
    t.a = function() {
        ...
        return function(e, t, i) {
            var l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                ...
                k = a(i, v, "mergeProps");
            return n(_, p({ methodName: "connect", getDisplayName: function(e) { return "Connect(" + e + ")" }, shouldHandleStateChanges: Boolean(e), initMapStateToProps: P, initMapDispatchToProps: x, initMergeProps: k, pure: c, areStatesEqual: d, areOwnPropsEqual: b, areStatePropsEqual: E, areMergedPropsEqual: O }, j))
        }
    }()
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(28),
        ...
        h = function() {
            ...
            var t = window.history,
                ...
                j = function(e) { Object(c.d)(e) || k(_(e.state)) },
                P = function() { k(_(d())) },
                x = !1,
                k = function(e) {
                    if (x) x = !1, O();
                    else { w.confirmTransitionTo(e, "POP", y, function(t) { t ? O({ action: "POP", location: e }) : N(e) }) }
                },
                N = function(e) {
                    var t = V.location,
                ...
                V = { length: t.length, action: "POP", location: C, createHref: T, push: M, replace: A, go: F, goBack: R, goForward: D, block: z, listen: L };
            return V
        };
    t.a = h
}, function(e, t, n) {
    ...
    var r = n(28),
        ...
        y = function() {
            ...
            var M = w(),
                ...
                z = 0,
                L = function(e) { z += e, 1 === z ? Object(c.a)(window, "hashchange", k) : 0 === z && Object(c.e)(window, "hashchange", k) },
                V = !1,
                B = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                        t = O.setPrompt(e);
                ...
                $ = { length: t.length, action: "POP", location: M, createHref: F, push: R, replace: D, go: q, goBack: U, goForward: I, block: B, listen: Q };
            return $
        };
    t.a = y
}, function(e, t, n) {
    ...
    var r = n(28),
        ...
        f = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                k = function() { var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0]; return m.setPrompt(e) },
                N = function(e) { return m.appendListener(e) },
                C = { length: g.length, action: "POP", location: g[v], index: v, entries: g, createHref: _, push: E, replace: w, go: O, goBack: j, goForward: P, canGo: x, block: k, listen: N };
            return C
        };
    t.a = f
}, function(e, t, n) {
    ...
    var h = n(0),
        ...
        k = function(e, t, n, r) { var a = this; if (a.instancePool.length) { var o = a.instancePool.pop(); return a.call(o, e, t, n, r), o } return new a(e, t, n, r) };
    ...
    */
    ...
    var s = function() {
        ...
        D = function(e) {
            ...
            }, { key: "handleBeforeunload", value: function(e) { if (window.powerformChanges.length > 0 || !0 === window.powerformChanges.settings) return e.preventDefault(), e.returnValue = (0, f.translate)("You have unsaved changes, are you sure want to leave this page"), (0, f.translate)("You have unsaved changes, are you sure want to leave this page") } }, { key: "render", value: function() { return u.default.createElement("div", null, u.default.createElement(d.default, null), u.default.createElement("div", { className: "sui-row-with-sidenav" }, u.default.createElement(b.default, this.props), u.default.createElement("div", null, u.default.createElement("div", { id: "powerform-builder-status", className: "sui-box sui-box-sticky", ref: "StickyHeader" }, u.default.createElement(g.default, null)), u.default.createElement(c.Route, { exact: !0, path: "/", render: function() { return u.default.createElement(c.Redirect, { to: "/intro" }) } }), u.default.createElement(c.Route, { path: "/intro", component: E.default }), u.default.createElement(c.Route, { path: "/questions", component: O.default }), u.default.createElement(c.Route, { path: "/leads", component: P.default }), u.default.createElement(c.Route, { path: "/appearance", component: k.default }), u.default.createElement(c.Route, { path: "/behaviour", component: C.default }), u.default.createElement(c.Route, { path: "/notifications", component: T.default }), u.default.createElement(c.Route, { path: "/integrations", component: A.default }), u.default.createElement(c.Route, { path: "/settings", component: R.default }))), u.default.createElement(m.default, this.props)) } }]), t
        }(l.Component);
    t.default = D
}, function(e, t, n) {
    "use strict";
    ...
    function a(e) { return { modal: e.modal, questions: e.questions, settings: e.settings, notifications: e.notifications, type: "knowledge", id: e.settings.form_id || -1 } }

    function o(e) { return { actions: { builderActions: (0, s.bindActionCreators)(f, e), settingsActions: (0, s.bindActionCreators)(d, e), notificationsActions: (0, s.bindActionCreators)(m, e) } } }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var i = n(7),
        s = n(8),
        l = n(197),
    ...
    function a(e) { return { id: e.settings.form_id, status: e.settings.form_status, state: e, title: e.settings.formName || "", changed: window.powerformChanges, type: "knowledge" } }
    ...
    function o(e) { return { settings: e.settings, type: "knowledge" } }
    ...
    function o(e) { return { settings: e.settings, questions: e.questions, hasLead: e.settings.hasLeads || !1, type: "knowledge" } }
    ...
    function o(e) { return { settings: e.settings, hasLead: e.settings.hasLeads || !1, leadsForm: e.settings.leadsId || !1, type: "knowledge" } }
    ...
    function a(e) { return { settings: e.settings, quizDesign: e.settings["powerform-quiz-theme"] || "default", quizLayout: e.settings.visual_style || "list", quizLoader: e.settings["quiz-ajax-loader"] || "show", hasLead: e.settings.hasLeads || !1 } }
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, this.props.settings.hasLeads && c.default.createElement(m.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(b.default, { value: "default", label: (0, f.translate)("Default") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Main Container"), property: "knowledge-container-color", defaultValue: "rgba(0,0,0,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Title color"), property: "knowledge-title-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Description color"), property: "knowledge-description-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Question color"), property: "knowledge-question-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Quiz result color"), property: "knowledge-summary-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Skip form button"), property: "knowledge-skip-default-color", defaultValue: "#888888" }))), c.default.createElement(b.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Skip form button"), property: "knowledge-skip-hover-color", defaultValue: "#333333" }))), c.default.createElement(b.default, { value: "focus", label: (0, f.translate)("Focus") }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Skip form button"), property: "knowledge-skip-focus-color", defaultValue: "#333333" })))), !this.props.settings.hasLeads && c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Main Container"), property: "knowledge-container-color", defaultValue: "rgba(0,0,0,0)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Title color"), property: "knowledge-title-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Description color"), property: "knowledge-description-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Question color"), property: "knowledge-question-color", defaultValue: "#000000" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Quiz result color"), property: "knowledge-summary-color", defaultValue: "#000000" })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Default") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-border-static", defaultValue: "#EBEDEB", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-background-static", defaultValue: "#FAFAFA", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-border-hover", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-background-hover", defaultValue: "#F3FBFE", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Active") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-border-active", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-background-active", defaultValue: "#F3FBFE", isAlpha: !0 }))), c.default.createElement(m.default, { value: "right", label: (0, f.translate)("Right") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-aright-border", defaultValue: "#0BC30B", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-aright-background", defaultValue: "#F4FCF2", isAlpha: !0 }))), c.default.createElement(m.default, { value: "wrong", label: (0, f.translate)("Wrong") }, "flat" !== this.props.quizDesign && "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-awrong-border", defaultValue: "#DA0000", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-awrong-background", defaultValue: "#FDF2F2", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Default") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-check-border-static", defaultValue: "#BFBFBF", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-check-background-static", defaultValue: "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Active") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-check-border-active", defaultValue: "#17A8E3", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-check-background-active", defaultValue: "#17A8E3", isAlpha: !0 })), "show" === this.props.quizLoader && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Evaluation loader icon"), description: (0, f.translate)('This picker works only when "Evaluation Loader" is set to "Show Loader".'), property: "knowledge-answer-loader-icon-color", defaultValue: "material" === this.props.quizDesign ? "#17A8E3" : "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "right", label: (0, f.translate)("Right") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-check-border-correct", defaultValue: "#0BC30B", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-check-background-correct", defaultValue: "#0BC30B", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Icon color"), property: "knowledge-answer-icon-correct", defaultValue: "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "wrong", label: (0, f.translate)("Wrong") }, "flat" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Border color"), property: "knowledge-answer-check-border-incorrect", defaultValue: "#DA0000", isAlpha: !0 })), "material" !== this.props.quizDesign && c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-answer-check-background-incorrect", defaultValue: "#DA0000", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Icon color"), property: "knowledge-answer-icon-incorrect", defaultValue: "#FFFFFF", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Default") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Answer text color"), property: "knowledge-answer-color-static", defaultValue: "#888888" })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Answer result message"), property: "knowledge-phrasing-color", defaultValue: "#777771" }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Active") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Answer text color"), property: "knowledge-answer-color-active", defaultValue: "#333333" }))), c.default.createElement(m.default, { value: "right", label: (0, f.translate)("Right") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Answer text color"), property: "knowledge-aright-color", defaultValue: "#0BC30B" }))), c.default.createElement(m.default, { value: "wrong", label: (0, f.translate)("Wrong") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Answer text color"), property: "knowledge-awrong-color", defaultValue: "#DA0000" })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { default: "default", type: "tabs", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Default") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-submit-background-static", defaultValue: "#17A8E3", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Label color"), property: "knowledge-submit-color-static", defaultValue: "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-submit-background-hover", defaultValue: "#008FCA", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Label color"), property: "knowledge-submit-color-hover", defaultValue: "#FFFFFF", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Active") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Background color"), property: "knowledge-submit-background-active", defaultValue: "#008FCA", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Label color"), property: "knowledge-submit-color-active", defaultValue: "#FFFFFF", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        d = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(p.default, s({}, this.props, { prefix: "knowledge-title", defaultFont: "Roboto", defaultSize: "36", defaultWeight: "700" })) } }]), t
        }(u.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        d = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(p.default, s({}, this.props, { prefix: "knowledge-description", defaultFont: "Roboto", defaultSize: "16", defaultWeight: "400" })) } }]), t
        }(u.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        d = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(p.default, s({}, this.props, { prefix: "knowledge-question", defaultFont: "Roboto", defaultSize: "16", defaultWeight: "700" })) } }]), t
        }(u.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        d = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(p.default, s({}, this.props, { prefix: "knowledge-phrasing", defaultFont: "Roboto", defaultSize: "13", defaultWeight: "700" })) } }]), t
        }(u.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        d = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(p.default, s({}, this.props, { prefix: "knowledge-skip", defaultFont: "Roboto", defaultSize: "15", defaultWeight: "400" })) } }]), t
        }(u.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
        ...
        g = function(e) {
            ...
            return i(t, e), s(t, [{ key: "componentDidMount", value: function() { jQuery("html, body").animate({ scrollTop: 0 }, "fast") } }, {
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) },
                        n = _.isUndefined(this.props.settings["form-placement"]) ? "" : this.props.settings["form-placement"];
                    return u.default.createElement("div", { id: "powerform-form-fields", className: "sui-box" }, u.default.createElement("div", { className: "sui-box-header" }, u.default.createElement("h2", { className: "sui-box-title" }, (0, c.translate)("Behaviour"))), u.default.createElement("div", { className: "sui-box-body" }, u.default.createElement(u.default.Fragment, null, "end" !== n && u.default.createElement(h.default, this.props), u.default.createElement(y.default, this.props), u.default.createElement(v.default, this.props), u.default.createElement(p.default, this.props))), u.default.createElement("div", { className: "sui-box-footer" }, u.default.createElement("button", { className: "sui-button", onClick: function() { return t("appearance") } }, u.default.createElement("i", { className: "sui-icon-arrow-left", "aria-hidden": "true" }), (0, c.translate)("Appearance")), u.default.createElement("div", { className: "sui-actions-right" }, u.default.createElement("button", { className: "sui-button sui-button-icon-right", onClick: function() { return t("notifications") } }, (0, c.translate)("Notifications"), u.default.createElement("i", { className: "sui-icon-arrow-right", "aria-hidden": "true" })))))
                }
            }]), t
        }(l.Component);
    t.default = g
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Results")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Choose how do you want to show quiz results to the participants."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "results_behav", defaultValue: "after", settingsLabel: (0, f.translate)("Display Method"), settingsDesc: (0, f.translate)("Choose whether to display the correct answer as the user answers each question or after the quiz is submitted."), divClass: "sui-tabs-content-lg" }), c.default.createElement(b.default, s({}, this.props, { value: "after", label: (0, f.translate)("Real Time") })), c.default.createElement(m.default, { value: "end", label: (0, f.translate)("On Submission") })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, s({}, this.props, { property: "quiz-ajax-loader", default: "show", label: "", settingsLabel: (0, f.translate)("Evaluation Loader"), settingsDesc: (0, f.translate)("Choose whether you want to show a loader while evaluating the selected answer in real-time. We recommend using this on long quizzes since evaluating an answer might take a bit longer.") }), c.default.createElement(b.default, { value: "show", label: (0, f.translate)("Show Loader"), boxClass: "sui-tab-boxed" }), c.default.createElement(m.default, { value: "none", label: (0, f.translate)("None") })) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t(e) { return r(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return o(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement(l.default.Fragment, null, l.default.createElement("p", { className: "sui-description" }, (0, u.translate)("Note: You can change the color of the loader in the Appearance tab.")), l.default.createElement("div", { className: "fui-demo fui-demo--quiz fui-demo--default" }, l.default.createElement("label", null, l.default.createElement("input", { type: "radio", checked: !0 }), l.default.createElement("span", { className: "powerform-ui" }, l.default.createElement("span", { className: "sui-icon-loader", "aria-hidden": "true" }), l.default.createElement("span", null, "Option Selected"))))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        y = function(e) {
            function t() { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Messages")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Choose the copy of the messages for the correct and wrong answers and also for the final score count."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Correct Answer Message"), description: (0, f.translate)("Use {{strong}}%UserAnswer%{{/strong}} and {{strong}}%CorrectAnswer%{{/strong}} to display the answer chosen by the user and the correct answer for each question respectively.", { components: { strong: c.default.createElement("strong", null) } }), property: "msg_correct", defaultValue: "" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Incorrect Answer Message"), description: (0, f.translate)("Use {{strong}}%UserAnswer%{{/strong}} and {{strong}}%CorrectAnswer%{{/strong}} to display the answer chosen by the user and the correct answer for each question respectively.", { components: { strong: c.default.createElement("strong", null) } }), property: "msg_incorrect", defaultValue: "" })), c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Final Count Message"), description: (0, f.translate)("Final count message will appear after the quiz is complete. Use {{strong}}%YourNum%{{/strong}} to display number of correct answers and {{strong}}%Total%{{/strong}} for total number of questions.", { components: { strong: c.default.createElement("strong", null) } }), property: "msg_count", defaultValue: "", disableMiscData: !0, enableFormData: !1, mainOptions: { quiz_name: (0, f.translate)("Quiz Name"), quiz_answer: (0, f.translate)("Quiz Answer"), quiz_result: (0, f.translate)("Quiz Result") } })))) } }]), t
        }(u.Component);
    t.default = y
}, function(e, t, n) {
    "use strict";
    ...
    function o(e) { return { actions: { settingsActions: (0, s.bindActionCreators)(u, e), notificationsActions: (0, s.bindActionCreators)(f, e), modalActions: (0, s.bindActionCreators)(d, e) } } }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var i = n(7),
        s = n(8),
        l = n(27),
