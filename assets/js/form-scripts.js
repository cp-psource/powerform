! function(e) {
        ...
        u = function(e) {
            ...
            return o(t, e), i(t, [{ key: "toggleValue", value: function(e) { "function" == typeof this.props.updateProperty ? this.props.updateProperty(this.props.property, e) : this.props.actions.settingsActions.updateSetting(this.props.property, e) } }, {
                ...
                value: function() {
                    ...
                    var u = "";
                    !this.props.label && this.props.settingsDesc && (u = s.default.createElement("span", { className: "sui-description", style: { marginBottom: "10px" } }, this.props.settingsDesc));
    ...
    */
    ...
    function d(e, t, n) { for (var r = [], a = 0; a < e.length; a++) r.push(b(e[a], t, n).source); return c(new RegExp("(?:" + r.join("|") + ")", f(n)), t) }
    ...
    var ja = Rr.canUseDOM && "TextEvent" in window && !xa,
        ...
        Ca = { beforeInput: { phasedRegistrationNames: { bubbled: "onBeforeInput", captured: "onBeforeInputCapture" }, dependencies: ["compositionend", "keypress", "textInput", "paste"] }, compositionEnd: { phasedRegistrationNames: { bubbled: "onCompositionEnd", captured: "onCompositionEndCapture" }, dependencies: "blur compositionend keydown keypress keyup mousedown".split(" ") }, compositionStart: { phasedRegistrationNames: { bubbled: "onCompositionStart", captured: "onCompositionStartCapture" }, dependencies: "blur compositionstart keydown keypress keyup mousedown".split(" ") }, compositionUpdate: { phasedRegistrationNames: { bubbled: "onCompositionUpdate", captured: "onCompositionUpdateCapture" }, dependencies: "blur compositionupdate keydown keypress keyup mousedown".split(" ") } },
        Na = !1,
        Sa = !1,
        Ta = {
            eventTypes: Ca,
    ...
    function r(e, t, n) { return l({}, n, e, t) }
    ...
    var r = n(26),
        ...
        h = function() {
            ...
            var t = window.history,
                ...
                P = function(e) {
                    if (k) k = !1, O();
                    else { w.confirmTransitionTo(e, "POP", b, function(t) { t ? O({ action: "POP", location: e }) : C(e) }) }
                },
                C = function(e) {
                    var t = z.location,
    ...
    var r = n(26),
        ...
        b = function() {
            ...
            var t = window.history,
                ...
                C = function(e) {
                    if (j) j = !1, x();
                    else { O.confirmTransitionTo(e, "POP", o, function(t) { t ? x({ action: "POP", location: e }) : N(e) }) }
                },
                N = function(e) {
                    var t = $.location,
    ...
    function i(e, t, n, a) {
        ...
        if (Array.isArray(e))
            ...
            if (d)
                ...
                var _ = "",
                    w = "" + e;
                y(!1, "Objects are not valid as a React child (found: %s).%s", "[object Object]" === w ? "object with keys {" + Object.keys(e).join(", ") + "}" : w, _)
            }
        }
        return c
    }
    ...
    var r = n(73),
        ...
        s = function e(t, n, a, o, i, s, u, c, f, p, d, h) {
            ...
            if ("string" == typeof m || "number" == typeof m || "boolean" == typeof m || r.isBuffer(m)) { if (s) { return [d(h ? n : s(n, l.encoder)) + "=" + d(s(m, l.encoder))] } return [d(n) + "=" + d(String(m))] }
            var b = [];
                ...
                value: function(e, t, n) {
                    ...
                    n && (this.$el.find(".sui-box-body").html('<p class="fui-loading-dialog" aria-label="Loading content"><i class="sui-icon-loader sui-loading" aria-hidden="true"></i></p>'), this.$el.find(".sui-box-footer").html(""), this.$el.find(".integration-header").html("")), this.$el.find(".sui-button:not(.disable-loader)").addClass("sui-button-onload"), this.ajax = jQuery.post({ url: powerformData.ajaxUrl, type: "post", data: e }).done(function(e) {
                        if (e && e.success) {
                            ...
                            var n = e.data.data;
                            if (r.onRender(n), r.$el.find(".sui-button").removeClass("sui-button-onload"), (t || !_.isUndefined(n.is_close) && n.is_close) && r.close(r), r.$el.find(".powerform-addon-close").on("click", function() { r.close(r) }), !_.isUndefined(n.notification) && !_.isUndefined(n.notification.type) && !_.isUndefined(n.notification.text)) { new s.default({ type: n.notification.type, text: n.notification.text, time: 4e3 }).open() }
            ...
            return o(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        ...
                        n = void 0,
                        r = void 0;
                    this.props.label && (n = u.default.createElement("label", { htmlFor: "powerform-field-" + this.props.property, className: "sui-label" }, this.props.label, this.props.note && u.default.createElement("span", { className: "sui-label-note" }, this.props.note))), this.props.canTrash && (r = u.default.createElement("button", { className: "sui-button-icon" }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Diesen Datumsbereich entfernen")))), this.props.canAdd && (r = u.default.createElement("button", { className: "sui-button-icon" }, u.default.createElement("i", { className: "sui-icon-plus", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Ausgewähltes Datum hinzufügen"))));
        ...
        c = function(e) {
            ...
            return o(t, e), i(t, [{ key: "closeModal", value: function() { this.props.actions.modalActions.showModal({ open: !1 }, "publish") } }, {
                ...
                value: function() {
                    ...
                    }())), s.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" })), s.default.createElement("button", { id: "powerform-module-publish", disabled: !!r, className: "sui-button sui-button-blue", onClick: this.publish }, s.default.createElement("span", { className: "sui-loading-text" }, s.default.createElement("i", { className: "sui-icon-web-globe-world", "aria-hidden": "true" }), s.default.createElement("span", { className: "button-text" }, function() {
                        switch (e) {
                            case "publish":
            ...
            return l(t, e), u(t, [{
                ...
                value: function() {
                    ...
                    switch (e) {
                        ...
                        case "settings":
                            return f.default.createElement(f.default.Fragment, null, "input" === t && f.default.createElement("div", { className: "sui-box-settings-row" }, f.default.createElement("div", { className: "sui-box-settings-col-2" }, f.default.createElement("label", { className: "sui-settings-label sui-dark" }, (0, p.translate)("Schritte")), f.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Wähle aus, welche Zeitinkremente Du für die Stunden- und Minuten-Zeitmesser verwenden möchtest.")), f.default.createElement("div", { className: "sui-form-field-inline" }, f.default.createElement(A.default, s({}, this.props, { settings: this.props.state, label: (0, p.translate)("Stunde"), property: "increment_hour" }), [].concat(a(Array(r))).map(function(e, t) { return f.default.createElement("option", { value: t, key: t }, t) })), f.default.createElement(A.default, s({}, this.props, { settings: this.props.state, label: (0, p.translate)("Minute"), property: "increment_minute" }), [].concat(a(Array(60))).map(function(e, t) { return f.default.createElement("option", { value: t, key: t }, t) }))))), f.default.createElement("div", { className: "sui-box-settings-row" }, f.default.createElement("div", { className: "sui-box-settings-col-2" }, f.default.createElement("label", { className: "sui-settings-label sui-dark" }, (0, p.translate)("Standardzeit")), f.default.createElement("span", { className: "sui-description", style: { marginBottom: "10px" } }, (0, p.translate)("Verwende diese Funktion, um eine standardmäßig ausgewählte Zeit anzugeben.")), f.default.createElement(w.default, s({}, this.props, { property: "default_time", settings: this.props.state, default: "none", simple: !0 }), f.default.createElement(R.default, s({ settings: this.props.state }, this.props, { value: "default", label: (0, p.translate)("Standard"), boxClass: "sui-tab-boxed" }), f.default.createElement(k.default, null, f.default.createElement(C.default, { cols: "3" }, f.default.createElement(A.default, s({}, this.props, { settings: this.props.state, label: (0, p.translate)("Stunde"), placeholder: "1", property: "default_time_hour" }), [].concat(a(Array(r))).map(function(e, t) { return f.default.createElement("option", { value: t, key: t }, t) }))), f.default.createElement(C.default, { cols: "3" }, f.default.createElement(A.default, s({}, this.props, { settings: this.props.state, label: (0, p.translate)("Minute"), placeholder: "0", property: "default_time_minute" }), [].concat(a(Array(60))).map(function(e, t) { return f.default.createElement("option", { value: t, key: t }, t) }))), "twelve" === n && f.default.createElement(C.default, { cols: "3" }, f.default.createElement(A.default, s({}, this.props, { settings: this.props.state, label: " ", property: "default_time_ampm" }), f.default.createElement("option", { value: "am" }, (0, p.translate)("AM")), f.default.createElement("option", { value: "pm" }, (0, p.translate)("PM")))))), f.default.createElement(I.default, { value: "none" }, (0, p.translate)("Keiner"))))), f.default.createElement(v.default, this.props));
                        case "visibility":
    ...
    var l = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return a(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), s(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, l({}, this.props, { label: (0, f.translate)("Feldbezeichnung"), property: "cform-label-color", defaultValue: "#777771" })), c.default.createElement(d.default, l({}, this.props, { label: (0, f.translate)("Erforderliches Symbol"), property: "cform-asterisk-color", defaultValue: "#777771" })), c.default.createElement(d.default, l({}, this.props, { label: (0, f.translate)("Feld Beschreibung"), property: "label-helper-color", defaultValue: "#6D6D6D" }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
