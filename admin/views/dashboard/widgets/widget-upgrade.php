<div class="sui-box">
	...
	<div class="sui-box-header">
		...
		<h2 class="sui-box-title"><span class="sui-icon-powerform" aria-hidden="true"></span> <?php esc_html_e( 'Powerform Pro', Powerform::DOMAIN ); ?></h2>

		<div class="sui-actions-left" aria-hidden="true">
			<span class="sui-tag sui-tag-pro"><?php esc_html_e( 'Pro', Powerform::DOMAIN ); ?></span>
		</div>
	...
	<div class="sui-box-body">
		...
		<ul class="sui-list-pro">
			...
			<li><span class="sui-icon-check sui-lg" aria-hidden="true"></span><?php esc_html_e( 'Early access to the newest from features', Powerform::DOMAIN ); ?></li>
			<li><span class="sui-icon-check sui-lg" aria-hidden="true"></span><?php esc_html_e( 'Smush and Hummingbird Pro performance pack', Powerform::DOMAIN ); ?></li>
			<li><span class="sui-icon-check sui-lg" aria-hidden="true"></span><?php esc_html_e( 'Complete marketing suite - pop-ups, email, and more', Powerform::DOMAIN ); ?></li>
