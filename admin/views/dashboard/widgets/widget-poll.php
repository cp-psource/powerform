...
<div class="sui-box">
	...
	<div class="sui-box-body">
		...
		<?php if ( 0 === powerform_polls_total() ) { ?>
			...
			<p><button href="/" class="sui-button sui-button-blue wpmudev-open-modal" data-modal="polls"><i class="sui-icon-plus" aria-hidden="true"></i> <?php esc_html_e( 'Erstellen', Powerform::DOMAIN ); ?></button></p>
	...
	<?php if ( powerform_polls_total() > 0 ) { ?>
				...
				<?php foreach( powerform_polls_modules( $num_recent, $statuses ) as $module ) { ?>
					...
					<tr>
						...
						<td class="fui-col-status">
							...
							<a href="<?php echo admin_url( 'admin.php?page=powerform-poll&view-stats=' . esc_attr( $module['id'] ) ); // WPCS: XSS ok. ?>"
							...
							<div class="sui-dropdown">
								...
								<ul>
									...
									<li><a href="<?php echo admin_url( 'admin.php?page=powerform-entries&form_type=powerform_polls&form_id=' . $module['id'] ); // WPCS: XSS ok. ?>"><i class="sui-icon-community-people" aria-hidden="true"></i> <?php esc_html_e( 'Einreichungen anzeigen', Powerform::DOMAIN ); ?></a></li>
		...
		<div class="sui-box-footer">
			...
			<div class="sui-actions-right">
				<p class="sui-description"><a href="<?php echo admin_url( 'admin.php?page=powerform-poll' ); // WPCS: XSS ok. ?>" class="sui-link-gray"><?php esc_html_e( 'Alle Umfragen anzeigen', Powerform::DOMAIN ); ?></a></p>
			</div>
