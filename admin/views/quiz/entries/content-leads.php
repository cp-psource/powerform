				...
				echo '<td class="sui-accordion-item-title">';
					...
					echo '<label class="sui-checkbox">';
						...
						echo '<span class="sui-screen-reader-text">' . sprintf(/* translators: ... */
								esc_html__( 'Wähle Eintragsnummer %s', Powerform::DOMAIN ),
            ...
            <div class="sui-box">
				...
				<div class="sui-box-body fui-entries--knowledge">
					...
					<div class="fui-entries-block">
						...
						<?php } else { ?>
							...
							<div class="sui-notice">
								<p><?php esc_html_e( 'Für diese Einsendung sind keine Lead-Details verfügbar. Anscheinend hat sich der Teilnehmer dafür entschieden, das Formular zur Lead-Generierung zu überspringen, während er den Test abschickte.', Powerform::DOMAIN ); ?></p>
							</div>
					...
					<div class="fui-entries-block">
						...
						<?php } else { ?>
                            <div class="sui-notice">
                                <p><?php esc_html_e( 'Quizergebnisse sind für diese Einsendung nicht verfügbar. Der Teilnehmer konnte den Test entweder nicht beenden oder hatte einige Fehler beim Einreichen des Tests.', Powerform::DOMAIN ); ?></p>
                            </div>
						<?php } ?>
					...
					<?php if ( ! empty( $integrations ) ) { ?>
						...
						<div class="fui-entries-block">
							...
							<h3 class="fui-entries-subtitle"><?php esc_html_e( 'Aktive Integrationen', Powerform::DOMAIN ); ?></h3>

							<p class="sui-description"><?php esc_html_e( 'Überprüfe den Status und die Antwort Deiner aktiven Drittanbieteranwendungen für diese Übermittlungen.', Powerform::DOMAIN ); ?></p>

							<div class="sui-accordion">

								<div class="sui-accordion-header">
									<div><?php esc_html_e( 'Integration Name', Powerform::DOMAIN ); ?></div>
									<div><?php esc_html_e( 'Daten an Integration senden', Powerform::DOMAIN ); ?></div>
									<div></div>
								</div>
                ...
                <div class="sui-box-footer">
                    ...
                    <button
						...
						<?php if ( isset( $entries['activation_key'] ) ) {
							$button_title = esc_html__( 'Submission & User löschen', Powerform::DOMAIN );
						...
						<?php } else {
							$button_title = esc_html__( 'Löschen', Powerform::DOMAIN );
						...
						<?php } ?>
                            ...
                            data-nonce="<?php echo esc_attr( wp_create_nonce( 'powerformQuizEntries' ) ); ?>"
                    >
