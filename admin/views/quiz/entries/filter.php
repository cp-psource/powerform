...
<div class="sui-pagination-filter <?php echo( $is_filter_enabled ? 'sui-open' : '' ); ?>">
	...
	<div class="sui-row">
		...
		<div class="sui-col-md-6">
			...
			<div class="sui-form-field">
				...
				<label for="powerform-forms-filter--by-date" class="sui-label"><?php esc_html_e( 'Submission Date Range', Powerform::DOMAIN ); ?></label>

				<div class="sui-date">
					<i class="sui-icon-calendar" aria-hidden="true"></i>
					<input type="text"
						placeholder="<?php esc_html_e( 'Pick a date range', Powerform::DOMAIN ); ?>"
		...
		<div class="sui-col-md-3">
			...
			<label for="powerform-forms-filter--from-id" class="sui-label"><?php esc_html_e( 'From ID', Powerform::DOMAIN ); ?></label>
			<input type="number"
				name="min_id"
				min="0"
				value="<?php echo esc_attr( $min_id ); ?>"
				placeholder="<?php esc_html_e( 'E.g. 100', Powerform::DOMAIN ); ?>"
		...
		<div class="sui-col-md-3">
			...
			<label for="powerform-forms-filter--to-id" class="sui-label"><?php esc_html_e( 'To ID', Powerform::DOMAIN ); ?></label>
			<input type="number"
				name="max_id"
				min="0"
	...
	<div class="sui-row">
		...
		<div class="sui-col-md-6">
			...
			<div class="sui-form-field">
				...
				<label for="powerform-forms-filter--by-keyword" class="sui-label"><?php esc_html_e( 'Keyword', Powerform::DOMAIN ); ?></label>
				...
				<div class="sui-control-with-icon">
					...
					<input type="text"
						...
						placeholder="<?php esc_html_e( 'E.g. search', Powerform::DOMAIN ); ?>"
		...
		<div class="sui-col-md-3">
			...
			<label for="powerform-forms-filter--sort-by" class="sui-label"><?php esc_html_e( 'Sort by', Powerform::DOMAIN ); ?></label>
			<select id="powerform-forms-filter--sort-by" name="order_by">
				<!--				<option value="">--><?php //esc_html_e( 'ID', Powerform::DOMAIN ); ?><!--</option>-->
				<option value="entries.date_created" <?php selected( 'entries.date_created', $order_by ); ?> ><?php esc_html_e( 'Submissions Date', Powerform::DOMAIN ); ?></option>
			</select>
		...
		<div class="sui-col-md-3">
			...
			<label for="powerform-forms-filter--sort-order" class="sui-label"><?php esc_html_e( 'Sort Order', Powerform::DOMAIN ); ?></label>
			<select id="powerform-forms-filter--sort-order" name="order">
				<option value="DESC" <?php selected( 'DESC', $order_filter ); ?>><?php esc_html_e( 'Descending', Powerform::DOMAIN ); ?></option>
				<option value="ASC" <?php selected( 'ASC', $order_filter ); ?>><?php esc_html_e( 'Ascending', Powerform::DOMAIN ); ?></option>
			</select>
	...
	<div class="sui-form-field">
		...
		<label class="sui-label"><?php esc_html_e( 'Display Fields', Powerform::DOMAIN ); ?></label>
			...
			<div class="sui-tabs-menu">
				...
				<label for="powerform-forms-filter--display-true" class="sui-tab-item <?php echo ( $this->fields_is_filtered ? 'active' : '' ); ?>" data-tab-index="2">
					<input type="radio"
						...
						value="true"/>
					<?php esc_html_e( 'Specified Fields', Powerform::DOMAIN ); ?>
				</label>
			...
			<div class="sui-tabs-content">
				...
				<div class="sui-tab-content sui-tab-boxed <?php echo ( $this->fields_is_filtered ? 'active' : '' ); ?>" data-tab-index="2">
					...
					<fieldset class="powerform-entries-fields-filter" <?php echo ( $this->fields_is_filtered ? '' : 'disabled=disabled' ); ?>>
						...
						$fields              = apply_filters( 'powerform_custom_form_filter_fields', $this->get_lead_fields() );
	...
	<div class="sui-filter-footer">
		...
		<button class="sui-button sui-button-ghost powerform-entries-clear-filter"><?php esc_html_e( 'Clear Filters', Powerform::DOMAIN ); ?></button>

		<div class="sui-actions-right">
			<button class="sui-button powerform-entries-apply-filter" type="submit"><?php esc_html_e( 'Apply', Powerform::DOMAIN ); ?></button>
		</div>
