...
<form class="sui-form-field">
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['sandbox_id_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Sandbox Client ID', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="sandbox_id" placeholder="<?php echo esc_attr( __( 'Enter your sandbox client id', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['sandbox_secret_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Sandbox Secret', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="sandbox_secret" placeholder="<?php echo esc_attr( __( 'Enter your sandbox secret', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['live_id_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Live Client ID', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="live_id" placeholder="<?php echo esc_attr( __( 'Enter your live client id', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['live_secret_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<input
			class="sui-form-control"
			name="live_secret" placeholder="<?php echo esc_attr( __( 'Enter your live secret id', Powerform::DOMAIN ) ); ?>"
