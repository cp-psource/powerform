...
<form class="sui-form-field">
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['test_key_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Test Publishable Key', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="test_key" placeholder="<?php echo esc_attr( __( 'Enter your test publishable key', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['test_secret_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Test Secret Key', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="test_secret" placeholder="<?php echo esc_attr( __( 'Enter your test secret key', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['live_key_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Live Publishable Key', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="live_key" placeholder="<?php echo esc_attr( __( 'Enter your live publishable key', Powerform::DOMAIN ) ); ?>"
	...
	<div class="sui-form-field <?php echo esc_attr( ! empty( $vars['live_secret_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		...
		<label class="sui-label"><?php esc_html_e( 'Live Secret Key', Powerform::DOMAIN ); ?></label>

		<input
			class="sui-form-control"
			name="live_secret" placeholder="<?php echo esc_attr( __( 'Enter your live secret key', Powerform::DOMAIN ) ); ?>"
