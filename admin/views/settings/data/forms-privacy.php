...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-1">
		...
		<span class="sui-description"><?php esc_html_e( 'Wähle aus, wie Du mit der Speicherung von Formulardaten umgehen möchtest.', Powerform::DOMAIN ); ?></span>
	</div>

	<div class="sui-box-settings-col-2">

		<span class="sui-settings-label"><?php esc_html_e( 'Aufbewahrung von Einsendungen', Powerform::DOMAIN ); ?></span>
		<span class="sui-description"><?php esc_html_e( 'Wie lange möchtest Du die Formularübermittlungen aufbewahren?', Powerform::DOMAIN ); ?></span>
		...
		<span class="sui-description"><?php esc_html_e( 'Wähle aus, wie lange die IP-Adresse beibehalten werden soll, bevor eine Übermittlung anonymisiert wird.', Powerform::DOMAIN ); ?></span>
		...
		<span class="sui-settings-label"><?php esc_html_e( 'Löschanforderungen für Konten', Powerform::DOMAIN ); ?></span>
		<span class="sui-description">
			<?php
			/* translators: ... */
			echo sprintf( __( 'Was möchtest Du tun, wenn Du eine <a href="%s" target="_blank">Anforderung zum Löschen eines Kontos</a>, E-Mail enthältst, die mit einer Übermittlung verknüpft ist. Was möchtest Du tun?', Powerform::DOMAIN ),
		...
		<div class="sui-side-tabs" style="margin-top: 10px;">
			...
			<div class="sui-tabs-menu">
				...
				<label for="erase_form_submissions-true" class="sui-tab-item<?php echo $form_submission_erasure_enabled ? ' active' : ''; ?>">
					...
					<?php esc_html_e( 'Einsendung beibehalten', Powerform::DOMAIN ); ?>
				</label>
				...
				<label for="erase_form_submissions-false" class="sui-tab-item<?php echo $form_submission_erasure_enabled ? '' : ' active'; ?>">
					...
					<?php esc_html_e( 'Einsendung entfernen', Powerform::DOMAIN ); ?>
				</label>
