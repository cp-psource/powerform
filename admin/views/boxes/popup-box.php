...
<div id="powerform-modal-<?php echo esc_attr( $template_class ); ?>" class="wpmudev-modal <?php echo esc_attr( $template_class ); ?>">
	...
	<div class="wpmudev-box-modal">
		...
		<div class="wpmudev-box-header">
			...
			<div class="wpmudev-header--action">
				...
				<button class="wpmudev-sr-only"><?php esc_html_e( "Modul schließen", Powerform::DOMAIN ); ?></button>
