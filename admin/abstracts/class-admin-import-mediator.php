 ...
 * @since 1.7
 */
abstract class Powerform_Import_Mediator {
	...
	/**
	 * Replaces invalid tags with powerform tags
	 *
	 * @param $mayhavetags
	 * @param $tags
	 *
	...
	public static function default_fields() {
		...
		return apply_filters( 'powerform_default_fields', $fields );
	}
	...
	/**
	 * Replaces cf7 tags with powerform tags
	 *
	 * @param $type
	 *
	 * @since 1.7
	...
	public function parse_import_data( $data ) {
		...
		$form_data['version']          = POWERFORM_VERSION;
