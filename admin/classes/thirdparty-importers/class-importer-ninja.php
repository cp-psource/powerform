...
/**
 * Class Powerform_Admin_Import_Ninja
 *
 * @since 1.7
 */
class Powerform_Admin_Import_Ninja extends Powerform_Import_Mediator {
	...
	public function import_form( $id ) {
		...
		$data = apply_filters( 'powerform_ninja_form_import_data', $data );
