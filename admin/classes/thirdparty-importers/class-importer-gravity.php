...
/**
 * Class Powerform_Admin_Import_Gravity
 *
 * @since 1.7
 */
class Powerform_Admin_Import_Gravity extends Powerform_Import_Mediator {
	...
	public function import_form( $id ) {
		...
		$data = apply_filters( 'powerform_gravity_form_import_data', $data );
