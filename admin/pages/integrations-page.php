...
/**
 * Class Powerform_Integrations_Page
 *
 * @since 1.1
 */
class Powerform_Integrations_Page extends Powerform_Admin_Page {
	...
	public static $addon_nonce_page_action = 'powerform_addon_nonce_page';
	...
	public function before_render() {
		...
		$this->addons_list_grouped_by_connected = powerform_get_registered_addons_grouped_by_connected();
	...
	public function add_addons_js_data( $data ) {
		if ( Powerform::is_addons_feature_enabled() ) {
			$data['addons']      = powerform_get_registered_addons_list();
