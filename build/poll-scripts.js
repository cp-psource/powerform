...
! function(e) {
    ...
    var n = {};
    t.m = e, t.c = n, t.d = function(e, n, r) { t.o(e, n) || Object.defineProperty(e, n, { configurable: !1, enumerable: !0, get: r }) }, t.n = function(e) { var n = e && e.__esModule ? function() { return e.default } : function() { return e }; return t.d(n, "a", n), n }, t.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, t.p = "", t(t.s = 354)
}([function(e, t, n) {
    "use strict";
    e.exports = n(82)
}, function(e, t, n) {
    ...
    function S() { "object" === F(window.SUI) && setTimeout(function() { SUI.suiAccordion(jQuery(".sui-accordion")), SUI.suiTabs(jQuery(".sui-tabs")), jQuery("select").not(".sui-select").not(".powerform-select").not(".powerform-time").not(".fui-multi-select").each(function() { SUI.suiSelect(jQuery(this)) }), jQuery("select.sui-select").not(".fui-multi-select").not(".custom-select2").each(function() { jQuery(this).SUIselect2({ dropdownCssClass: "sui-select-dropdown" }) }), SUI.loadCircleScore(jQuery(".sui-circle-score")), SUI.showHidePassword() }, 50) }
    ...
    e.exports = { isArray: r, isArrayBuffer: o, isBuffer: O, isFormData: a, isArrayBufferView: i, isString: s, isNumber: l, isObject: c, isUndefined: u, isDate: f, isFile: p, isBlob: d, isFunction: h, isStream: m, isURLSearchParams: y, isStandardBrowserEnv: v, forEach: g, merge: _, extend: w, trim: b }
}, function(e, t, n) {
    "use strict";
        ...
        u = function(e) {
            ...
            return a(t, e), i(t, [{ key: "toggleValue", value: function(e) { "function" == typeof this.props.updateProperty ? this.props.updateProperty(this.props.property, e) : this.props.actions.settingsActions.updateSetting(this.props.property, e) } }, {
                ...
                value: function() {
                    ...
                    var u = "";
                    !this.props.label && this.props.settingsDesc && (u = l.default.createElement("span", {
    ...
    var i = function() {
        ...
        u = function(e) {
            ...
            }, { key: "updateValue", value: function(e) { var t = jQuery(e.target).val(); "function" == typeof this.props.updateProperty ? this.props.updateProperty(this.props.property, t) : this.props.actions.settingsActions.updateSetting(this.props.property, t) } }, {
                key: "componentWillUnmount",
                value: function() { this.$el.off("change", this.updateValue), this.$el.unbind().removeData() }
            }, {
                key: "render",
                value: function() {
                    var e = this,
    ...
    function u(e) {
        var t, n, u = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            C = u.withRef,
            N = void 0 !== C && C,
            T = i(u, ["getDisplayName", "methodName", "renderCountProp", "shouldHandleStateChanges", "storeKey", "withRef"]),
            S = P + "Subscription",
            A = v++,
            M = (t = {}, t[P] = y.a, t[S] = y.b, t),
            R = (n = {}, n[S] = y.b, n);
        return function(t) {
            d()("function" == typeof t, "You must pass a component to the function returned by " + w + ". Instead received " + JSON.stringify(t));
            var n = t.displayName || t.name || "Component",
                i = p(n),
                u = b({}, T, { getDisplayName: p, methodName: w, renderCountProp: O, shouldHandleStateChanges: j, storeKey: P, withRef: N, displayName: i, wrappedComponentName: n, WrappedComponent: t }),
                c = function(n) {
                    function c(e, t) { r(this, c); var a = o(this, n.call(this, e, t)); return a.version = A, a.state = {}, a.renderCount = 0, a.store = e[P] || t[P], a.propsMode = Boolean(e[P]), a.setWrappedInstance = a.setWrappedInstance.bind(a), d()(a.store, 'Could not find "' + P + '" in either the context or props of "' + i + '". Either wrap the root component in a <Provider>, or explicitly pass "' + P + '" as a prop to "' + i + '".'), a.initSelector(), a.initSubscription(), a }
            ...
            return c.WrappedComponent = t, c.displayName = i, c.childContextTypes = R, c.contextTypes = M, c.propTypes = M, f()(c, t)
        }
    }
    t.a = u;
    var c = n(49),
        ...
        for (var n, r = [], o = 0, a = 0, i = "", s = t && t.delimiter || "/"; null != (n = v.exec(e));) {
            ...
            if (i += e.slice(a, p), a = p + c.length, f) i += f[1];
                ...
                var w = null != h && null != d && d !== h,
                    ...
                    x = n[2] || s,
                    j = y || b;
                r.push({ name: m || o++, prefix: h || "", delimiter: x, optional: O, repeat: E, partial: w, asterisk: !!_, pattern: j ? u(j) : _ ? ".*" : "[^" + l(x) + "]+?" })
            }
        }
    ...
    function i(e) { if (!f(e)) return T(e); var t = []; for (var n in Object(e)) P.call(e, n) && "constructor" != n && t.push(n); return t }
    ...
    function u(e, t) { return !!(t = null == t ? w : t) && ("number" == typeof e || j.test(e)) && e > -1 && e % 1 == 0 && e < t }
    ...
    var w = 9007199254740991,
        ...
        T = function(e, t) { return function(n) { return e(t(n)) } }(Object.keys, Object),
        S = Math.max,
        A = !N.call({ valueOf: 1 }, "valueOf"),
        M = Array.isArray,
        R = function(e) {
        ...
        }(function(e, t) { if (A || f(t) || h(t)) return void l(t, _(t), e); for (var n in t) P.call(t, n) && a(e, n, t[n]) });
    e.exports = R
    ...
    function o(e, t, n) { this.props = e, this.context = t, this.refs = g, this.updater = n || A }

    function a() {}

    function i(e, t, n) { this.props = e, this.context = t, this.refs = g, this.updater = n || A }
    ...
    function m(e, t, n) {
        var r = e.result,
            o = e.keyPrefix;
        e = e.func.call(e.context, t, e.count++), Array.isArray(e) ? y(e, r, n, _.thatReturnsArgument) : null != e && (l(e) && (t = o + (!e.key || t && t.key === e.key ? "" : ("" + e.key).replace(U, "$&/") + "/") + n, e = { $$typeof: E, type: e.type, key: t, ref: e.ref, props: e.props, _owner: e._owner }), r.push(e))
    }
    ...
    var S = "function" == typeof Symbol && Symbol.iterator,
        A = { isMounted: function() { return !1 }, enqueueForceUpdate: function() {}, enqueueReplaceState: function() {}, enqueueSetState: function() {} };
    ...
    var R = { current: null },
        ...
        L = {
            Children: {
                ...
                count: function(e) { return null == e ? 0 : p(e, "", _.thatReturnsNull, null) },
                toArray: function(e) { var t = []; return y(e, t, null, _.thatReturnsArgument), t },
            ...
            forwardRef: function(e) { return { $$typeof: T, render: e } },
            Fragment: x,
            StrictMode: j,
    ...
    function a() { if (qr._hasRethrowError) { var e = qr._rethrowError; throw qr._rethrowError = null, qr._hasRethrowError = !1, e } }
    ...
    function l(e) { $r && r("101"), $r = Array.prototype.slice.call(e), i() }
    ...
    function u(e) {
        ...
        for (t in e)
            if (e.hasOwnProperty(t)) {
                var o = e[t];
                Wr.hasOwnProperty(t) && Wr[t] === o || (Wr[t] && r("102", t), Wr[t] = o, n = !0)
            }
        n && i()
    }
    ...
    function b(e, t) { null !== e && (eo = f(eo, e)), e = eo, eo = null, e && (t ? p(e, h) : p(e, m), eo && r("95"), qr.rethrowCaughtError()) }

    function v(e, t, n, r) {
        for (var o = null, a = 0; a < Hr.length; a++) {
            var i = Hr[a];
    ...
    function S(e, t) { var n = {}; return n[e.toLowerCase()] = t.toLowerCase(), n["Webkit" + e] = "webkit" + t, n["Moz" + e] = "moz" + t, n["ms" + e] = "MS" + t, n["O" + e] = "o" + t.toLowerCase(), n }
    ...
    function M() { return !bo && Dr.canUseDOM && (bo = "textContent" in document.documentElement ? "textContent" : "innerText"), bo }
    ...
    function F() { return "value" in vo._root ? vo._root.value : vo._root[M()] }
    ...
    function V(e) { return e = e.detail, "object" == typeof e && "data" in e ? e.data : null }
    ...
    function z(e, t) {
        switch (e) {
            case "compositionend":
                return V(t);
            case "keypress":
                return 32 !== t.which ? null : (To = !0, Co);
            case "textInput":
                return e = t.data, e === Co && To ? null : e;
            default:
                return null
        }
    }
    ...
    function q(e, t) {
        if (So) return "compositionend" === e || !xo && B(e, t) ? (e = R(), vo._root = null, vo._startText = null, vo._fallbackText = null, So = !1, e) : null;
        switch (e) {
            case "paste":
                return null;
            case "keypress":
    ...
    function W(e) { Fo ? Do ? Do.push(e) : Do = [e] : Fo = e }

    function H() { return null !== Fo || null !== Do }
    ...
    function X(e, t) {
        if (Io) return e(t);
        Io = !0;
        try { return Y(e, t) } finally { Io = !1, H() && (K(), Q()) }
    }
    ...
    function me(e, t) {
        ...
        n = _e(null != t.value ? t.value : n), e._wrapperState = { initialChecked: r, initialValue: n, controlled: "checkbox" === t.type || "radio" === t.type ? null != t.checked : null != t.value }
    }
    ...
    function be(e, t) {
        ye(e, t);
        var n = _e(t.value);
        null != n && ("number" === t.type ? (0 === n && "" === e.value || e.value != n) && (e.value = "" + n) : e.value !== "" + n && (e.value = "" + n)), t.hasOwnProperty("value") ? ge(e, t.type, n) : t.hasOwnProperty("defaultValue") && ge(e, t.type, _e(t.defaultValue)), null == t.checked && null != t.defaultChecked && (e.defaultChecked = !!t.defaultChecked)
    }
    ...
    function we(e, t, n) { return e = D.getPooled(aa.change, e, t, n), e.type = "change", W(n), N(e), e }

    function Ee(e) { b(e, !1) }

    function Oe(e) { if (oe(_(e))) return e }

    function xe(e, t) { if ("change" === e) return t }

    function je() { ia && (ia.detachEvent("onpropertychange", ke), sa = ia = null) }

    function ke(e) { "value" === e.propertyName && Oe(sa) && (e = we(sa, e, Z(e)), X(Ee, e)) }
    ...
    function Te(e, t) { if ("input" === e || "change" === e) return Oe(t) }

    function Se(e) { var t = this.nativeEvent; return t.getModifierState ? t.getModifierState(e) : !!(e = fa[e]) && !!t[e] }
    ...
    function $e(e, t) { G(We, e, t) }

    function We(e, t) {
        if (Aa) {
            var n = Z(t);
            if (n = g(n), null === n || "number" != typeof n.tag || 2 === Me(n) || (n = null), Sa.length) {
                var r = Sa.pop();
                r.topLevelType = e,
                    r.nativeEvent = t, r.targetInst = n, e = r
            } else e = { topLevelType: e, nativeEvent: t, targetInst: n, ancestors: [] };
            try { X(Be, e) } finally { e.topLevelType = null, e.nativeEvent = null, e.targetInst = null, e.ancestors.length = 0, 10 > Sa.length && Sa.push(e) }
        }
    }

    function He(e) { return Object.prototype.hasOwnProperty.call(e, Da) || (e[Da] = Fa++, Ra[e[Da]] = {}), Ra[e[Da]] }
    ...
    function Ke(e, t) { if (za || null == La || La !== Lr()) return null; var n = La; return "selectionStart" in n && Ge(n) ? n = { start: n.selectionStart, end: n.selectionEnd } : window.getSelection ? (n = window.getSelection(), n = { anchorNode: n.anchorNode, anchorOffset: n.anchorOffset, focusNode: n.focusNode, focusOffset: n.focusOffset }) : n = void 0, Va && Br(Va, n) ? null : (Va = n, e = D.getPooled(Ia.select, Ba, e, t), e.type = "select", e.target = La, N(e), e) }
    ...
    function ht(e, t, n, r) {
        ...
        switch (t) {
            ...
            case "option":
                ...
                break;
            case "select":
                et(e, n), a = Ur({}, n, { value: void 0 }), ze("invalid", e), ft(r, "onChange");
                break;
            case "textarea":
    ...
    function Tt(e) { xt(Ci, e), xt(Pi, e) }

    function St(e, t, n) { Pi.current !== zr && r("168"), jt(Pi, t, e), jt(Ci, n, e) }
    ...
    function Ut(e, t, n) {
        ...
        if (e = e.props, "function" == typeof o) var i = o.prototype && o.prototype.isReactComponent ? 2 : 0;
            ...
            case Wo:
                ...
                break;
            case Ho:
                return o = new Ft(15, e, a, 4 | t), o.type = Ho, o.expirationTime = n, o;
            case Xo:
                i = 16, t |= 2;
                break;
            default:
    ...
    function Bt(e, t, n) { return t = new Ft(4, null !== e.children ? e.children : [], e.key, t), t.expirationTime = n, t.stateNode = { containerInfo: e.containerInfo, pendingChildren: null, implementation: e.implementation }, t }
    ...
    function qt(e) {
        ...
        try {
            var n = t.inject(e);
            Ti = zt(function(e) { return t.onCommitFiberRoot(n, e) }), Si = zt(function(e) { return t.onCommitFiberUnmount(n, e) })
        } catch (e) {}
        return !0
    }
    ...
    function Kt(e, t, n) {
        ...
        if (null === r) {
            var o = e.updateQueue,
                a = null;
            null === o && (o = e.updateQueue = Ht(e.memoizedState))
        } else o = e.updateQueue, a = r.updateQueue, null === o ? null === a ? (o = e.updateQueue = Ht(e.memoizedState), a = r.updateQueue = Ht(r.memoizedState)) : o = e.updateQueue = Qt(a) : null === a && (a = r.updateQueue = Qt(o));
    ...
    function on(e) {
        ...
        jt(Fi, t._changedBits, e), jt(Ri, t._currentValue, e), jt(Mi, e, e), t._currentValue = e.pendingProps.value, t._changedBits = e.stateNode
    }

    function an(e) {
        var t = Fi.current,
            n = Ri.current;
        xt(Mi, e), xt(Ri, e), xt(Fi, e), e = e.type._context, e._currentValue = n, e._changedBits = t
    }
    ...
    function pn(e, t, n, r, o, a) { var i = e.stateNode; return e = e.type, "function" == typeof i.shouldComponentUpdate ? i.shouldComponentUpdate(n, o, a) : !(e.prototype && e.prototype.isPureReactComponent && Br(t, n) && Br(r, o)) }

    function dn(e, t, n, r) { e = t.state, "function" == typeof t.componentWillReceiveProps && t.componentWillReceiveProps(n, r), "function" == typeof t.UNSAFE_componentWillReceiveProps && t.UNSAFE_componentWillReceiveProps(n, r), t.state !== e && Bi.enqueueReplaceState(t, t.state, null) }
    ...
    function hn(e, t) {
        var n = e.type,
            ...
            o = e.pendingProps,
            a = kt(e);
        r.props = o, r.state = e.memoizedState, r.refs = zr, r.context = Pt(e, a), a = e.updateQueue, null !== a && (en(e, a, o, r, t), r.state = e.memoizedState), a = e.type.getDerivedStateFromProps, "function" == typeof a && (fn(e, a, o), r.state = e.memoizedState), "function" == typeof n.getDerivedStateFromProps || "function" == typeof r.getSnapshotBeforeUpdate || "function" != typeof r.UNSAFE_componentWillMount && "function" != typeof r.componentWillMount || (n = r.state, "function" == typeof r.componentWillMount && r.componentWillMount(), "function" == typeof r.UNSAFE_componentWillMount && r.UNSAFE_componentWillMount(), n !== r.state && Bi.enqueueReplaceState(r, r.state, null), null !== (a = e.updateQueue) && (en(e, a, o, r, t), r.state = e.memoizedState)), "function" == typeof r.componentDidMount && (e.effectTag |= 4)
    }
    ...
    function bn(e) {
        ...
        function c(e, t, n, r) { return null === t || 4 !== t.tag || t.stateNode.containerInfo !== n.containerInfo || t.stateNode.implementation !== n.implementation ? (t = Bt(n, e.mode, r), t.return = e, t) : (t = a(t, n.children || [], r), t.return = e, t) }
        ...
        function p(e, t, n) {
            ...
            if ("object" == typeof t && null !== t) {
                ...
                if (Vi(t) || ae(t)) return t = It(t, e.mode, n, null), t.return = e, t;
                yn(e, t)
            }
            return null
        }
        ...
        function d(e, t, n, r) {
            ...
            if ("object" == typeof n && null !== n) {
                switch (n.$$typeof) {
                    case zo:
                        return n.key === o ? n.type === $o ? f(e, t, n.props.children, r, o) : u(e, t, n, r) : null;
                    case qo:
                        return n.key === o ? c(e, t, n, r) : null
                }
                if (Vi(n) || ae(n)) return null !== o ? null : f(e, t, n, r, null);
                yn(e, n)
            }
            return null
        }
        ...
        function h(e, t, n, r, o) {
            ...
            if ("object" == typeof r && null !== r) {
                switch (r.$$typeof) {
                    case zo:
                        return e = e.get(null === r.key ? n : r.key) || null, r.type === $o ? f(t, e, r.props.children, o, r.key) : u(t, e, r, o);
                    case qo:
                        return e = e.get(null === r.key ? n : r.key) || null, c(t, e, r, o)
                }
                if (Vi(r) || ae(r)) return e = e.get(n) || null, f(t, e, r, o, null);
                yn(t, r)
            }
            return null
        }
        ...
        return function(e, o, i, l) {
            var u = "object" == typeof i && null !== i && i.type === $o && null === i.key;
                ...
                case zo:
                    e: {
                        for (c = i.key, u = o; null !== u;) {
                            if (u.key === c) {
                                if (10 === u.tag ? i.type === $o : u.type === i.type) { n(e, u.sibling), o = a(u, i.type === $o ? i.props.children : i.props, l), o.ref = mn(e, u, i), o.return = e, e = o; break e }
                                n(e, u);
                                break
                            }
                            t(e, u), u = u.sibling
                        }
                        i.type === $o ? (o = It(i.props.children, e.mode, l, i.key), o.return = e, e = o) : (l = Ut(i, e.mode, l), l.ref = mn(e, o, i), l.return = e, e = l)
                    }
                    return s(e);
                case qo:
                    e: {
    ...
    function _n(e) {
        if (Hi) {
            ...
            if (t) {
                var n = t;
                if (!gn(e, t)) {
                    if (!(t = wt(n)) || !gn(e, t)) return e.effectTag |= 2, Hi = !1, void($i = e);
                    vn($i, n)
                }
                $i = e, Wi = Et(t)
            } else e.effectTag |= 2, Hi = !1, $i = e
        }
    }
    ...
    function En(e) {
        if (e !== $i) return !1;
        if (!Hi) return wn(e), Hi = !0, !1;
        var t = e.type;
        if (5 !== e.tag || "head" !== t && "body" !== t && !_t(t, e.memoizedProps))
            for (t = Wi; t;) vn(e, t), t = wt(t);
        return wn(e), Wi = $i ? wt(e.stateNode) : null, !0
    }

    function On() { Wi = $i = null, Hi = !1 }
    ...
    function Cn(e) {
        var t = e.stateNode;
        t.pendingContext ? St(e, t.pendingContext, t.pendingContext !== t.context) : t.context && St(e, t.context, !1), ln(e, t.containerInfo)
    }
    ...
    function Tn(e, t, n) {
        var r = t.type._context,
            ...
            i = !0;
        if (Ci.current) i = !1;
        else if (a === o) return t.stateNode = 0, on(t), Sn(e, t);
        var s = o.value;
        if (t.memoizedProps = o, null === a) s = 1073741823;
        else if (a.value === o.value) {
            if (a.children === o.children && i) return t.stateNode = 0, on(t), Sn(e, t);
            s = 0
        } else {
            var l = a.value;
            if (l === s && (0 !== l || 1 / l == 1 / s) || l !== l && s !== s) {
                if (a.children === o.children && i) return t.stateNode = 0, on(t), Sn(e, t);
                s = 0
            } else if (s = "function" == typeof r._calculateChangedBits ? r._calculateChangedBits(l, s) : 1073741823, 0 == (s |= 0)) { if (a.children === o.children && i) return t.stateNode = 0, on(t), Sn(e, t) } else Nn(t, r, s, n)
        }
        ...
        switch (t.tag) {
            case 0:
                ...
                var o = t.type,
                    a = t.pendingProps,
                    i = kt(t);
                return i = Pt(t, i), o = o(a, i), t.effectTag |= 1, "object" == typeof o && null !== o && "function" == typeof o.render && void 0 === o.$$typeof ? (i = t.type, t.tag = 2, t.memoizedState = null !== o.state && void 0 !== o.state ? o.state : null, i = i.getDerivedStateFromProps, "function" == typeof i && fn(t, i, a), a = Mt(t), o.updater = Bi, t.stateNode = o, o._reactInternalFiber = t, hn(t, n), e = Pn(e, t, !0, a, n)) : (t.tag = 1, xn(e, t, o), t.memoizedProps = a, e = t.child), e;
            case 1:
                return a = t.type, n = t.pendingProps, Ci.current || t.memoizedProps !== n ? (o = kt(t), o = Pt(t, o), a = a(n, o), t.effectTag |= 1, xn(e, t, a), t.memoizedProps = n, e = t.child) : e = Sn(e, t), e;
            case 2:
                if (a = Mt(t), null === e)
                    if (null === t.stateNode) {
                        ...
                        i = u ? Pt(t, o) : zr, s = new l(s, i), t.memoizedState = null !== s.state && void 0 !== s.state ? s.state : null, s.updater = Bi, t.stateNode = s, s._reactInternalFiber = t, u && (u = t.stateNode, u.__reactInternalMemoizedUnmaskedChildContext = o, u.__reactInternalMemoizedMaskedChildContext = i), hn(t, n), o = !0
                    } else {
                        l = t.type, o = t.stateNode, u = t.memoizedProps, i = t.pendingProps, o.props = u;
                        var c = o.context;
                        s = kt(t), s = Pt(t, s);
                        var f = l.getDerivedStateFromProps;
                        (l = "function" == typeof f || "function" == typeof o.getSnapshotBeforeUpdate) || "function" != typeof o.UNSAFE_componentWillReceiveProps && "function" != typeof o.componentWillReceiveProps || (u !== i || c !== s) && dn(t, o, i, s), Ai = !1;
                        var p = t.memoizedState;
                        c = o.state = p;
                        var d = t.updateQueue;
                        null !== d && (en(t, d, i, o, n), c = t.memoizedState), u !== i || p !== c || Ci.current || Ai ? ("function" == typeof f && (fn(t, f, i), c = t.memoizedState), (u = Ai || pn(t, u, i, p, c, s)) ? (l || "function" != typeof o.UNSAFE_componentWillMount && "function" != typeof o.componentWillMount || ("function" == typeof o.componentWillMount && o.componentWillMount(), "function" == typeof o.UNSAFE_componentWillMount && o.UNSAFE_componentWillMount()), "function" == typeof o.componentDidMount && (t.effectTag |= 4)) : ("function" == typeof o.componentDidMount && (t.effectTag |= 4), t.memoizedProps = i, t.memoizedState = c), o.props = i, o.state = c, o.context = s, o = u) : ("function" == typeof o.componentDidMount && (t.effectTag |= 4), o = !1)
                    }
                else l = t.type, o = t.stateNode, i = t.memoizedProps, u = t.pendingProps, o.props = i, c = o.context, s = kt(t), s = Pt(t, s), f = l.getDerivedStateFromProps, (l = "function" == typeof f || "function" == typeof o.getSnapshotBeforeUpdate) || "function" != typeof o.UNSAFE_componentWillReceiveProps && "function" != typeof o.componentWillReceiveProps || (i !== u || c !== s) && dn(t, o, u, s), Ai = !1, c = t.memoizedState, p = o.state = c, d = t.updateQueue, null !== d && (en(t, d, u, o, n), p = t.memoizedState), i !== u || c !== p || Ci.current || Ai ? ("function" == typeof f && (fn(t, f, u), p = t.memoizedState), (f = Ai || pn(t, i, u, c, p, s)) ? (l || "function" != typeof o.UNSAFE_componentWillUpdate && "function" != typeof o.componentWillUpdate || ("function" == typeof o.componentWillUpdate && o.componentWillUpdate(u, p, s), "function" == typeof o.UNSAFE_componentWillUpdate && o.UNSAFE_componentWillUpdate(u, p, s)), "function" == typeof o.componentDidUpdate && (t.effectTag |= 4), "function" == typeof o.getSnapshotBeforeUpdate && (t.effectTag |= 256)) : ("function" != typeof o.componentDidUpdate || i === e.memoizedProps && c === e.memoizedState || (t.effectTag |= 4), "function" != typeof o.getSnapshotBeforeUpdate || i === e.memoizedProps && c === e.memoizedState || (t.effectTag |= 256), t.memoizedProps = u, t.memoizedState = p), o.props = u, o.state = p, o.context = s, o = f) : ("function" != typeof o.componentDidUpdate || i === e.memoizedProps && c === e.memoizedState || (t.effectTag |= 4), "function" != typeof o.getSnapshotBeforeUpdate || i === e.memoizedProps && c === e.memoizedState || (t.effectTag |= 256), o = !1);
                return Pn(e, t, o, a, n);
            case 3:
                return Cn(t), a = t.updateQueue, null !== a ? (o = t.memoizedState, o = null !== o ? o.element : null, en(t, a, t.pendingProps, null, n), (a = t.memoizedState.element) === o ? (On(), e = Sn(e, t)) : (o = t.stateNode, (o = (null === e || null === e.child) && o.hydrate) && (Wi = Et(t.stateNode.containerInfo), $i = t, o = Hi = !0), o ? (t.effectTag |= 2, t.child = qi(t, null, a, n)) : (On(), xn(e, t, a)), e = t.child)) : (On(), e = Sn(e, t)), e;
            case 5:
                return sn(Li.current), a = sn(Ui.current), o = it(a, t.type), a !== o && (jt(Ii, t, t), jt(Ui, o, t)), null === e && _n(t), a = t.type, u = t.memoizedProps, o = t.pendingProps, i = null !== e ? e.memoizedProps : null, Ci.current || u !== o || ((u = 1 & t.mode && !!o.hidden) && (t.expirationTime = 1073741823), u && 1073741823 === n) ? (u = o.children, _t(a, o) ? u = null : i && _t(a, i) && (t.effectTag |= 16), kn(e, t), 1073741823 !== n && 1 & t.mode && o.hidden ? (t.expirationTime = 1073741823, t.memoizedProps = o, e = null) : (xn(e, t, u), t.memoizedProps = o, e = t.child)) : e = Sn(e, t), e;
            case 6:
                return null === e && _n(t), t.memoizedProps = t.pendingProps, null;
            case 16:
                return null;
            case 4:
                return ln(t, t.stateNode.containerInfo), a = t.pendingProps, Ci.current || t.memoizedProps !== a ? (null === e ? t.child = zi(t, null, a, n) : xn(e, t, a), t.memoizedProps = a, e = t.child) : e = Sn(e, t), e;
            case 14:
                return a = t.type.render, n = t.pendingProps, o = t.ref, Ci.current || t.memoizedProps !== n || o !== (null !== e ? e.ref : null) ? (a = a(n, o), xn(e, t, a), t.memoizedProps = n, e = t.child) : e = Sn(e, t), e;
            case 10:
                return n = t.pendingProps, Ci.current || t.memoizedProps !== n ? (xn(e, t, n), t.memoizedProps = n, e = t.child) : e = Sn(e, t), e;
            case 11:
                return n = t.pendingProps.children, Ci.current || null !== n && t.memoizedProps !== n ? (xn(e, t, n), t.memoizedProps = n, e = t.child) : e = Sn(e, t), e;
            case 15:
                return n = t.pendingProps, t.memoizedProps === n ? e = Sn(e, t) : (xn(e, t, n.children), t.memoizedProps = n, e = t.child), e;
            case 13:
                return Tn(e, t, n);
            case 12:
    ...
    function Rn(e, t) {
        ...
        switch (t.tag) {
            ...
            case 3:
                un(t), Tt(t);
                var o = t.stateNode;
                return o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), null !== e && null !== e.child || (En(t), t.effectTag &= -3), Qi(t), null;
            case 5:
                ...
                if (null !== e && null != t.stateNode) {
                    ...
                    if (e = sn(Ui.current), En(t)) n = t.stateNode, a = t.type, i = t.memoizedProps, n[oo] = t, n[ao] = i, o = bt(n, a, i, e, o), t.updateQueue = o, null !== o && Mn(t);
                    else {
                        ...
                        ht(e, a, n, o), gt(a, n) && Mn(t), t.stateNode = e
                    }
            ...
            case 6:
                if (e && null != t.stateNode) Gi(e, t, e.memoizedProps, n);
                    ...
                    o = sn(Li.current), sn(Ui.current), En(t) ? (o = t.stateNode, n = t.memoizedProps, o[oo] = t, vt(o, n) && Mn(t)) : (o = dt(n, o), o[oo] = t, t.stateNode = o)
                }
                return null;
            case 14:
            case 16:
    ...
    function zn(e, t, n) { n = Yt(n), n.tag = 3, n.payload = { element: null }; var r = t.value; return n.callback = function() { hr(r), Fn(e, t) }, n }
    ...
    function $n(e, t, n, r, o, a) {
        ...
        do {
            switch (e.tag) {
                ...
                case 2:
                    if (t = r, n = e.stateNode, 0 == (64 & e.effectTag) && null !== n && "function" == typeof n.componentDidCatch && (null === cs || !cs.has(n))) return e.effectTag |= 1024, r = qn(e, t, a), void Xt(e, r, a)
            }
            e = e.return
        } while (null !== e)
    }
    ...
    function Wn(e) {
        switch (e.tag) {
            ...
            case 3:
                return un(e), Tt(e), t = e.effectTag, 1024 & t ? (e.effectTag = -1025 & t | 64, e) : null;
            case 5:
                return cn(e), null;
            case 16:
    ...
    function Qn(e) {
        for (;;) {
            ...
            if (0 == (512 & e.effectTag)) {
                ...
                if (null !== (e = Wn(e, is, os))) return e.effectTag &= 511, e;
    ...
    function Yn(e) { var t = An(e.alternate, e, os); return null === t && (t = Qn(e)), Bo.current = null, t }

    function Gn(e, t, n) {
        ts && r("243"), ts = !0, t === os && e === rs && null !== ns || (Hn(), rs = e, os = t, as = -1, ns = Dt(rs.current, null, os), e.pendingCommitExpirationTime = 0);
        var o = !1;
        for (is = !n || os <= Xi;;) {
            try {
                if (n)
        ...
        e: {
            for (ts && !ls && r("263"), n = e.return; null !== n;) {
                switch (n.tag) {
                    case 2:
                        var o = n.stateNode;
                        if ("function" == typeof n.type.getDerivedStateFromCatch || "function" == typeof o.componentDidCatch && (null === cs || !cs.has(o))) { e = rn(t, e), e = qn(n, e, 1), Kt(n, e, 1), Zn(n, 1), n = void 0; break e }
                        break;
                    case 3:
    ...
    function cr() {
        if (Cs = 0, null !== ks) {
            var e = ks;
            ks = null;
            for (var t = 0; t < e.length; t++) { var n = e[t]; try { n._onComplete() } catch (e) { _s || (_s = !0, ws = e) } }
        }
    ...
    function pr(e, t, n) {
        ...
        if (e.finishedWork = null, ls = ts = !0, n = t.stateNode, n.current === t && r("177"), o = n.pendingCommitExpirationTime, 0 === o && r("261"), n.pendingCommitExpirationTime = 0, er(), Bo.current = null, 1 < t.effectTag)
        ...
        for (wi = { focusedElem: i, selectionRange: s }, Ve(!1), ss = a; null !== ss;) {
            i = !1, s = void 0;
            try {
                for (; null !== ss;) {
                    if (256 & ss.effectTag) {
                        ...
                        switch (u = ss, u.tag) {
                            case 2:
                                if (256 & u.effectTag && null !== g) {
                                    ...
                                    var O = E.getSnapshotBeforeUpdate(_, w);
        ...
        for (ss = a; null !== ss;) {
                ...
                for (; null !== ss;) {
                    ...
                    switch (14 & x) {
                        case 2:
                            ...
                            break;
                        case 6:
                            Ln(ss), ss.effectTag &= -3, Vn(ss.alternate, ss);
                            break;
                        case 4:
                            Vn(ss.alternate, ss);
                            break;
            ...
            g && (null === ss && r("178"), Kn(ss, _), null !== ss && (ss = ss.nextEffect))
        }
        if (k = wi, j = Lr(), x = k.focusedElem, g = k.selectionRange, j !== x && Vr(document.documentElement, x)) { null !== g && Ge(x) && (j = g.start, k = g.end, void 0 === k && (k = j), "selectionStart" in x ? (x.selectionStart = j, x.selectionEnd = Math.min(k, x.value.length)) : window.getSelection && (j = window.getSelection(), _ = x[M()].length, k = Math.min(g.start, _), g = void 0 === g.end ? k : Math.min(g.end, _), !j.extend && k > g && (_ = g, g = k, k = _), _ = Ye(x, k), w = Ye(x, g), _ && w && (1 !== j.rangeCount || j.anchorNode !== _.node || j.anchorOffset !== _.offset || j.focusNode !== w.node || j.focusOffset !== w.offset) && (E = document.createRange(), E.setStart(_.node, _.offset), j.removeAllRanges(), k > g ? (j.addRange(E), j.extend(w.node, w.offset)) : (E.setEnd(w.node, w.offset), j.addRange(E))))), j = []; for (k = x; k = k.parentNode;) 1 === k.nodeType && j.push({ element: k, left: k.scrollLeft, top: k.scrollTop }); for ("function" == typeof x.focus && x.focus(), x = 0; x < j.length; x++) k = j[x], k.element.scrollLeft = k.left, k.element.scrollTop = k.top }
        for (wi = null, Ve(_i), _i = null, n.current = t, ss = a; null !== ss;) {
            a = !1, x = void 0;
            try {
                for (j = o; null !== ss;) {
                    var P = ss.effectTag;
                                ...
                                if (4 & k.effectTag)
                                    if (null === C) N.props = k.memoizedProps, N.state = k.memoizedState, N.componentDidMount();
                                        ...
                                        var T = C.memoizedProps,
                                            S = C.memoizedState;
                                        N.props = k.memoizedProps, N.state = k.memoizedState, N.componentDidUpdate(T, S, N.__reactInternalSnapshotBeforeUpdate)
                                    }
                                var A = k.updateQueue;
                                null !== A && (N.props = k.memoizedProps, N.state = k.memoizedState, nn(k, A, N, g));
                                break;
                            case 3:
                                var R = k.updateQueue;
                                if (null !== R) {
        ...
        ts = ls = !1, "function" == typeof $t && $t(t.stateNode), t = n.current.expirationTime, 0 === t && (cs = null), e.remainingExpirationTime = t
    }

    function dr() { return !(null === Es || Es.timeRemaining() > Ns) && (gs = !0) }

    function hr(e) { null === ys && r("246"), ys.remainingExpirationTime = 0, _s || (_s = !0, ws = e) }
    ...
    function wr(e, t, n, o, a) {
        ...
        if (n) {
            ...
            var s;
            e: {
                for (2 === Me(n) && 2 === n.tag || r("170"), s = n; 3 !== s.tag;) { if (Ct(s)) { s = s.stateNode.__reactInternalMemoizedMergedChildContext; break e }(s = s.return) || r("171") }
    ...
    function Or(e, t, n, r) { var o = t.current; return o = Jn(er(), o), wr(e, t, n, o, r) }
    ...
    function jr(e) { var t = e.findFiberByHostInstance; return qt(Ur({}, e, { findHostInstanceByFiber: function(e) { return e = De(e), null === e ? null : e.stateNode }, findFiberByHostInstance: function(e) { return t ? t(e) : null } })) }

    function kr(e, t, n) { var r = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null; return { $$typeof: qo, key: null == r ? null : "" + r, children: e, containerInfo: t, implementation: n } }
    ...
    function Nr(e, t, n) { this._internalRoot = Vt(e, t, n) }
    ...
    function Ar(e, t, n, o, a) {
        ...
        if (i) {
            ...
            if (i = n._reactRootContainer = Sr(n, o), "function" == typeof a) {
                var l = a;
                a = function() {
                    var e = xr(i._internalRoot);
                    l.call(e)
    ...
    function Mr(e, t) { var n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null; return Tr(t) || r("200"), kr(e, t, null, n) }
    var Rr = n(24),
        Fr = n(0),
        Dr = n(84),
        Ur = n(32),
    ...
    var qr = {
            ...
            _rethrowError: null,
            _hasRethrowError: !1,
            invokeGuardedCallback: function(e, t, n, r, a, i, s, l, u) { o.apply(qr, arguments) },
            ...
            rethrowCaughtError: function() { return a.apply(qr, arguments) },
        ...
        Yr = {},
        Gr = {},
        Kr = { plugins: Hr, eventNameDispatchConfigs: Qr, registrationNameModules: Yr, registrationNameDependencies: Gr, possibleRegistrationNames: null, injectEventPluginOrder: l, injectEventPluginsByName: u },
        Xr = null,
        Jr = null,
        Zr = null,
        eo = null,
        ...
        io = { precacheFiberNode: function(e, t) { t[oo] = e }, getClosestInstanceFromNode: g, getInstanceFromNode: function(e) { return e = e[oo], !e || 5 !== e.tag && 6 !== e.tag ? null : e }, getNodeFromInstance: _, getFiberCurrentPropsFromNode: w, updateFiberProps: function(e, t) { e[ao] = t } },
        so = { accumulateTwoPhaseDispatches: N, accumulateTwoPhaseDispatchesSkipTarget: function(e) { p(e, k) }, accumulateEnterLeaveDispatches: T, accumulateDirectDispatches: function(e) { p(e, C) } },
        lo = { animationend: S("Animation", "AnimationEnd"), animationiteration: S("Animation", "AnimationIteration"), animationstart: S("Animation", "AnimationStart"), transitionend: S("Transition", "TransitionEnd") },
        uo = {},
        co = {};
    ...
    var fo = A("animationend"),
        ...
        _o = { type: null, target: null, currentTarget: Ir.thatReturnsNull, eventPhase: null, bubbles: null, cancelable: null, timeStamp: function(e) { return e.timeStamp || Date.now() }, defaultPrevented: null, isTrusted: null };
    Ur(D.prototype, {
    ...
    var ko = Dr.canUseDOM && "TextEvent" in window && !jo,
        ...
        Ao = {
            ...
            extractEvents: function(e, t, n, r) {
                ...
                else So ? B(e, n) && (o = No.compositionEnd) : "keydown" === e && 229 === n.keyCode && (o = No.compositionStart);
                return o ? (Po && (So || o !== No.compositionStart ? o === No.compositionEnd && So && (a = R()) : (vo._root = r, vo._startText = F(), So = !0)), o = wo.getPooled(o, t, n, r), a ? o.data = a : null !== (a = V(n)) && (o.data = a), N(o), a = o) : a = null, (e = ko ? z(e, n) : q(e, n)) ? (t = Eo.getPooled(No.beforeInput, t, n, r), t.data = e, N(t)) : t = null, null === a ? t : null === t ? a : [a, t]
            }
        },
        Mo = null,
        Ro = { injectFiberControlledHostComponent: function(e) { Mo = e } },
        Fo = null,
        Do = null,
        Uo = { injection: Ro, enqueueStateRestore: W, needsStateRestore: H, restoreStateIfNeeded: Q },
        Io = !1,
        ...
        Bo = Fr.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
        Vo = "function" == typeof Symbol && Symbol.for,
        zo = Vo ? Symbol.for("react.element") : 60103,
        qo = Vo ? Symbol.for("react.portal") : 60106,
        $o = Vo ? Symbol.for("react.fragment") : 60107,
        Wo = Vo ? Symbol.for("react.strict_mode") : 60108,
        Ho = Vo ? Symbol.for("react.profiler") : 60114,
        Qo = Vo ? Symbol.for("react.provider") : 60109,
        Yo = Vo ? Symbol.for("react.context") : 60110,
        Go = Vo ? Symbol.for("react.async_mode") : 60111,
        Ko = Vo ? Symbol.for("react.forward_ref") : 60112,
    ...
    var ua = {
            ...
            extractEvents: function(e, t, n, r) {
                ...
                if ("select" === s || "input" === s && "file" === o.type ? a = xe : J(o) ? la ? a = Te : (a = Ce, i = Pe) : (s = o.nodeName) && "input" === s.toLowerCase() && ("checkbox" === o.type || "radio" === o.type) && (a = Ne), a && (a = a(e, t))) return we(a, n, r);
        ...
        pa = ca.extend({ screenX: null, screenY: null, clientX: null, clientY: null, pageX: null, pageY: null, ctrlKey: null, shiftKey: null, altKey: null, metaKey: null, getModifierState: Ae, button: null, buttons: null, relatedTarget: function(e) { return e.relatedTarget || (e.fromElement === e.srcElement ? e.toElement : e.fromElement) } }),
        ...
        ma = {
            ...
            extractEvents: function(e, t, n, r) {
                ...
                var i = void 0,
                    ...
                    l = void 0,
                    u = void 0;
                return "mouseout" === e || "mouseover" === e ? (i = pa, s = ha.mouseLeave, l = ha.mouseEnter, u = "mouse") : "pointerout" !== e && "pointerover" !== e || (i = da, s = ha.pointerLeave, l = ha.pointerEnter, u = "pointer"), e = null == a ? o : _(a), o = null == t ? o : _(t), s = i.getPooled(s, a, n, r), s.type = u + "leave", s.target = e, s.relatedTarget = o, n = i.getPooled(l, t, n, r), n.type = u + "enter", n.target = o, n.relatedTarget = e, T(s, n, a, t), [s, n]
            }
        },
        ...
        _a = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Löschen", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" },
        wa = ca.extend({
            key: function(e) { if (e.key) { var t = ga[e.key] || e.key; if ("Unidentified" !== t) return t } return "keypress" === e.type ? (e = Ie(e), 13 === e ? "Enter" : String.fromCharCode(e)) : "keydown" === e.type || "keyup" === e.type ? _a[e.keyCode] || "Unidentified" : "" },
            location: null,
            ctrlKey: null,
            shiftKey: null,
            altKey: null,
            ...
            locale: null,
            getModifierState: Ae,
            charCode: function(e) { return "keypress" === e.type ? Ie(e) : 0 },
            keyCode: function(e) { return "keydown" === e.type || "keyup" === e.type ? e.keyCode : 0 },
            which: function(e) { return "keypress" === e.type ? Ie(e) : "keydown" === e.type || "keyup" === e.type ? e.keyCode : 0 }
        }),
        Ea = pa.extend({ dataTransfer: null }),
        Oa = ca.extend({ touches: null, targetTouches: null, changedTouches: null, altKey: null, metaKey: null, ctrlKey: null, shiftKey: null, getModifierState: Ae }),
    ...
    var Na = {
        ...
        Ta = Na.isInteractiveTopLevelEventType,
        Sa = [],
        Aa = !0,
        Ma = {get _enabled() { return Aa }, setEnabled: Ve, isEnabled: function() { return Aa }, trapBubbledEvent: ze, trapCapturedEvent: qe, dispatchEvent: We },
        Ra = {},
        Fa = 0,
        ...
        qa = {
            ...
            extractEvents: function(e, t, n, r) {
                ...
                switch (a = t ? _(t) : window, e) {
                    case "focus":
                        (J(a) || "true" === a.contentEditable) && (La = a, Ba = t, Va = null);
                        break;
                    case "blur":
                        Va = Ba = La = null;
                        break;
    ...
    } else Ya = function() { return Wa.now() };
    var Ka = void 0,
        Xa = void 0;
    if (Dr.canUseDOM) {
        var Ja = "function" == typeof $a ? $a : function() { r("276") },
            Za = null,
            ei = null,
            ti = -1,
            ni = !1,
        ...
        Ka = function(e) {
            var t = { scheduledCallback: e, timeoutTime: 0, next: null, prev: null },
                n = Ha(function() { e({ timeRemaining: function() { return 1 / 0 }, didTimeout: !1 }) });
            return fi.set(e, n), t
        }, Xa = function(e) {
    ...
    var Ki = Ei(),
        ...
        Cs = 0,
        Ns = 1,
        Ts = { updateContainerAtExpirationTime: wr, createContainer: function(e, t, n) { return Vt(e, t, n) }, updateContainer: Or, flushRoot: ur, requestWork: or, computeUniqueAsyncExpiration: Xn, batchedUpdates: yr, unbatchedUpdates: br, deferredUpdates: tr, syncUpdates: nr, interactiveUpdates: gr, flushInteractiveUpdates: function() { ms || 0 === vs || (lr(vs, !1, null), vs = 0) }, flushControlled: _r, flushSync: vr, getPublicRootInstance: xr, findHostInstance: Er, findHostInstanceWithNoPortals: function(e) { return e = Ue(e), null === e ? null : e.stateNode }, injectIntoDevTools: jr };
    Ro.injectFiberControlledHostComponent(gi), Pr.prototype.render = function(e) {
        ...
        return e
    }, Y = Ts.batchedUpdates, G = Ts.interactiveUpdates, K = Ts.flushInteractiveUpdates;
    var Ss = { createPortal: Mr, findDOMNode: function(e) { return null == e ? null : 1 === e.nodeType ? e : Er(e) }, hydrate: function(e, t, n) { return Ar(null, e, t, !0, n) }, render: function(e, t, n) { return Ar(null, e, t, !1, n) }, unstable_renderSubtreeIntoContainer: function(e, t, n, o) { return (null == e || void 0 === e._reactInternalFiber) && r("38"), Ar(e, t, n, !1, o) }, unmountComponentAtNode: function(e) { return Tr(e) || r("40"), !!e._reactRootContainer && (br(function() { Ar(null, null, e, !1, function() { e._reactRootContainer = null }) }), !0) }, unstable_createPortal: function() { return Mr.apply(void 0, arguments) }, unstable_batchedUpdates: yr, unstable_deferredUpdates: tr, unstable_interactiveUpdates: gr, flushSync: vr, unstable_flushControlled: _r, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: { EventPluginHub: no, EventPluginRegistry: Kr, EventPropagators: so, ReactControlledComponent: Uo, ReactDOMComponentTree: io, ReactDOMEventListener: Ma }, unstable_createRoot: function(e, t) { return new Nr(e, !0, null != t && !0 === t.hydrate) } };
    ...
    t.a = function() {
        ...
        return function(e, t, i) {
            var l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                ...
                P = o(i, v, "mergeProps");
            return n(_, p({ methodName: "connect", getDisplayName: function(e) { return "Connect(" + e + ")" }, shouldHandleStateChanges: Boolean(e), initMapStateToProps: j, initMapDispatchToProps: k, initMergeProps: P, pure: c, areStatesEqual: d, areOwnPropsEqual: b, areStatePropsEqual: w, areMergedPropsEqual: O }, x))
        }
    }()
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(26),
        ...
        h = function() {
            ...
            var t = window.history,
                ...
                E = Object(u.a)(),
                O = function(e) { p(z, e), z.length = t.length, E.notifyListeners(z.location, z.action) },
                x = function(e) { Object(c.d)(e) || P(_(e.state)) },
                j = function() { P(_(d())) },
                k = !1,
                P = function(e) { k ? (k = !1, O()) : E.confirmTransitionTo(e, "POP", y, function(t) { t ? O({ action: "POP", location: e }) : C(e) }) },
                C = function(e) {
                    var t = z.location,
                        n = T.indexOf(t.key); - 1 === n && (n = 0);
                    var r = T.indexOf(e.key); - 1 === r && (r = 0);
                    var o = n - r;
                    o && (k = !0, R(o))
                },
                N = _(d()),
                T = [N.key],
                S = function(e) { return g + Object(l.b)(e) },
                A = function(e, r) {
                    ...
                    var a = Object(s.a)(e, r, w(), z.location);
                            ...
                            if (n)
                                if (t.pushState({ key: i, state: s }, null, r), h) window.location.href = r;
                                    ...
                                    var l = T.indexOf(z.location.key),
                                        u = T.slice(0, -1 === l ? 0 : l + 1);
                                    u.push(a.key), T = u, O({ action: "PUSH", location: a })
                                }
                    ...
                    E.confirmTransitionTo(a, "REPLACE", y, function(e) {
                        if (e) {
                            ...
                            if (n)
                                ...
                                else { var l = T.indexOf(z.location.key); - 1 !== l && (T[l] = a.key), O({ action: "REPLACE", location: a }) }
                ...
                z = { length: t.length, action: "POP", location: N, createHref: S, push: A, replace: M, go: R, goBack: F, goForward: D, block: B, listen: V };
            return z
        };
    t.a = h
}, function(e, t, n) {
    ...
    var r = n(26),
        ...
        y = function() {
            ...
            var t = window.history,
                ...
                O = Object(u.a)(),
                x = function(e) { f(W, e), W.length = t.length, O.notifyListeners(W.location, W.action) },
                j = !1,
                k = null,
                P = function() {
                    var e = d(),
                ...
                C = function(e) { j ? (j = !1, x()) : O.confirmTransitionTo(e, "POP", a, function(t) { t ? x({ action: "POP", location: e }) : N(e) }) },
                N = function(e) {
                    var t = W.location,
            ...
            var A = E(),
                ...
                F = function(e, t) {
                    ...
                    var n = Object(s.a)(e, void 0, void 0, W.location);
                    O.confirmTransitionTo(n, "PUSH", a, function(e) {
                        if (e) {
                            ...
                            if (d() !== r) {
                                k = t, h(r);
                                var a = M.lastIndexOf(Object(l.b)(W.location)),
                    ...
                    O.confirmTransitionTo(n, "REPLACE", a, function(e) {
                        if (e) {
                            var t = Object(l.b)(n),
                                r = _(v + t);
                            d() !== r && (k = t, m(r));
                            var o = M.indexOf(Object(l.b)(W.location)); - 1 !== o && (M[o] = t), x({ action: "REPLACE", location: n })
                        }
                    })
                },
                ...
                B = 0,
                V = function(e) { B += e, 1 === B ? Object(c.a)(window, "hashchange", P) : 0 === B && Object(c.e)(window, "hashchange", P) },
                z = !1,
                q = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                        t = O.setPrompt(e);
                    return z || (V(1), z = !0),
                        function() { return z && (z = !1, V(-1)), t() }
                },
                $ = function(e) {
                ...
                W = { length: t.length, action: "POP", location: A, createHref: R, push: F, replace: D, go: U, goBack: I, goForward: L, block: q, listen: $ };
            return W
        };
    t.a = y
}, function(e, t, n) {
    ...
    var r = n(26),
        ...
        f = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                ...
                N = { length: g.length, action: "POP", location: g[v], index: v, entries: g, createHref: _, push: w, replace: E, go: O, goBack: x, goForward: j, canGo: k, block: P, listen: C };
            return N
        };
    t.a = f
}, function(e, t, n) {
                        ...
                        for (var d, h, m, y, b, v, g, _, w, E = {};;) {
                            if (m = r[r.length - 1], this.defaultActions[m] ? y = this.defaultActions[m] : (null == d && (d = t()), y = i[m] && i[m][d]), void 0 === y || !y.length || !y[0]) {
                                if (!c) {
                                    ...
                                    var O = "";
                                    O = this.lexer.showPosition ? "Parse error on line " + (l + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + w.join(", ") + ", got '" + this.terminals_[d] + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (1 == d ? "end of input" : "'" + (this.terminals_[d] || d) + "'"), this.parseError(O, { text: this.lexer.match, token: this.terminals_[d] || d, line: this.lexer.yylineno, loc: p, expected: w })
                                }
                                if (3 == c) {
                                ...
                                for (; !(f.toString() in i[m]);) { if (0 == m) throw new Error(O || "Parsing halted.");! function(e) { r.length = r.length - 2, o.length = o.length - 1, a.length = a.length - 1 }(), m = r[r.length - 1] }
    ...
    function i(e, t, n, o) {
        ...
        if (Array.isArray(e))
            ...
            if (d)
                ...
                var w = "" + e;
                b(!1, "Objects are not valid as a React child (found: %s).%s", "[object Object]" === w ? "object with keys {" + Object.keys(e).join(", ") + "}" : w, "")
            }
        }
        return c
    }
    ...
    function o(e, t, n) {
        ...
        function y(e) {
            ...
            t.prototype = new x, t.prototype.constructor = t, t.prototype.__reactAutoBindPairs = [], b.forEach(u.bind(null, t)), u(t, w), u(t, e), u(t, E), t.getDefaultProps && (t.defaultProps = t.getDefaultProps()), s(t.prototype.render, "createClass(...): Class specification must implement a `render` method.");
    ...
    r.prototype.request = function(e) {
        ...
        var t = [s, void 0],
            n = Promise.resolve(e);
        for (this.interceptors.request.forEach(function(e) { t.unshift(e.fulfilled, e.rejected) }),
    ...
    var r = n(73),
        ...
        l = function e(t, n, o, a, i, l, u, c, f, p, d, h) {
            ...
            if ("string" == typeof m || "number" == typeof m || "boolean" == typeof m || r.isBuffer(m)) return l ? [d(h ? n : l(n, s.encoder)) + "=" + d(l(m, s.encoder))] : [d(n) + "=" + d(String(m))];
            var y = [];
            ...
            for (var g = 0; g < b.length; ++g) {
                var _ = b[g];
                i && null === m[_] || (y = Array.isArray(m) ? y.concat(e(m[_], o(n, _), o, a, i, l, u, c, f, p, d, h)) : y.concat(e(m[_], n + (f ? "." + _ : "[" + _ + "]"), o, a, i, l, u, c, f, p, d, h)))
            }
            return y
        };
    e.exports = function(e, t) {
        ...
        for (var x = 0; x < v.length; ++x) {
            var j = v[x];
            f && null === n[j] || (w = w.concat(l(n[j], j, O, c, f, p ? d : null, g, h, m, y, _, b)))
        }
        var k = w.join(u),
            ...
            return a(t, e), i(t, [{
                ...
                value: function(e, t, n) {
                    ...
                    n && (this.$el.find(".sui-box-body").html('<p class="fui-loading-dialog" aria-label="Loading content"><i class="sui-icon-loader sui-loading" aria-hidden="true"></i></p>'), this.$el.find(".sui-box-footer").html(""), this.$el.find(".integration-header").html("")), this.$el.find(".sui-button:not(.disable-loader)").addClass("sui-button-onload"), this.ajax = jQuery.post({ url: powerformData.ajaxUrl, type: "post", data: e }).done(function(e) {
                        if (e && e.success) {
                            ...
                            var n = e.data.data;
                            if (r.onRender(n), r.$el.find(".sui-button").removeClass("sui-button-onload"), (t || !_.isUndefined(n.is_close) && n.is_close) && r.close(r), r.$el.find(".powerform-addon-close").on("click", function() { r.close(r) }), _.isUndefined(n.notification) || _.isUndefined(n.notification.type) || _.isUndefined(n.notification.text) || new l.default({ type: n.notification.type, text: n.notification.text, time: 4e3 }).open(), _.isUndefined(n.has_back) ? r.$el.find(".powerform-addon-back").hide() : n.has_back ? r.$el.find(".powerform-addon-back").show() : r.$el.find(".powerform-addon-back").hide(), !_.isUndefined(n.size)) { var a = jQuery("#powerform-integration-popup"); "normal" === n.size && a.removeClass("sui-dialog-sm sui-dialog-lg"), "small" === n.size && (a.addClass("sui-dialog-sm"), a.removeClass("sui-dialog-lg")), "large" === n.size && (a.addClass("sui-dialog-lg"), a.removeClass("sui-dialog-sm")) }
                ...
                value: function(e) {
                    var t = {},
                        ...
                        r = { slug: this.slug, step: this.getStep(), current_step: this.step },
                        o = n.serialize();
                    r = this.getAjaxModuleData(r, !0), o = o + "&" + jQuery.param(r), t.action = this.action, t._ajax_nonce = this.nonce, t.data = o,
                        this.request(t, !1, !1)
                }
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.Headers = s, t.Request = y, t.Response = g, n.d(t, "DOMException", function() { return k }), t.fetch = _;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.updateAnswers = function(e) { return function(t) { window.powerformChanges.settings = !0, t({ type: "UPDATE_ANSWERS", answers: e }) } }, t.updateAnswer = function(e) { return function(t) { window.powerformChanges.settings = !0, t({ type: "UPDATE_ANSWER", answer: e }) } }
}, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(e, t, n) {
    "use strict";
    ...
    p.default.setLocale(powerforml10n.locale), window.powerformChanges = { answers: [], settings: !1 }, (0, i.render)(a.default.createElement(s.Provider, { store: m }, a.default.createElement(l.MemoryRouter, null, a.default.createElement(l.Route, { component: h.default }))), document.getElementById("powerform-poll-builder"))
}, function(e, t, n) {
    "use strict";
    ...
    var o = n(5),
        ...
        u = n(359),
        c = r(u),
        f = (0, o.combineReducers)({ answers: i.default, settings: l.default, modal: c.default });
    t.default = f
}, function(e, t, n) {
    "use strict";
    ...
    var s = function() {
        ...
        M = function(e) {
            ...
            }, { key: "handleBeforeunload", value: function(e) { if (e.preventDefault(), window.powerformChanges.length > 0 || !0 === window.powerformChanges.settings) return e.returnValue = (0, p.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?"), (0, p.translate)("Du hast nicht gespeicherte Änderungen, möchtest Du diese Seite wirklich verlassen?") } }, { key: "render", value: function() { return u.default.createElement("div", null, u.default.createElement(h.default, null), u.default.createElement("div", { className: "sui-row-with-sidenav" }, u.default.createElement("div", { className: "sui-sidenav" }, u.default.createElement(_.default, this.props)), u.default.createElement("div", { id: "powerform-builder-status", className: "sui-box sui-box-sticky", ref: "StickyHeader" }, u.default.createElement(v.default, null)), u.default.createElement(f.Route, { exact: !0, path: "/", render: function() { return u.default.createElement(f.Redirect, { to: "/builder" }) } }), u.default.createElement(f.Route, { path: "/builder", component: E.default }), u.default.createElement(f.Route, { path: "/appearance", component: x.default }), u.default.createElement(f.Route, { path: "/behaviour", component: k.default }), u.default.createElement(f.Route, { path: "/notifications", component: C.default }), u.default.createElement(f.Route, { path: "/integrations", component: T.default }), u.default.createElement(f.Route, { path: "/settings", component: A.default })), u.default.createElement(y.default, this.props)) } }]), t
        }(l.Component);
    t.default = M
}, function(e, t, n) {
    "use strict";
    ...
    function o(e) { return i.default.createElement("div", { className: "sui-header sui-header-inline sui-with-floating-input" }, i.default.createElement("h1", { className: "sui-header-title" }, (0, u.translate)("Umfrage bearbeiten")), i.default.createElement("div", { className: "sui-actions-right" }, i.default.createElement(l.default, e))) }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = o;
    var a = n(0),
        i = r(a),
        s = n(363),
    ...
    function r(e) { return powerformData.showDocLink ? a.default.createElement("a", { href: "https://n3rds.work/docs/ps-powerform-handbuch/#polls", target: "_blank", className: "sui-button sui-button-ghost" }, a.default.createElement("i", { className: "sui-icon-academy" }), " ", (0, i.translate)("Dokumentation anzeigen")) : "" }
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = r;
    var o = n(0),
    ...
    var o = n(367),
        ...
        c = n(370),
        f = r(c),
        p = { previewModal: a.default, publishModal: s.default, shortcodeModal: u.default, deleteModal: f.default };
    t.default = p
}, function(e, t, n) {
    "use strict";
            ...
            return a(t, e), i(t, [{ key: "componentDidMount", value: function() { this.$el = jQuery(this.el), this.$body = jQuery(this.body), this.mounted = !0, this.load(), jQuery(document).off("after.load.powerform"), jQuery(document).on("after.load.powerform", this.previewLoaded) } }, { key: "componentWillUnmount", value: function() { this.mounted = !1 } }, { key: "previewLoaded", value: function() { this.$body.find(".sui-notice-loading").remove() } }, {
                ...
                value: function() {
                    var e = { answers: this.props.answers, settings: this.props.settings },
                        t = { id: this.props.id, action: "powerform_load_poll", type: "powerform_polls", render_id: 0, is_preview: 1, preview_data: e, last_submit_data: {} };
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("i", { className: "sui-icon-loader sui-loading", "aria-hidden": "true" }), l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("Umfrage veröffentlichen..."))), l.default.createElement("div", { className: "sui-box-body" }, l.default.createElement("p", null, (0, u.translate)("Großartige Arbeit! Bitte warte einige Momente, während wir Dein Formular für die Welt veröffentlichen."))), powerformData.showBranding && l.default.createElement("img", { src: powerformData.imagesUrl + "/powerform-visibility.png", srcSet: powerformData.imagesUrl + "/powerform-visibility.png 1x,\n\t\t\t\t\t\t" + powerformData.imagesUrl + "/powerform-visibility@2x.png 2x", className: "sui-image sui-image-center" })) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = function() {
        ...
        d = function(e) {
            ...
            return i(t, e), s(t, [{ key: "copyToClipboard", value: function() { this.input.select(), document.execCommand("copy"), new p.default({ type: "success", text: (0, c.translate)("Shortcode wurde erfolgreich kopiert."), time: 4e3 }).open() } }, { key: "render", value: function() { var e = this; return u.default.createElement(u.default.Fragment, null, u.default.createElement("div", { className: "sui-box-header sui-block-content-center" }, u.default.createElement("i", { className: "sui-icon-check sui-lg", "aria-hidden": "true" }), u.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, c.translate)("Bereit zum loslegen!")), u.default.createElement("button", { className: "sui-dialog-close powerform-cancel-create-form", "aria-label": (0, c.translate)("Dieses Dialogfenster schließen"), onClick: this.closeModal })), u.default.createElement("div", { className: "sui-box-body sui-block-content-center" }, u.default.createElement("p", null, u.default.createElement("small", null, (0, c.translate)("Deine Umfrage kann jetzt in eine Seite oder Vorlage Deiner Wahl eingebettet werden. Kopiere einfach den folgenden Shortcode und füge ihn ein, um ihn anzuzeigen!"))), u.default.createElement("div", { id: "powerform-form-name-input", className: "sui-form-field" }, u.default.createElement("label", { htmlFor: "powerform-form-name", className: "sui-label" }, (0, c.translate)("Shortcode")), u.default.createElement("div", { className: "sui-with-button sui-with-button-icon" }, u.default.createElement("input", { type: "text", id: "powerform-form-shortcode", ref: function(t) { return e.input = t }, className: "sui-form-control", defaultValue: '[powerform_poll id="' + this.props.id + '"]' }), u.default.createElement("button", { className: "sui-button-icon", onClick: this.copyToClipboard }, u.default.createElement("i", { "aria-hidden": "true", className: "sui-icon-copy" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Shortcode kopieren")))))), powerformData.showBranding && u.default.createElement("img", { src: powerformData.imagesUrl + "/powerform-visibility.png", srcSet: powerformData.imagesUrl + "/powerform-visibility.png 1x,\n\t\t\t\t\t\t" + powerformData.imagesUrl + "/powerform-visibility@2x.png 2x", className: "sui-image sui-image-center" })) } }]), t
        }(l.Component);
    t.default = d
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{ key: "trashField", value: function() { this.props.modal.modalProps.trashField(), this.closeModal() } }, {
                key: "render",
                value: function() {
                    var e = this.props.modal.modalProps.answer.title;
                    return l.default.createElement(l.default.Fragment, null, l.default.createElement("div", { className: "sui-box-header" }, l.default.createElement("h3", { className: "sui-box-title", id: "dialogTitle" }, (0, u.translate)("Antwort löschen"), " ", e), l.default.createElement("button", { className: "sui-dialog-close powerform-builder-fields-close", "aria-label": (0, u.translate)("Dieses Dialogfenster schließen"), onClick: this.closeModal })), l.default.createElement("div", { className: "sui-box-body" }, l.default.createElement("p", null, (0, u.translate)("Diese Antwort löschen"), (0, u.translate)("wird seinen Wert auch aus den vorhandenen Einsendungen entfernen."))), l.default.createElement("div", { className: "sui-box-footer" }, l.default.createElement("button", { className: "sui-button sui-button-ghost powerform-discard-field-settings", onClick: this.closeModal }, (0, u.translate)("Abbrechen")), l.default.createElement("button", { className: "sui-button sui-button-ghost sui-button-red", onClick: this.trashField }, l.default.createElement("span", { className: "sui-loading-text" }, l.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), (0,
                        u.translate)("LÖSCHEN")))))
                }
            }]), t
        }(s.Component);
            ...
            return i(t, e), l(t, [{
                ...
                value: function(e, t) {
                    var n = this,
                        r = this,
                        o = this.props.status;
                    if (!this.isValid()) return new b.default({ type: "error", text: (0, f.translate)("Umfrageantworten dürfen nicht leer sein."), time: 4e3 }).open(), this.setState({ publishLoading: !1, draftLoading: !1 }), !1;
                    d.default.post(powerformData.ajaxUrl, m.default.stringify(e)).then(function(a) {
                        -1 === e.form_id && (n.props.actions.settingsActions.updateSetting("form_id", a.data.data), powerformData.currentForm.settings.form_id = a.data.data, window.history.pushState({}, "Umfrage bearbeiten", powerformData.pollEditUrl + "&id=" + a.data.data)), n.props.actions.settingsActions.saveBuilder("form_status", t), n.setState({ publishLoading: !1, draftLoading: !1 }), ("draft" === o && "publish" === t || _.isUndefined(o) && "publish" === t) && setTimeout(function() {
    ...
    var s = function() {
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), s(t, [{ key: "render", value: function() { return u.default.createElement(u.default.Fragment, null, u.default.createElement("div", { className: "sui-sidenav-sticky sui-sidenav-hide-md" }, u.default.createElement("ul", { className: "sui-vertical-tabs sui-alt-design" }, u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/builder", activeClassName: "current" }, (0, f.translate)("Details"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/appearance", activeClassName: "current" }, (0, f.translate)("Darstellung"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/behaviour", activeClassName: "current" }, (0, f.translate)("Verhalten"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/notifications", activeClassName: "current" }, (0, f.translate)("Benachrichtigungen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/integrations", activeClassName: "current" }, (0, f.translate)("Integrationen"))), u.default.createElement("li", { className: "sui-vertical-tab" }, u.default.createElement(c.NavLink, { to: "/settings", activeClassName: "current" }, (0, f.translate)("Einstellungen")))), u.default.createElement("div", { className: "sui-sidenav-settings" }, u.default.createElement(m.default, this.props))), u.default.createElement("div", { className: "sui-sidenav-settings" }, u.default.createElement(d.default, this.props), u.default.createElement("div", { className: "sui-form-field sui-sidenav-hide-lg" }, u.default.createElement("label", { className: "sui-label" }, (0, f.translate)("Navigieren")), u.default.createElement(b.default, this.props, u.default.createElement("option", { value: "" }, (0, f.translate)("Details")), u.default.createElement("option", { value: "appearance" }, (0, f.translate)("Darstellung")), u.default.createElement("option", { value: "behaviour" }, (0, f.translate)("Verhalten")), u.default.createElement("option", { value: "notifications" }, (0, f.translate)("E-Mail Benachrichtigungen")), u.default.createElement("option", { value: "integrations" }, (0, f.translate)("Integrationen")), u.default.createElement("option", { value: "settings" }, (0, f.translate)("Einstellungen")))), u.default.createElement("div", { className: "sui-sidenav-hide-lg" }, u.default.createElement(m.default, this.props)))) } }]), t
        }(l.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{
                key: "componentDidMount",
                value: function() {
                    var e = $(".sui-sidenav .sui-with-floating-input"),
                        t = $(".sui-header"),
    ...
    var i = function() {
        ...
        u = function(e) {
            function t(e) { r(this, t); var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)); return n.updateValue = n.updateValue.bind(n), n }
            return a(t, e), i(t, [{ key: "componentDidMount", value: function() { this.$el = $(this.el), SUI.suiSelect(this.$el), this.updateValue = this.updateValue.bind(this), this.$el.on("change", this.updateValue) } }, {
                key: "updateValue",
                value: function(e) {
    ...
    function a(e) { return { actions: { settingsActions: (0, s.bindActionCreators)(u, e), builderActions: (0, s.bindActionCreators)(d, e), modalActions: (0, s.bindActionCreators)(f, e) } } }
    Object.defineProperty(t, "__esModule", { value: !0 });
    var i = n(4),
        s = n(5),
        l = n(80),
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            ...
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Frage")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Füge zunächst die Frage hinzu, über die Umfragebesucher abstimmen sollen."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Was ist deine Hauptfrage?"), type: "text", placeholder: (0, f.translate)("Z.B. Warum hat das Huhn die Straße überquert?"), property: "poll-question" })), c.default.createElement(m.default, s({}, this.props, { type: "image", label: (0, f.translate)("Funktionsbild (optional)"), property: "poll-image", imageSize: "large", description: (0, f.translate)("Dieses Bild wird unter Deiner Hauptfrage angezeigt und kann verwendet werden, um Umfragen basierend auf einem Bild zu erstellen.") })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Beschreibung (optional)"), type: "text", placeholder: (0, f.translate)("Gib eine optionale Beschreibung ein"), property: "poll-description", description: (0, f.translate)("Dies wird unter der Hauptfrage angezeigt und kann zur weiteren Erläuterung der Hauptfrage verwendet werden.") })))), c.default.createElement("div", { className: "sui-box-settings-row sui-flushed", style: { borderBottom: "0" } }, c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement("label", { className: "sui-settings-label sui-dark" }, (0, f.translate)("Antworten")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Füge nun Antworten auf Deine Frage hinzu, mit denen Deine Benutzer abstimmen werden. Füge so viele hinzu, wie Du möchtest. Achte nur darauf, dass jede einzelne einzigartig ist!")), c.default.createElement(b.default, this.props))), c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Schaltfläche")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Passe die Tastenbeschriftung an, die zum Senden der Benutzerantwort verwendet wird."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Schaltflächentext"), type: "text", placeholder: (0, f.translate)("Z.B. Abstimmen"), property: "poll-button-label" }))))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
            ...
            return s(t, e), u(t, [{
                ...
                value: function() {
                    var e = [].concat(o(this.props.answers)),
                        t = [{ element_id: "answer-" + (0, p.getMaxID)("answer", this.props.answers) }],
                        n = [].concat(o(e), t);
                    this.props.actions.builderActions.updateAnswers(n)
                }
            }, { key: "render", value: function() { var e = this; return f.default.createElement("div", { className: "fui-multi-answers", ref: function(t) { return e.el = t } }, f.default.createElement("ul", { className: "fui-answers" }, _.map(this.props.answers, function(t, n) { return f.default.createElement(h.default, l({ key: t.element_id, answer: t }, e.props, { counter: n })) })), f.default.createElement("button", { className: "sui-button sui-button-dashed", onClick: this.addAnswer }, f.default.createElement("i", { className: "sui-icon-plus", "aria-hidden": "true" }), (0, p.translate)("Antwort hinzufügen")), 0 === this.props.answers.length && f.default.createElement("div", { className: "fui-empty-message" }, f.default.createElement("span", { className: "sui-description" }, (0, p.translate)("Eine Umfrage ohne Antworten wird nicht sehr nützlich sein... Füge Deine Antworten oben hinzu!")), powerformData.showBranding && f.default.createElement("img", { src: powerformData.imagesUrl + "/powerform-create-modal.png", srcSet: powerformData.imagesUrl + "/powerform-create-modal.png 1x,\n\t\t\t\t\t\t\t\t" + powerformData.imagesUrl + "/powerform-create-modal@2x.png 2x", className: "sui-image sui-image-center" }))) } }]), t
        }(c.Component);
    t.default = m
}, function(e, t, n) {
    "use strict";
            ...
            return i(t, e), s(t, [{
                ...
                value: function() {
                    var e = !!this.props.answer.title,
                        t = e ? "" : "fui-error";
                    return u.default.createElement("li", { "data-index": this.props.counter, className: "answer-row " + t }, u.default.createElement("span", { className: "fui-answer--move" }, u.default.createElement("i", { className: "sui-icon-drag", "aria-hidden": "true" })), u.default.createElement("span", { className: "fui-answer--fields" }, u.default.createElement("div", { className: "sui-form-field" }, u.default.createElement("input", { className: "sui-form-control", defaultValue: this.props.answer.title, onChange: this.updateTitle.bind(this) })), !0 === this.props.answer.use_extra && u.default.createElement("div", { className: "sui-form-field" }, u.default.createElement("input", { className: "sui-form-control", placeholder: (0, c.translate)("Platzhalter eingeben"), defaultValue: this.props.answer.extra, onChange: this.updateExtra.bind(this) }))), u.default.createElement("span", {
                        className: "fui-answer--actions"
                    }, u.default.createElement("button", { onClick: this.deleteField, className: "sui-button-icon sui-button-red sui-tooltip", "data-tooltip": (0, c.translate)("Löschen") }, u.default.createElement("i", { className: "sui-icon-trash", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Antwort löschen"))), u.default.createElement("span", { className: "sui-dropdown" }, u.default.createElement("button", { className: "sui-button-icon sui-dropdown-anchor" }, u.default.createElement("i", { className: "sui-icon-widget-settings-config", "aria-hidden": "true" }), u.default.createElement("span", { className: "sui-screen-reader-text" }, (0, c.translate)("Antwortoptionen"))), u.default.createElement("ul", null, !0 !== this.props.answer.use_extra && u.default.createElement("li", null, u.default.createElement("button", { onClick: this.addExtra.bind(this) }, (0, c.translate)("Benutzerdefinierte Eingabe aktivieren"))), !0 === this.props.answer.use_extra && u.default.createElement("li", null, u.default.createElement("button", { onClick: this.removeExtra.bind(this) }, (0, c.translate)("Benutzerdefinierte Eingabe entfernen")))))))
                }
            }]), t
        }(l.Component);
    t.default = f
    ...
    var i = function() {
        ...
        c = function(e) {
            ...
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--poll fui-demo--default" }, l.default.createElement("label", { htmlFor: "powerform-poll-preview--default-default" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--default-default" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Standard")), l.default.createElement("label", { htmlFor: "powerform-poll-preview--default-checked" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--default-checked" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Ausgewählt")), l.default.createElement("button", null, (0, u.translate)("Schaltfläche"))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t() { return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--poll fui-demo--flat" }, l.default.createElement("label", { htmlFor: "powerform-poll-preview--flat-default" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--flat-default" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Standard")), l.default.createElement("label", { htmlFor: "powerform-poll-preview--flat-checked" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--flat-checked" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Ausgewählt")), l.default.createElement("button", null, (0, u.translate)("Schaltfläche"))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t() { return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--poll fui-demo--bold" }, l.default.createElement("label", { htmlFor: "powerform-poll-preview--bold-default" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--bold-default" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Standard")), l.default.createElement("label", { htmlFor: "powerform-poll-preview--bold-checked" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--bold-checked" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Ausgewählt")), l.default.createElement("button", null, (0, u.translate)("Schaltfläche"))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t() { return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "fui-demo fui-demo--poll fui-demo--material" }, l.default.createElement("label", { htmlFor: "powerform-poll-preview--material-default" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--material-default" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Standard")), l.default.createElement("label", { htmlFor: "powerform-poll-preview--material-checked" }, l.default.createElement("input", { type: "radio", id: "powerform-poll-preview--material-checked" }), l.default.createElement("span", { "aria-hidden": "true" }), (0, u.translate)("Ausgewählt")), l.default.createElement("button", null, (0, u.translate)("Schaltfläche"))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var i = function() {
        ...
        c = function(e) {
            function t() { return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return a(t, e), i(t, [{ key: "render", value: function() { return l.default.createElement("div", { className: "sui-notice" }, l.default.createElement("p", null, (0, u.translate)("Du hast Dich dafür entschieden, dass kein Stylesheet in die Warteschlange gestellt wird. Das Formular erbt Stile vom CSS Deines Themes."))) } }]), t
        }(s.Component);
    t.default = c
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        A = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Farben")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Passe die Standardfarbkombinationen an Dein Design an."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "poll-colors", default: "" }), c.default.createElement(m.default, { value: "" }, (0, f.translate)("Standardfarben verwenden")), c.default.createElement(b.default, { value: "true", label: (0, f.translate)("Benutzerdefiniert") }, c.default.createElement("div", { className: "sui-accordion" }, c.default.createElement("div", { className: "sui-accordion-header" }, c.default.createElement("div", null, (0, f.translate)("Element"))), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Container") }), c.default.createElement(w.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Frage & Beschreibung") }), c.default.createElement(O.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Optionen") }), c.default.createElement(j.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Benutzerdefinierte Antwort") }), c.default.createElement(P.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Einreichen Button") }), c.default.createElement(N.default, this.props)), c.default.createElement(g.default, s({}, this.props, { label: (0, f.translate)("Links") }), c.default.createElement(S.default, this.props))))))) } }]), t
        }(u.Component);
    t.default = A
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Hintergrund"), property: "box_background", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "box_border", defaultValue: "rgba(233,233,233,1)", isAlpha: !0 })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Box Schatten"), property: "box_shadow", defaultValue: "rgba(230,230,230,1)", isAlpha: !0 }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(c.default.Fragment, null, c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Fragenfarbe"), property: "poll_question", defaultValue: "#333333" })), c.default.createElement(d.default, s({}, this.props, { label: (0, f.translate)("Beschreibung Farbe"), property: "poll_description", defaultValue: "#4D4D4D" }))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(b.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Hintergrund"), property: "inputbg", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "inputbo", defaultValue: "rgba(119,119,113,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Textfarbe"), property: "poll_answers", defaultValue: "#000000" }))), c.default.createElement(b.default, { value: "checked", label: (0, f.translate)("Ausgewählt") }, c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Hintergrund"), property: "inputbg_active", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "inputbo_active", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(m.default, s({}, this.props, { label: (0, f.translate)("Symbolfarbe"), property: "radio_dot", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_static", defaultValue: "rgba(237,237,237,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "powerform-poll-input-border_static", defaultValue: "rgba(119,119,113,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Platzhalter"), property: "input_placeholder", defaultValue: "#AAAAAA" })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Textfarbe"), property: "input_text", defaultValue: "#000000" }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_hover", defaultValue: "rgba(230,230,230,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "powerform-poll-input-border_hover", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "focus", label: (0, f.translate)("Fokus") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "powerform-poll-input-background_active", defaultValue: "rgba(230,230,230,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Randfarbe"), property: "powerform-poll-input-border_active", defaultValue: "rgba(221,221,221,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        v = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement(d.default, { type: "tabs", default: "default", extraClass: "sui-tabs-flushed" }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "buttonbg", defaultValue: "rgba(23,168,227,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Textfarbe"), property: "buttontxt", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "buttonbg_hover", defaultValue: "rgba(0,143,202,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Textfarbe"), property: "buttontxt_hover", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Aktiv") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Hintergrundfarbe"), property: "buttonbg_active", defaultValue: "rgba(0,143,202,1)", isAlpha: !0 })), c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Textfarbe"), property: "buttontxt_active", defaultValue: "rgba(255,255,255,1)", isAlpha: !0 })))) } }]), t
        }(u.Component);
    t.default = v
}, function(e, t, n) {
    "use strict";
        ...
        v = function(e) {
            ...
            return i(t, e), l(t, [{
                ...
                value: function() {
                    ...
                    }, c.default.createElement(m.default, { value: "default", label: (0, f.translate)("Standard") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Link Farbe"), property: "color_link", defaultValue: "rgba(23,168,227, 1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "hover", label: (0, f.translate)("Hover") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Link Farbe"), property: "color_link_hover", defaultValue: "rgba(0,143,202, 1)", isAlpha: !0 }))), c.default.createElement(m.default, { value: "active", label: (0, f.translate)("Aktiv") }, c.default.createElement(b.default, s({}, this.props, { label: (0, f.translate)("Link Farbe"), property: "color_link_active", defaultValue: "rgba(0,143,202, 1)", isAlpha: !0 }))))
                }
            }]), t
        }(u.Component);
    t.default = v
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        _ = function(e) {
            function t() { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Formularcontainer")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Passen Sie die Polsterung und den Rand des Formularcontainers an."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(g.default, s({}, this.props, { property: "poll-padding", settingsLabel: (0, f.translate)("Padding"), settingsDesc: (0, f.translate)("Standardmäßig füllt das Formular den verfügbaren Platz aus, an dem Du es einfügst. Du kannst hier etwas Polster hinzufügen, um es besser an Dein Theme anzupassen.") }), c.default.createElement(d.default, { value: "" }, (0, f.translate)("Keiner")), c.default.createElement(m.default, s({}, this.props, { value: "custom", boxClass: "sui-tab-boxed" }), (0, f.translate)("Benutzerdefiniert"))), c.default.createElement(g.default, s({}, this.props, { property: "poll-border", settingsLabel: (0, f.translate)("Rand"), settingsDesc: (0, f.translate)("Füge einen optionalen Rahmen um das Formular hinzu.") }), c.default.createElement(d.default, { value: "" }, (0, f.translate)("Keiner")), c.default.createElement(b.default, s({}, this.props, { value: "custom", boxClass: "sui-tab-boxed" }), (0, f.translate)("Benutzerdefiniert"))))) } }]), t
        }(u.Component);
    t.default = _
}, function(e, t, n) {
    "use strict";
        ...
        w = function(e) {
            ...
            return i(t, e), l(t, [{
                ...
                value: function() {
                    var e = this,
                        t = function(t) { e.props.history.push("/" + t) },
                        n = c.default.createElement(_.default, s({}, this.props, { defaultValue: "pie", property: "results-style", radioClass: "sui-radio-sm" }), c.default.createElement("div", { value: "pie", image1x: "graph-pie.png", image2x: "graph-pie@2x.png", hasImage: !0 }, (0, f.translate)("Kuchendiagramm")), c.default.createElement("div", { value: "bar", image1x: "graph-bar.png", image2x: "graph-bar@2x.png", hasImage: !0 }, (0, f.translate)("Balkendiagramm")));
                    return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Ergebnisanzeige")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Wähle aus, wie Du die Umfrageergebnisse für neue Einreichungen anzeigen möchtest. Du kannst die Farben auf der Registerkarte {{link}}Darstellung{{/link}} anpassen.", { components: { link: c.default.createElement("a", { href: "#", onClick: function() { return t("appearance") } }) } }))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(v.default, s({}, this.props, { property: "results-behav", default: "not_show" }), c.default.createElement(m.default, s({}, this.props, { value: "link_on", label: (0, f.translate)("Link bei Umfrage"), boxClass: "sui-tab-boxed" }), n), c.default.createElement(m.default, s({}, this.props, { value: "show_after", label: (0, f.translate)("Zeige nach der Abstimmung"), boxClass: "sui-tab-boxed" }), n), c.default.createElement(d.default, { value: "not_show", label: (0, f.translate)("Nicht anzeigen") }))))
                }
            }]), t
        }(u.Component);
    t.default = w
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Stimmenzahl")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Zeige die Anzahl der Stimmen in den Balkendiagrammergebnissen an."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "show-votes-count", defaultValue: "false" }), c.default.createElement("div", { value: "false" }, (0, f.translate)("Ausblenden")), c.default.createElement("div", { value: "true" }, (0, f.translate)("Anzeigen"))))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Einreichungsmethode")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Bei Einsendungen muss die Seite standardmäßig nicht neu geladen werden. Wenn Probleme auftreten, kannst Du die herkömmliche Methode zum erneuten Laden der Seite verwenden."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "enable-ajax", defaultValue: "" }), c.default.createElement("div", { value: "" }, (0, f.translate)("Seite neuladen")), c.default.createElement("div", { value: "true" }, (0, f.translate)("Ajax"))))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        x = function(e) {
            function t(e) { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Limits")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Standardmäßig ist Benutzer nur die Abgabe einer Umfragestimme erlaubt. Du kannst einen bestimmten Zeitrahmen festlegen, um zusätzliche Stimmen zuzulassen, oder immer mehrere Stimmen."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "enable-votes-limit", default: "false", simple: !0 }), c.default.createElement(m.default, { value: "false", label: (0, f.translate)("Einmal") }), c.default.createElement(b.default, s({}, this.props, { value: "true", label: (0, f.translate)("Mehrfach zulassen"), boxClass: "sui-tab-boxed" }), c.default.createElement(g.default, { cols: "6" }, c.default.createElement(w.default, s({}, this.props, { type: "number", property: "vote_limit_input", placeholder: "10" }))), c.default.createElement(g.default, { cols: "6" }, c.default.createElement(O.default, s({}, this.props, { property: "vote_limit_options", defaultValue: "m" }), c.default.createElement("option", { value: "m" }, (0, f.translate)("Minute(n)")), c.default.createElement("option", { value: "h" }, (0, f.translate)("Stunde(n)")), c.default.createElement("option", { value: "d" }, (0, f.translate)("Tag(e)")), c.default.createElement("option", { value: "W" }, (0, f.translate)("Woche(n)")), c.default.createElement("option", { value: "M" }, (0, f.translate)("Monat(e)")), c.default.createElement("option", { value: "Y" }, (0, f.translate)("Jahr(e)")))))))) } }]), t
        }(u.Component);
    t.default = x
}, function(e, t, n) {
    "use strict";
    ...
    var s = Object.assign || function(e) { for (var t = 1; t < arguments.length; t++) { var n = arguments[t]; for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && (e[r] = n[r]) } return e },
        ...
        h = function(e) {
            function t() { return o(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments)) }
            return i(t, e), l(t, [{ key: "render", value: function() { return c.default.createElement("div", { className: "sui-box-settings-row" }, c.default.createElement("div", { className: "sui-box-settings-col-1" }, c.default.createElement("span", { className: "sui-settings-label" }, (0, f.translate)("Rendern")), c.default.createElement("span", { className: "sui-description" }, (0, f.translate)("Wähle aus, wie Deine Umfrage für Benutzer gerendert werden soll."))), c.default.createElement("div", { className: "sui-box-settings-col-2" }, c.default.createElement(d.default, s({}, this.props, { property: "use_ajax_load", label: (0, f.translate)("Umfrage mit AJAX laden"), description: (0, f.translate)("Durch Aktivieren dieser Funktion wird die Umfrage über AJAX geladen, nachdem die Seite geladen wurde, wodurch die Ladezeit Deiner Seite effektiv beschleunigt wird. Mit dieser Methode können (in den meisten Fällen) auch Probleme beim Zwischenspeichern von Seiten bei Deiner Umfrage vermieden werden.") })), c.default.createElement(d.default, s({}, this.props, { property: "use_donotcachepage", label: (0, f.translate)("Seiten-Caching auf Umfrageseiten verhindern"), description: (0, f.translate)("Plugins zum Zwischenspeichern von Seiten stellen eine statische HTML-Version der Seite bereit, die Probleme bei Deinen dynamischen Abfragen verursachen kann. Wenn Du diese Option aktivierst, verwenden wir die Konstante {{strong}}DONOTCACHEPAGE{{/strong}}, um Zwischenspeichern der Seiten mit dieser Abfrage  zu verhindern . ", { components: { strong: c.default.createElement("strong", null) } }) })))) } }]), t
        }(u.Component);
    t.default = h
}, function(e, t, n) {
    "use strict";
            ...
            return i(t, e), l(t, [{ key: "getNameOptions", value: function() { var e = []; return _.map(powerformData.variables, function(t, n) { e.push({ label: t, value: n }) }), e } }, { key: "getEmailOptions", value: function() { return [] } }, { key: "getRecipientTagsOptions", value: function() { return { tags: !0, tokenSeparators: [",", " "], language: { searching: function() { return (0, f.translate)("Suchen") }, noResults: function() { return (0, f.translate)("Keine Einträge gefunden") } }, placeholder: (0, f.translate)("Empfänger"), ajax: { url: powerformData.ajaxUrl, type: "POST", delay: 350, data: function(e) { return { action: "powerform_builder_search_emails", _wpnonce: powerformData.searchNonce, q: e.term } }, processResults: function(e) { return { results: e.data } }, cache: !0 }, templateResult: function(e) { return _.isUndefined(e.id) || _.isUndefined(e.text) || _.isUndefined(e.display_name) ? e.text : $("<span><b>" + e.text + "</b> - <small>" + e.display_name + "</small></span>") }, createTag: function(e) { var t = $.trim(e.term); return (0, f.isEmailWp)(t) ? { id: t, text: t } : null } } } }, { key: "getCcBccOptions", value: function() { return { tags: !0, placeholder: (0, f.translate)("Keiner"), createTag: function(e) { var t = $.trim(e.term); return (0, f.isEmailWp)(t) ? { id: t, text: t } : null } } } }, {
                ...
                value: function() {
                    ...
                    return e.map(function(e) {
                        t.push(e.value)
                    }), (_.isUndefined(this.props.settings["admin-email-cc-address"]) || !_.isArray(this.props.settings["admin-email-cc-address"]) ? [] : this.props.settings["admin-email-cc-address"]).filter(function(e) { return t.indexOf(e) < 0 }).map(function(t) { e.push({ value: t, label: t }) }), e
                }
            }, {
